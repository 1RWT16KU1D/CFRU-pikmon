...
static bool8 SpeciesHasMultipleSearchableForms(u16 species)
{
	...
	switch (dexNum)
	{
		case NATIONAL_DEX_CRUMBUG:
		case NATIONAL_DEX_BREADBUG:
		case NATIONAL_DEX_SPOTTYBULBEAR:
		case NATIONAL_DEX_HONEYWISP:
		case NATIONAL_DEX_DANDELFLY:
		case NATIONAL_DEX_DOWNYSNAGRET:
		case NATIONAL_DEX_ARISTOCRABOFFSPRING:
		case NATIONAL_DEX_ARISTOCRAB:
		...
		case NATIONAL_DEX_BULBMIN:
		case NATIONAL_DEX_ADULTBULBMIN:
		case NATIONAL_DEX_VEHEAMOTHPHOSBAT:
		case NATIONAL_DEX_PUCKERINGBLINNOW:
		case NATIONAL_DEX_SPUTTLEFISH:
		case NATIONAL_DEX_PRICKLEPUFF:
		case NATIONAL_DEX_SNOWYBLOWHOG:
		case NATIONAL_DEX_BOGSWALLOW:
		case NATIONAL_DEX_PUFFMIN:
		case NATIONAL_DEX_SCORCHCAKE:
			return TRUE;
		default:
			return FALSE;
	}
