...
#define MAP_HERMITCRAWMADS_CAVE_NORTH_ENTRANCE         (36 | (1 << 8))
#define MAP_HERMITCRAWMADS_CAVE_B1F                    (37 | (1 << 8))
#define MAP_HERMITCRAWMADS_CAVE_SOUTH_ENTRANCE         (38 | (1 << 8))
...
//PIKMON MAPS
    #define MAP_WARP_ROOM                       ( 0 | ( 3 << 8))
#define MAP_THE_IMPACT_SITE                     ( 0 | ( 3 << 8))
    #define MAP_SHEPHERD_FRONT                  ( 0 | ( 4 << 8))
    #define MAP_SHEPHERD_BACK                   ( 1 | ( 4 << 8))
    #define MAP_OLIMARS_LAB                     ( 3 | ( 4 << 8))
    #define MAP_IS_HOUSE_TOP                    (14 | ( 0 << 8))
    #define MAP_IS_HOUSE_BOT                    (15 | ( 0 << 8))
    #define MAP_IS_HOUSE_LEFT                   (17 | ( 0 << 8))
#define MAP_ROUTE_1                             (19 | ( 3 << 8))
    #define MAP_R1_CENTER                       (21 | (10 << 8))
#define MAP_BURROW_OF_BEGINNINGS                (66 | ( 3 << 8))
#define MAP_ROUTE_2                             (68 | ( 3 << 8))
#define MAP_BLOSSOMING_ARCADIA                  ( 1 | ( 3 << 8))
    #define MAP_BA_CENTER                       ( 4 | ( 5 << 8))
    #define MAP_BA_GYM                          ( 2 | ( 6 << 8))
    #define MAP_BA_HOUSE_LEFT                   ( 5 | ( 5 << 8))
    #define MAP_BA_HOUSE_RIGHT                  (67 | ( 3 << 8))
    #define MAP_BA_HOUSE_BOT                    (16 | ( 0 << 8))
#define MAP_DRAFTY_GALLERY                      (12 | ( 0 << 8))
    #define MAP_DG_F2                           ( 0 | ( 5 << 8))
    #define MAP_DG_BOSS                         (18 | ( 0 << 8))