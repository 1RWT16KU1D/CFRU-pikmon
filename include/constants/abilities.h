...
#define ABILITY_TRIPLETHREAT ABILITY_POISONTOUCH //applies Tri-Attack to rock type moves and gives STAB on Fire/Electric/Ice
#define ABILITY_ASONE_SUPREME ABILITY_UNNERVE
#define ABILITY_ASONE_BEAST ABILITY_UNNERVE
#define ABILITY_SLIPPERY ABILITY_HEATPROOF