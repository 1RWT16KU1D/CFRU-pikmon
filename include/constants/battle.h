...
#define BATTLE_TYPE_BENJAMIN_GLINTBEETLE	0x8000000
...
#define STATUS1_PETRIFY          (1 << 12 | 1 << 13 | 1 << 14)
#define STATUS1_PETRIFY_TURN(num) ((num) << 12)
#define STATUS1_PSN_ANY          (STATUS1_POISON | STATUS1_TOXIC_POISON)
#define STATUS1_ANY              (STATUS1_SLEEP | STATUS1_POISON | STATUS1_BURN | STATUS1_FREEZE | STATUS1_PARALYSIS | STATUS1_TOXIC_POISON | STATUS1_PETRIFY)
...
#define STATUS3_COLORCHANGE             0x20000
...
#define WEATHER_GLOOM               (1 << 15)

#define WEATHER_ANY                 (WEATHER_RAIN_ANY | WEATHER_SANDSTORM_ANY | WEATHER_SUN_ANY | WEATHER_HAIL_ANY | WEATHER_FOG_ANY | WEATHER_GLOOM | WEATHER_PRIMAL_ANY)
...
#define WEATHER_GLOOM_ANY           (WEATHER_GLOOM)
