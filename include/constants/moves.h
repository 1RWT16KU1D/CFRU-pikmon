...
enum Gen9Moves
{
    MOVE_AQUACUTTER       = 0x2FF,
    MOVE_AQUASTEP         = 0x300,
    MOVE_ARMORCANNON      = 0x301,
    MOVE_AXEKICK          = 0x302,
    MOVE_BITTERBLADE      = 0x303,
    MOVE_BLAZINGTORQUE    = 0x304,
    MOVE_CHILLINGWATER    = 0x305,
    MOVE_CHILLYRECEPTION  = 0x306,
    MOVE_COLLISIONCOURSE  = 0x307,
    MOVE_COMBATTORQUE     = 0x308,
    MOVE_COMEUPPANCE      = 0x309,
    MOVE_DOODLE           = 0x30A,
    MOVE_DOUBLESHOCK      = 0x30B,
    MOVE_ELECTRODRIFT     = 0x30C,
    MOVE_FILLETAWAY       = 0x30D,
    MOVE_FLOWERTRICK      = 0x30E,
    MOVE_GIGATONHAMMER    = 0x30F,
    MOVE_GLAIVERUSH       = 0x310,
    MOVE_HYDROSTEAM       = 0x311,
    MOVE_HYPERDRILL       = 0x312,
    MOVE_ICESPINNER       = 0x313,
    MOVE_JETPUNCH         = 0x314,
    MOVE_KOWTOWCLEAVE     = 0x315,
    MOVE_LASTRESPECTS     = 0x316,
    MOVE_LUMINACRASH      = 0x317,
    MOVE_MAGICALTORQUE    = 0x318,
    MOVE_MAKEITRAIN       = 0x319,
    MOVE_MORTALSPIN       = 0x31A,
    MOVE_NOXIOUSTORQUE    = 0x31B,
    MOVE_ORDERUP          = 0x31C,
    MOVE_POPULATIONBOMB   = 0x31D,
    MOVE_POUNCE           = 0x31E,
    MOVE_PSYBLADE         = 0x31F,
    MOVE_RAGEFIST         = 0x320,
    MOVE_RAGINGBULL       = 0x321,
    MOVE_REVIVALBLESSING  = 0x322,
    MOVE_RUINATION        = 0x323,
    MOVE_SALTCURE         = 0x324,
    MOVE_SHEDTAIL         = 0x325,
    MOVE_SILKTRAP         = 0x326,
    MOVE_SNOWSCAPE        = 0x327,
    MOVE_SPICYEXTRACT     = 0x328,
    MOVE_SPINOUT          = 0x329,
    MOVE_TERABLAST        = 0x32A,
    MOVE_TIDYUP           = 0x32B,
    MOVE_TORCHSONG        = 0x32C,
    MOVE_TRAILBLAZE       = 0x32D,
    MOVE_TRIPLEDIVE       = 0x32E,
    MOVE_TWINBEAM         = 0x32F,
    MOVE_WICKEDTORQUE     = 0x330,
    MOVE_BLOODMOON        = 0x331,
    MOVE_UPPERHAND        = 0x332,
    MOVE_MATCHAGOTCHA     = 0x333,
    MOVE_SYRUPBOMB        = 0x334,
    MOVE_IVYCUDGEL        = 0x335,
    MOVE_ELECTROSHOT      = 0x336,
    MOVE_TERASTARSTORM    = 0x337,
    MOVE_FICKLEBEAM       = 0x338,
    MOVE_BURNINGBULWARK   = 0x339,
    MOVE_MIGHTYCLEAVE     = 0x33A,
    MOVE_TACHYONCUTTER    = 0x33B,
    MOVE_DRAGONCHEER      = 0x33C,
    MOVE_MALIGNANTCHAIN   = 0x33D,
    MOVE_THUNDERCLAP      = 0x33E,
    MOVE_HARDPRESS        = 0x33F,
    MOVE_ALLURINGVOICE    = 0x340,
    MOVE_TEMPERFLARE      = 0x341,
    MOVE_SUPERCELLSLAM    = 0x342,
    MOVE_PSYCHICNOISE     = 0x343
};

// New PikMon Moves
enum NewPikmonMoves
{
    MOVE_ARCTICBLAST = 0x344,
    MOVE_ACIDREFLEX,
    MOVE_BOMBROCK,
    MOVE_CURSEDFLAMES,
    MOVE_BORBBASH,
