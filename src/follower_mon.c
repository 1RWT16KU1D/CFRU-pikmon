...
{
    [SPECIES_BULBLARVA] = OBJ_EVENT_PAL_TAG_BULBLARVA_SHINY,
    [SPECIES_BULBORB] = OBJ_EVENT_PAL_TAG_BULBORB_SHINY,
    [SPECIES_JUMBOBORB] = OBJ_EVENT_PAL_TAG_JUMBOBORB_SHINY,
    [SPECIES_BLOWLET] = OBJ_EVENT_PAL_TAG_BLOWLET_SHINY,
    [SPECIES_BLOWHOG] = OBJ_EVENT_PAL_TAG_BLOWHOG_SHINY,
    [SPECIES_TITANBHOG] = OBJ_EVENT_PAL_TAG_TITANBHOG_SHINY,
    [SPECIES_WOLPOLE] = OBJ_EVENT_PAL_TAG_WOLPOLE_SHINY,
    [SPECIES_YWOLLYHOP] = OBJ_EVENT_PAL_TAG_YWOLLYHOP_SHINY,
