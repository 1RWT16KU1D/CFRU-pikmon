...
void sp156_StartGhostBattle(void)
{
	...
	if (Var8004 == 0 || Var8004 >= NUM_SPECIES) //Default is Scorchcake
		CreateMonWithGenderNatureLetter(&gEnemyParty[0], SPECIES_SCORCHCAKE, 30, 31, MON_FEMALE, NATURE_SERIOUS, 0);
	else
