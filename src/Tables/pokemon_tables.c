...
{
	ALTERNATE_SIZE(SPECIES_JUMBOBULBORB_MEGA, 2.4, 155.5),
	ALTERNATE_SIZE(SPECIES_TITANBLOWHOG_MEGA_Y, 1.7, 100.5),
	ALTERNATE_SIZE(SPECIES_TITANBLOWHOG_MEGA_X, 1.7, 110.5),
	ALTERNATE_SIZE(SPECIES_MASTERHOP_MEGA, 1.6, 101.1),
	ALTERNATE_SIZE(SPECIES_DIRIGIBUG_MEGA, 1.4, 40.5),
	ALTERNATE_SIZE(SPECIES_FROSTYBULBORB, 2.2, 50.5),
	ALTERNATE_SIZE(SPECIES_CRUMBUG_A, 0.3, 3.8),
	ALTERNATE_SIZE(SPECIES_BREADBUG_A, 0.7, 25.5),
	ALTERNATE_SIZE(SPECIES_HONEYWISP_A, 0.7, 21.0),
	ALTERNATE_SIZE(SPECIES_DANDELFLY_A, 0.7, 40.0),
	ALTERNATE_SIZE(SPECIES_DOWNYSNAGRET_A, 1.2, 55.0),
	ALTERNATE_SIZE(SPECIES_HERMITCRAWMAD_A, 0.2, 1.0),
	ALTERNATE_SIZE(SPECIES_BUGEYEDCRAWMAD_A, 0.7, 66.6),
	ALTERNATE_SIZE(SPECIES_DWARFORANGEBULBORB_A, 1.1, 33.0),
	ALTERNATE_SIZE(SPECIES_VOLATILEDWEEVIL_MEGA, 1.2, 105.8),
	ALTERNATE_SIZE(SPECIES_VEHEAMOTHPHOSBAT_A, 0.4, 20.3),
	ALTERNATE_SIZE(SPECIES_PUCKERINGBLINNOW_A, 1.0, 110.0),
	ALTERNATE_SIZE(SPECIES_SPUTTLEFISH_A, 1.7, 316.0),
	ALTERNATE_SIZE(SPECIES_SLOWBRO_MEGA, 2.0, 120.0),
	ALTERNATE_SIZE(SPECIES_GRIMER_A, 0.7, 42.0),
	ALTERNATE_SIZE(SPECIES_SNOWYBLOWHOG_A, 1.0, 52.0),
	ALTERNATE_SIZE(SPECIES_GENGAR_MEGA, 1.4, 40.5),
	ALTERNATE_SIZE(SPECIES_EXEGGUTOR_A, 10.9, 415.6),
	ALTERNATE_SIZE(SPECIES_SCORCHCAKE_A, 1.0, 34.0),
	ALTERNATE_SIZE(SPECIES_KANGASKHAN_MEGA, 2.2, 100.0),
	ALTERNATE_SIZE(SPECIES_PINSIR_MEGA, 1.7, 59.0),
	ALTERNATE_SIZE(SPECIES_MASTERONION_MEGA, 6.5, 305.0),
	...
	ALTERNATE_SIZE(SPECIES_DWARFBULBORB_G, 0.4, 7.5),
	ALTERNATE_SIZE(SPECIES_PRICKLEPUFF_G, 0.8, 24.0),
	...
	ALTERNATE_SIZE(SPECIES_BULBMIN_H, 0.8, 22.7),
	ALTERNATE_SIZE(SPECIES_ADULTBULBMIN_H, 2.0, 168.0),
	ALTERNATE_SIZE(SPECIES_BOGSWALLOW_H, 0.5, 13.0),
	ALTERNATE_SIZE(SPECIES_PUFFMIN_H, 1.2, 71.0),
...
{
	ITEM_ALAKAZITE,
	ITEM_TITANBLOWHOGITE_X,
	ITEM_TITANBLOWHOGITE_Y,
	ITEM_DIANCITE,
	ITEM_GARCHOMPITE,
	ITEM_MASTERONIONITE,
	ITEM_LATIASITE,
