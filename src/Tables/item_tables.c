...
const struct FlingStruct gFlingTable[ITEMS_COUNT] =
{
	...
	[ITEM_JUMBOBORBITE] = {80, 0},
	[ITEM_TITANBHOGITE_X] = {80, 0},
	[ITEM_TITANBHOGITE_Y] = {80, 0},
...
const u16 gItemsByType[ITEMS_COUNT] =
{
	...
	[ITEM_JUMBOBORBITE] = ITEM_TYPE_MEGA_STONE,
	[ITEM_TITANBHOGITE_X] = ITEM_TYPE_MEGA_STONE,
	[ITEM_TITANBHOGITE_Y] = ITEM_TYPE_MEGA_STONE,
...
const struct Item gItemData[] =
{
	...
	},
	{
		...
		.itemId = ITEM_JUMBOBORBITE,
		.price = 0,
		.holdEffect = ITEM_EFFECT_MEGA_STONE,
		.holdEffectParam = 0,
		.description = DESC_JUMBOBORBITE,
		.importance = 0,
		.unk19 = 0,
		.pocket = POCKET_ITEMS,
		.type = ITEM_USE_BAG_MENU,
	...
	},
	{
		...
		.itemId = ITEM_TITANBHOGITE_X,
		.price = 0,
		.holdEffect = ITEM_EFFECT_MEGA_STONE,
		.holdEffectParam = 0,
		.description = DESC_TITANBHOGITE,
		.importance = 0,
		.unk19 = 0,
		.pocket = POCKET_ITEMS,
		.type = ITEM_USE_BAG_MENU,
