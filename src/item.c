...
u8 MegaBerry(u16 item){
	switch (item){
		case ITEM_BITTER_ADULT_BERRY :
		case ITEM_BITTER_ARMORED_BERRY :
		case ITEM_BITTER_BOG_BERRY :
		case ITEM_BITTER_BREAD_BERRY :
		case ITEM_BITTER_CRUSTED_BERRY :
		case ITEM_BITTER_DANDEL_BERRY :
		case ITEM_BITTER_DESICCATED_BERRY :
		case ITEM_BITTER_DIRIGI_BERRY :
		case ITEM_BITTER_EMPRESS_BERRY :
		case ITEM_BITTER_FLUTTER_BERRY :
		case ITEM_BITTER_GATTLING_BERRY :
		case ITEM_BITTER_GLINT_BERRY :
		case ITEM_BITTER_GREATER_BERRY :
		case ITEM_BITTER_GROOVY_BERRY :
		case ITEM_BITTER_JUMBO_BERRY :
		case ITEM_BITTER_MAN_AT_BERRY :
		case ITEM_BITTER_MASTER_BERRY :
		case ITEM_BITTER_MIRE_BERRY :
		case ITEM_BITTER_MOSS_BERRY :
		case ITEM_BITTER_MUCK_BERRY :
		case ITEM_BITTER_OAT_BERRY :
		case ITEM_BITTER_PILEATED_BERRY :
		case ITEM_BITTER_PROG_BERRY :
		case ITEM_BITTER_PUFF_BERRY :
		case ITEM_BITTER_PYROCLASTIC_BERRY :
		case ITEM_BITTER_SCORCH_BERRY :
		case ITEM_BITTER_SOVREIGN_BERRY :
		case ITEM_BITTER_TITAN_BERRY :
		case ITEM_BITTER_VEHEAMOTH_BERRY :
		case ITEM_BITTER_WATERY_BERRY :
			return 0;
		case ITEM_SPICY_ADULT_BERRY :
		case ITEM_SPICY_BLUE_BERRY :
		case ITEM_SPICY_GLOW_BERRY :
		case ITEM_SPICY_ICE_BERRY :
		case ITEM_SPICY_MOSS_BERRY :
		case ITEM_SPICY_OAT_BERRY :
		case ITEM_SPICY_PUFF_BERRY :
		case ITEM_SPICY_PURPLE_BERRY :
		case ITEM_SPICY_RED_BERRY :
		case ITEM_SPICY_ROCK_BERRY :
		case ITEM_SPICY_WHITE_BERRY :
		case ITEM_SPICY_WINGED_BERRY :
		case ITEM_SPICY_YELLOW_BERRY :
			return 1;
		default:
			return 2;
	}
