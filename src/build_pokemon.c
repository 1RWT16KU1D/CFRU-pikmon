...
const species_t gGeneralTrainerSpreads[NUM_TRAINER_CLASSES][NUM_BADGE_OPTIONS][NUM_MONS_PER_BADGE] = {
    ...
    [CLASS_BUG_MANIAC] = {
        ...
        [6] = {SPECIES_BEEDRILL_MEGA, SPECIES_CENTISKORCH_GIGA, SPECIES_VIVILLON_CONTINENTAL, SPECIES_GLNTBEETLE_GIGA, SPECIES_HERACROSS, SPECIES_FROSMOTH, SPECIES_ARMALDO, SPECIES_VIVILLON_GARDEN, SPECIES_VIVILLON_ELEGANT, SPECIES_BEEDRILL},
    ...
    [CLASS_BUG_CATCHER] = {
        ...
        [3] = {SPECIES_DOTTLER, SPECIES_PARAS, SPECIES_SILCOON, SPECIES_WHIRLIPEDE, SPECIES_SKORUPI, SPECIES_SWADLOON, SPECIES_DOODLEBUG, SPECIES_CASCOON, SPECIES_KAKUNA, SPECIES_ANORITH},
