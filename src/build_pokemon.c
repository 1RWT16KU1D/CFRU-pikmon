...
#define TOTAL_SPOTTYBULBEAR_SPREADS ARRAY_COUNT(gSpottyBulbearSpreads)
...
extern const species_t gSpottyBulbearCapForms[];
...
extern const u8 gNumSpottyBulbearCapForms;
...
u16 sp068_GivePlayerFrontierMonGivenSpecies(void)
{
	...
	if (spreads == NULL) //No special table like Arceus or SpottyBulbear was found
	{
		switch (Var8001) {
			case 0:
			default:
			...
			switch (trainerId) {
				...
				GENERIC_RANDOM_SPREADS:
					switch (tier) {
						...
						case BATTLE_FACILITY_BENJAMIN_GLINTBEETLE: //Don't use legends even though you can
...
static void UpdateBuilderAfterSpread(struct TeamBuilder* builder, const struct BattleTowerSpread* spread, u16 species, u8 ability, u16 item, u8 itemEffect, u32 partyId)
{
	...
	if (!IsFrontierSingles(builder->battleType)) //Doubles or Multi
	{
		switch (ability) {
			...
			case ABILITY_LIGHTNINGROD:
				...
				else if (SpeciesHasMithridate(SPECIES(gBankTarget)))
	...
	if (CareAboutTeamWeaknessesInTier(builder->tier) && species != SPECIES_QUAGGLEDMIRECLOPS) //QuaggledMireclops transforms anyway
	{
		u8 moveType;
		for (moveType = 0; moveType < NUMBER_OF_MON_TYPES; ++moveType)
		{
...
static bool8 IsSpreadWeakToType(u8 moveType, u8 defType1, u8 defType2, u8 ability)
{
	...
	switch (ability)
	{
		...
		case ABILITY_MOTORDRIVE:
		case ABILITY_LIGHTNINGROD:
			if ((moveType == TYPE_ELECTRIC && !(SpeciesHasEarthEater(SPECIES(gBankTarget)) || SpeciesHasMithridate(SPECIES(gBankTarget))))
			|| (moveType == TYPE_GROUND && SpeciesHasEarthEater(SPECIES(gBankTarget)))
			|| (moveType == TYPE_POISON && SpeciesHasMithridate(SPECIES(gBankTarget))))
				typeDmg = 0;
			break;
		case ABILITY_WATERABSORB:
		case ABILITY_DRYSKIN:
...
static void TryGetSpecialSpeciesSpreadTable(u16 species, const struct BattleTowerSpread** table, u16* spreadCount)
{
	switch (SpeciesToNationalPokedexNum(species))
	{
		...
		case NATIONAL_DEX_SPOTTYBULBEAR:
			*table = gSpottyBulbearSpreads; //Sooo many different forms of SpottyBulbear
			*spreadCount = TOTAL_SPOTTYBULBEAR_SPREADS;
			break;
		#endif
...
static u16 TryAdjustAestheticSpecies(u16 species)
{
	...
	switch (nationalDexNum) {
		...
		#endif
		default:
			#ifdef SPECIES_SPOTTYBULBEAR_CAP_ORIGINAL
			if (species == SPECIES_SPOTTYBULBEAR_CAP_ORIGINAL)
				species = gSpottyBulbearCapForms[Random() % gNumSpottyBulbearCapForms];
			#endif
			break;
	}
...
const species_t gGeneralTrainerSpreads[NUM_TRAINER_CLASSES][NUM_BADGE_OPTIONS][NUM_MONS_PER_BADGE] = {
    [CLASS_PKMN_TRAINER_1] = {
        [0] = {SPECIES_DUDUNSPARCE_THREE, SPECIES_LECHONK, SPECIES_SQUAWKABILLY_YELLOW, SPECIES_OINKOLOGNE, SPECIES_PATRAT, SPECIES_DEERLING_WINTER, SPECIES_ZORUA_H, SPECIES_TAILLOW, SPECIES_LILLIPUP, SPECIES_CRUMBUG_A},
        [1] = {SPECIES_GRAFAIAI, SPECIES_EGG, SPECIES_OINKOLOGNE_FEMALE, SPECIES_YUNGOOS, SPECIES_BIDOOF, SPECIES_SENTRET, SPECIES_PIDOVE, SPECIES_DEERLING_AUTUMN, SPECIES_CRUMBUG_A, SPECIES_TERAPAGOS_TERASTAL},
        [2] = {SPECIES_PIKIPEK, SPECIES_DUDUNSPARCE, SPECIES_DEERLING, SPECIES_DEERLING_WINTER, SPECIES_CRUMBUG_A, SPECIES_OINKOLOGNE_FEMALE, SPECIES_ARBOLIVA, SPECIES_SNOWBULBORB, SPECIES_SQUAWKABILLY_BLUE, SPECIES_YUNGOOS},
        ...
        [4] = {SPECIES_BREADBUG, SPECIES_TRANQUILL, SPECIES_WOOLOO, SPECIES_SWABLU, SPECIES_DWARFFROSTYBULBORB, SPECIES_CASTFORM, SPECIES_WATCHOG, SPECIES_LOUDRED, SPECIES_LINOONE_G, SPECIES_FARFETCHD},
        [5] = {SPECIES_STUFFUL, SPECIES_FARFETCHD, SPECIES_DUNSPARCE, SPECIES_KECLEON, SPECIES_LITLEO, SPECIES_BREADBUG, SPECIES_BUNEARY, SPECIES_SWABLU, SPECIES_LINOONE_G, SPECIES_HERDIER},
    ...
    [CLASS_PKMN_TRAINER_2] = {
        [0] = {SPECIES_SKWOVET, SPECIES_SQUAWKABILLY_BLUE, SPECIES_DWARFBULBORB_GIGA, SPECIES_SQUAWKABILLY_YELLOW, SPECIES_SQUAWKABILLY, SPECIES_FARIGIRAF, SPECIES_SMOLIV, SPECIES_HOOTHOOT, SPECIES_EGG, SPECIES_TANDEMAUS},
        ...
        [2] = {SPECIES_LECHONK, SPECIES_IGGLYBUFF, SPECIES_HOOTHOOT, SPECIES_ZIGZAGOON_G, SPECIES_CRUMBUG, SPECIES_SNOWBULBORB, SPECIES_LILLIPUP, SPECIES_SHROODLE, SPECIES_PIDOVE, SPECIES_DEERLING_SUMMER},
        [3] = {SPECIES_LITLEO, SPECIES_EEVEE, SPECIES_PYROCLASTICSLOOCH, SPECIES_PORYGON, SPECIES_FARFETCHD, SPECIES_DWARFFROSTYBULBORB, SPECIES_AIPOM, SPECIES_TEDDIURSA, SPECIES_DWARFORANGEBULBORB, SPECIES_BREADBUG},
        [4] = {SPECIES_LOUDRED, SPECIES_DWARFORANGEBULBORB, SPECIES_SPINDA, SPECIES_SLAKOTH, SPECIES_TEDDIURSA, SPECIES_SWABLU, SPECIES_DELCATTY, SPECIES_EEVEE, SPECIES_FOOLIX, SPECIES_TRUMBEAK},
        [5] = {SPECIES_TRANQUILL, SPECIES_CHATOT, SPECIES_SLAKOTH, SPECIES_BREADBUG, SPECIES_GOOLIX, SPECIES_VIGOROTH, SPECIES_BIBAREL, SPECIES_SPINDA, SPECIES_TRUMBEAK, SPECIES_MUNCHLAX},
        ...
        [8] = {SPECIES_FROSTYBULBORB, SPECIES_INDEEDEE_FEMALE, SPECIES_PORYGON2, SPECIES_SNORLAX, SPECIES_ORANGURU, SPECIES_ZOROARK_H, SPECIES_PYROAR, SPECIES_FURFROU_STAR, SPECIES_FURFROU, SPECIES_SAWSBUCK_SUMMER},
        [9] = {SPECIES_FEAROW, SPECIES_CINCCINO, SPECIES_HAPPINY, SPECIES_SNORLAX_GIGA, SPECIES_KOMALA, SPECIES_BEWEAR, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_TAUROS, SPECIES_FURFROU_DANDY, SPECIES_PORYGON_Z},
    },
    [CLASS_AQUA_LEADER] = {
        [0] = {SPECIES_HOOTHOOT, SPECIES_OINKOLOGNE_FEMALE, SPECIES_SNOWBULBORB, SPECIES_OINKOLOGNE, SPECIES_SHROODLE, SPECIES_HELIOPTILE, SPECIES_MINCCINO, SPECIES_TERAPAGOS, SPECIES_AZURILL, SPECIES_PIKIPEK},
        [1] = {SPECIES_CYCLIZAR, SPECIES_SQUAWKABILLY_WHITE, SPECIES_SENTRET, SPECIES_MAUSHOLD_FOUR, SPECIES_GIANTBREADBUG, SPECIES_ZIGZAGOON, SPECIES_HELIOPTILE, SPECIES_DWARFBULBORB, SPECIES_OINKOLOGNE_FEMALE, SPECIES_PIKIPEK},
        [2] = {SPECIES_DUDUNSPARCE_THREE, SPECIES_ZIGZAGOON, SPECIES_SQUAWKABILLY_BLUE, SPECIES_DEERLING, SPECIES_DEERLING_WINTER, SPECIES_CRUMBUG, SPECIES_LECHONK, SPECIES_MAUSHOLD_FOUR, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_FLETCHLING},
        [3] = {SPECIES_EEVEE, SPECIES_DIGGERSBY, SPECIES_CASTFORM, SPECIES_BREADBUG, SPECIES_SLAKOTH, SPECIES_WOOLOO, SPECIES_BUNEARY, SPECIES_FOOLIX, SPECIES_GIRAFARIG, SPECIES_GLAMEOW},
        [4] = {SPECIES_SPINDA, SPECIES_TRANQUILL, SPECIES_FURRET, SPECIES_SWABLU, SPECIES_EEVEE, SPECIES_GOOLIX, SPECIES_STARAVIA, SPECIES_LOUDRED, SPECIES_CHATOT, SPECIES_LINOONE_G},
        [5] = {SPECIES_VIGOROTH, SPECIES_AIPOM, SPECIES_SWABLU, SPECIES_TRUMBEAK, SPECIES_LOUDRED, SPECIES_EEVEE, SPECIES_SLAKOTH, SPECIES_SMEARGLE, SPECIES_GOOLIX, SPECIES_MUNCHLAX},
    ...
    [CLASS_TEAM_AQUA] = {
        ...
        [1] = {SPECIES_MINCCINO, SPECIES_TERAPAGOS_STELLAR, SPECIES_TAILLOW, SPECIES_MAUSHOLD, SPECIES_GRAFAIAI, SPECIES_HELIOPTILE, SPECIES_PATRAT, SPECIES_HOOTHOOT, SPECIES_ZIGZAGOON, SPECIES_SNOWBULBORB},
        [2] = {SPECIES_TERAPAGOS_TERASTAL, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_MAUSHOLD_FOUR, SPECIES_TERAPAGOS, SPECIES_BIDOOF, SPECIES_BUNNELBY, SPECIES_SQUAWKABILLY_BLUE, SPECIES_OINKOLOGNE, SPECIES_SENTRET, SPECIES_IGGLYBUFF},
        [3] = {SPECIES_PORYGON, SPECIES_LOUDRED, SPECIES_VIGOROTH, SPECIES_FURRET, SPECIES_CASTFORM, SPECIES_DIGGERSBY, SPECIES_KECLEON, SPECIES_DWARFORANGEBULBORB, SPECIES_DUNSPARCE, SPECIES_GLAMEOW},
        ...
        [7] = {SPECIES_INDEEDEE_FEMALE, SPECIES_BOUFFALANT, SPECIES_CHANSEY, SPECIES_PORYGON_Z, SPECIES_FROSTYBULBORB, SPECIES_WYRDEER, SPECIES_UNFEZANT_F, SPECIES_SAWSBUCK_AUTUMN, SPECIES_STARAPTOR, SPECIES_KANGASKHAN},
        ...
        [9] = {SPECIES_FURFROU_LA_REINE, SPECIES_AUDINO_MEGA, SPECIES_BLISSEY, SPECIES_MELOETTA_PIROUETTE, SPECIES_SAWSBUCK_WINTER, SPECIES_FROSTYBULBORB_MEGA, SPECIES_MELOETTA, SPECIES_KANGASKHAN_MEGA, SPECIES_ZANGOOSE, SPECIES_FURFROU_PHAROAH},
    },
    [CLASS_AROMA_LADY_RS] = {
        [0] = {SPECIES_SHROODLE, SPECIES_WHISMUR, SPECIES_GRAFAIAI, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_URSALUNA_BLOODMOON, SPECIES_DOLLIV, SPECIES_HELIOPTILE, SPECIES_SMOLIV, SPECIES_SNOWBULBORB, SPECIES_DWARFBULBORB},
        [1] = {SPECIES_ARBOLIVA, SPECIES_DEERLING_SUMMER, SPECIES_DEERLING_WINTER, SPECIES_IGGLYBUFF, SPECIES_PIKIPEK, SPECIES_DWARFBULBORB_GIGA, SPECIES_PATRAT, SPECIES_FLETCHLING, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_MAUSHOLD},
        ...
        [3] = {SPECIES_STUFFUL, SPECIES_LINOONE_G, SPECIES_WATCHOG, SPECIES_CASTFORM, SPECIES_MOCKIWI, SPECIES_VIGOROTH, SPECIES_PORYGON, SPECIES_PYROCLASTICSLOOCH, SPECIES_BIBAREL, SPECIES_AIPOM},
        [4] = {SPECIES_FARFETCHD, SPECIES_GUMSHOOS, SPECIES_FURRET, SPECIES_SWABLU, SPECIES_DIGGERSBY, SPECIES_PYROCLASTICSLOOCH, SPECIES_CHATOT, SPECIES_GOOLIX, SPECIES_STUFFUL, SPECIES_KECLEON},
        ...
        [8] = {SPECIES_ORANGURU, SPECIES_CINCCINO, SPECIES_FURFROU_HEART, SPECIES_KANGASKHAN_MEGA, SPECIES_BLISSEY, SPECIES_BOUFFALANT, SPECIES_ZOROARK_H, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_HAPPINY, SPECIES_STOUTLAND},
    ...
    [CLASS_RUIN_MANIAC_RS] = {
        [0] = {SPECIES_FLETCHLING, SPECIES_PIKIPEK, SPECIES_DWARFBULBORB, SPECIES_TERAPAGOS_STELLAR, SPECIES_MINCCINO, SPECIES_PATRAT, SPECIES_ZIGZAGOON_G, SPECIES_GRAFAIAI, SPECIES_MAUSHOLD_FOUR, SPECIES_DEERLING_SUMMER},
        [1] = {SPECIES_BIDOOF, SPECIES_CYCLIZAR, SPECIES_AZURILL, SPECIES_YUNGOOS, SPECIES_ZORUA_H, SPECIES_DEERLING_SUMMER, SPECIES_PIKIPEK, SPECIES_GRAFAIAI, SPECIES_SHROODLE, SPECIES_CRUMBUG_A},
        [2] = {SPECIES_CYCLIZAR, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_DOLLIV, SPECIES_MINCCINO, SPECIES_BUNNELBY, SPECIES_LECHONK, SPECIES_IGGLYBUFF, SPECIES_SMOLIV, SPECIES_SQUAWKABILLY_YELLOW, SPECIES_TAILLOW},
        [3] = {SPECIES_DELCATTY, SPECIES_AIPOM, SPECIES_DUNSPARCE, SPECIES_TRANQUILL, SPECIES_FURRET, SPECIES_HERDIER, SPECIES_BUNEARY, SPECIES_BREADBUG_A, SPECIES_LINOONE, SPECIES_TEDDIURSA},
        [4] = {SPECIES_CHATOT, SPECIES_EEVEE, SPECIES_LITLEO, SPECIES_WATCHOG, SPECIES_STARAVIA, SPECIES_GOOLIX, SPECIES_HERDIER, SPECIES_TEDDIURSA, SPECIES_MUNCHLAX, SPECIES_DUNSPARCE},
        [5] = {SPECIES_HERDIER, SPECIES_WOOLOO, SPECIES_MOCKIWI, SPECIES_FURRET, SPECIES_TRANQUILL, SPECIES_SMEARGLE, SPECIES_CASTFORM, SPECIES_SPINDA, SPECIES_WATCHOG, SPECIES_BREADBUG},
        [6] = {SPECIES_AUDINO_MEGA, SPECIES_PYROAR, SPECIES_ZANGOOSE, SPECIES_AUDINO, SPECIES_BLISSEY, SPECIES_PORYGON2, SPECIES_FROSTYBULBORB_MEGA, SPECIES_DUBWOOL, SPECIES_UNFEZANT_F, SPECIES_LOPUNNY_MEGA},
        [7] = {SPECIES_FURFROU_HEART, SPECIES_FURFROU_DANDY, SPECIES_AMBIPOM, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_FURFROU_KABUKI, SPECIES_PURUGLY, SPECIES_ZOROARK_H, SPECIES_MELOETTA_PIROUETTE, SPECIES_FURFROU, SPECIES_DUBWOOL},
    ...
    [CLASS_INTERVIEWER] = {
        [0] = {SPECIES_GIANTBREADBUG, SPECIES_OINKOLOGNE_FEMALE, SPECIES_TERAPAGOS_TERASTAL, SPECIES_BIDOOF, SPECIES_DUDUNSPARCE, SPECIES_DEERLING_AUTUMN, SPECIES_WHISMUR, SPECIES_PATRAT, SPECIES_SHROODLE, SPECIES_EGG},
        ...
        [2] = {SPECIES_DEERLING, SPECIES_ZORUA_H, SPECIES_ZIGZAGOON_G, SPECIES_SQUAWKABILLY_WHITE, SPECIES_TERAPAGOS, SPECIES_CRUMBUG, SPECIES_EGG, SPECIES_SKWOVET, SPECIES_DEERLING_WINTER, SPECIES_CRUMBUG_A},
        [3] = {SPECIES_TEDDIURSA, SPECIES_DIGGERSBY, SPECIES_DUNSPARCE, SPECIES_LOUDRED, SPECIES_WATCHOG, SPECIES_EEVEE_GIGA, SPECIES_GOOLIX, SPECIES_BREADBUG, SPECIES_GIRAFARIG, SPECIES_DELCATTY},
        [4] = {SPECIES_FURRET, SPECIES_DELCATTY, SPECIES_BREADBUG, SPECIES_STUFFUL, SPECIES_WOOLOO, SPECIES_GOOLIX, SPECIES_EEVEE_GIGA, SPECIES_MOCKIWI, SPECIES_GLAMEOW, SPECIES_LOUDRED},
        [5] = {SPECIES_BREADBUG, SPECIES_EEVEE, SPECIES_CASTFORM, SPECIES_DIGGERSBY, SPECIES_VIGOROTH, SPECIES_LITLEO, SPECIES_LINOONE, SPECIES_STUFFUL, SPECIES_DELCATTY, SPECIES_DUNSPARCE},
        ...
        [7] = {SPECIES_HAPPINY, SPECIES_GREEDENT, SPECIES_FROSTYBULBORB, SPECIES_CHANSEY, SPECIES_EXPLOUD, SPECIES_STANTLER, SPECIES_ARCEUS, SPECIES_INDEEDEE_FEMALE, SPECIES_DRAMPA, SPECIES_KANGASKHAN_MEGA},
    ...
    [CLASS_TUBER_RS_1] = {
        ...
        [1] = {SPECIES_POPPLIO, SPECIES_WALKING_WAKE, SPECIES_DEWPIDER, SPECIES_TATSUGIRI, SPECIES_PELLETPOSY, SPECIES_FROAKIE, SPECIES_QUAXWELL, SPECIES_PIPLUP, SPECIES_CLAUNCHER, SPECIES_WOOPER},
        ...
        [4] = {SPECIES_LOTAD, SPECIES_SLOWPOKE, SPECIES_MAREANIE, SPECIES_MANTYKE, SPECIES_PANPOUR, SPECIES_QWILFISH, SPECIES_POLIWHIRL, SPECIES_TOXSTOOL, SPECIES_BIBAREL, SPECIES_WAILMER},
        [5] = {SPECIES_BLIZZARDINGBLOWHOG, SPECIES_PALPITOAD, SPECIES_GREATERSPOTTEDJELLYFLOAT, SPECIES_ROTOM_WASH, SPECIES_WISHIWASHI, SPECIES_WAILMER, SPECIES_BASCULIN_H, SPECIES_OMANYTE, SPECIES_QWILFISH, SPECIES_BIBAREL},
        [6] = {SPECIES_SNOWFLAKEFLUTTERTAIL, SPECIES_CRAMORANT_GORGING, SPECIES_PHIONE, SPECIES_OATCHI, SPECIES_MASTERONION_MEGA, SPECIES_EMPOLEON, SPECIES_JELLICENT_F, SPECIES_GASTRODON, SPECIES_PELIPPER, SPECIES_BEARDEDAMPRAT},
        [7] = {SPECIES_VOLCANION, SPECIES_CRAMORANT_GORGING, SPECIES_MASTERHOP_GIGA, SPECIES_WAILORD, SPECIES_OATCHI_GIGA, SPECIES_HUNTAIL, SPECIES_FLOATZEL, SPECIES_ALOMOMOLA, SPECIES_CRAWDAUNT, SPECIES_OATCHI},
        ...
        [9] = {SPECIES_OMASTAR, SPECIES_KABUTOPS, SPECIES_PALKIA, SPECIES_DEWGONG, SPECIES_SNOWFLAKEFLUTTERTAIL, SPECIES_RELICANTH, SPECIES_SWAMPERT_MEGA, SPECIES_DREDNAW_GIGA, SPECIES_OATCHI_GIGA, SPECIES_WALREIN},
    },
    [CLASS_TUBER_RS_2] = {
        ...
        [1] = {SPECIES_IRON_BUNDLE, SPECIES_WIMPOD, SPECIES_WOLPOLE, SPECIES_FRILLISH_F, SPECIES_DEWPIDER, SPECIES_VELUZA, SPECIES_WALKING_WAKE, SPECIES_QUAQUAVAL, SPECIES_WOOPER, SPECIES_PELLETPOSY},
        ...
        [3] = {SPECIES_FROGADIER, SPECIES_BRIONNE, SPECIES_WAILMER, SPECIES_TOXSTOOL, SPECIES_SLOWPOKE, SPECIES_FINNEON, SPECIES_BASCULIN_H, SPECIES_SEALEO, SPECIES_MAREANIE, SPECIES_BASCULIN_BLUE},
        [4] = {SPECIES_HORSEA, SPECIES_PRINPLUP, SPECIES_BLIZZARDINGBLOWHOG, SPECIES_BARBOACH, SPECIES_WISHIWASHI, SPECIES_CLAMPERL, SPECIES_DRIZZILE, SPECIES_PANPOUR, SPECIES_ROTOM_WASH, SPECIES_TIRTOUGA},
        [5] = {SPECIES_OMANYTE, SPECIES_SHELLOS, SPECIES_GREATERSPOTTEDJELLYFLOAT, SPECIES_WAILMER, SPECIES_QUAGSIRE, SPECIES_SILVALLY_WATER, SPECIES_BASCULIN_BLUE, SPECIES_SPHEAL, SPECIES_YELLOWWOLLYHOP, SPECIES_GOLDEEN},
        [6] = {SPECIES_INTELEON_GIGA, SPECIES_KYOGRE_PRIMAL, SPECIES_SHARPEDO, SPECIES_SUICUNE, SPECIES_FERALIGATR, SPECIES_SHARPEDO_MEGA, SPECIES_MASTERHOP_MEGA, SPECIES_HUNTAIL, SPECIES_BARBARACLE, SPECIES_LANTURN},
        [7] = {SPECIES_MANTINE, SPECIES_SEISMITOAD, SPECIES_KYOGRE_PRIMAL, SPECIES_POLITOED, SPECIES_ALOMOMOLA, SPECIES_PHOSBAT, SPECIES_CRAMORANT_GULPING, SPECIES_OMASTAR, SPECIES_BURROWNIT, SPECIES_KINGDRA},
        [8] = {SPECIES_CRAMORANT, SPECIES_MANTINE, SPECIES_KYOGRE, SPECIES_DREDNAW, SPECIES_MASTERHOP_MEGA, SPECIES_LUDICOLO, SPECIES_PELIPPER, SPECIES_CARRACOSTA, SPECIES_BURROWNIT, SPECIES_CLOYSTER},
        [9] = {SPECIES_SLOWKING, SPECIES_SLOWBRO_MEGA, SPECIES_MASTERONION_MEGA, SPECIES_CRAMORANT_GULPING, SPECIES_KELDEO_RESOLUTE, SPECIES_CRAMORANT_GORGING, SPECIES_INTELEON_GIGA, SPECIES_GATTLINGGROINK, SPECIES_PALKIA, SPECIES_SWAMPERT},
    },
    [CLASS_COOLTRAINER_RS] = {
        [0] = {SPECIES_BIDOOF, SPECIES_STARLY, SPECIES_SKWOVET, SPECIES_SNOWBULBORB, SPECIES_LECHONK, SPECIES_MAUSHOLD, SPECIES_SQUAWKABILLY_WHITE, SPECIES_ZIGZAGOON_G, SPECIES_DEERLING, SPECIES_DEERLING_SUMMER},
        [1] = {SPECIES_GRAFAIAI, SPECIES_ZORUA_H, SPECIES_DWARFBULBORB, SPECIES_GIANTBREADBUG, SPECIES_CRUMBUG_A, SPECIES_SMOLIV, SPECIES_AZURILL, SPECIES_STARLY, SPECIES_DEERLING_SUMMER, SPECIES_SNOWBULBORB},
        [2] = {SPECIES_YUNGOOS, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_SHROODLE, SPECIES_URSALUNA_BLOODMOON, SPECIES_SNOWBULBORB, SPECIES_SKITTY, SPECIES_IGGLYBUFF, SPECIES_ZIGZAGOON, SPECIES_TERAPAGOS_STELLAR, SPECIES_ZORUA_H},
        [3] = {SPECIES_BUNEARY, SPECIES_GLAMEOW, SPECIES_WATCHOG, SPECIES_GOOLIX, SPECIES_STUFFUL, SPECIES_VIGOROTH, SPECIES_PORYGON, SPECIES_STARAVIA, SPECIES_DIGGERSBY, SPECIES_TYPE_NULL},
        [4] = {SPECIES_TEDDIURSA, SPECIES_GLAMEOW, SPECIES_EEVEE_GIGA, SPECIES_BUNEARY, SPECIES_CASTFORM, SPECIES_STARAVIA, SPECIES_LINOONE_G, SPECIES_MOCKIWI, SPECIES_GOOLIX, SPECIES_VIGOROTH},
        [5] = {SPECIES_LINOONE_G, SPECIES_GOOLIX, SPECIES_KECLEON, SPECIES_BREADBUG, SPECIES_TRUMBEAK, SPECIES_EEVEE, SPECIES_STUFFUL, SPECIES_STARAVIA, SPECIES_VIGOROTH, SPECIES_DUNSPARCE},
        ...
        [8] = {SPECIES_PURUGLY, SPECIES_BLISSEY, SPECIES_FURFROU_MATRON, SPECIES_BRAVIARY, SPECIES_FROSTYBULBORB_MEGA, SPECIES_FURFROU_KABUKI, SPECIES_REGIGIGAS, SPECIES_URSALUNA, SPECIES_SWELLOW, SPECIES_KOMALA},
    ...
    [CLASS_HEX_MANIAC] = {
        ...
        [3] = {SPECIES_SABLEYE_MEGA, SPECIES_DOTTLER, SPECIES_SMOOCHUM, SPECIES_MUNNA, SPECIES_BEADYLONGLEGS, SPECIES_HATTREM, SPECIES_SWOOBAT, SPECIES_WOLLYHOP_A, SPECIES_SHUPPET, SPECIES_SILVALLY_GHOST},
        [4] = {SPECIES_SHEDINJA, SPECIES_CHIMECHO, SPECIES_CHINGLING, SPECIES_SABLEYE_MEGA, SPECIES_MIME_JR_G, SPECIES_SANDYGAST, SPECIES_BELDUM, SPECIES_SILVALLY_GHOST, SPECIES_SPOTTYBULBEAR_PHD, SPECIES_DUOSION},
        [5] = {SPECIES_MEDITITE, SPECIES_SPOTTYBULBEAR_PHD, SPECIES_WOLLYHOP_A, SPECIES_MUNNA, SPECIES_SMOOCHUM, SPECIES_SILVALLY_GHOST, SPECIES_ROTOM, SPECIES_LAMPENT, SPECIES_MIME_JR, SPECIES_SUNQUISH},
        [6] = {SPECIES_GOLURK, SPECIES_INDEEDEE_FEMALE, SPECIES_RAGINGLONGLEGS, SPECIES_POLTEAGEIST_CHIPPED, SPECIES_GARDEVOIR_MEGA, SPECIES_MISMAGIUS, SPECIES_CHANDELURE, SPECIES_GRUMPIG, SPECIES_BRAVIARY_H, SPECIES_MEWTWO_MEGA_Y},
        [7] = {SPECIES_GOURGEIST_L, SPECIES_TYPHLOSION_H, SPECIES_XATU, SPECIES_GRUMPIG, SPECIES_ZOROARK_H, SPECIES_GARDEVOIR_MEGA, SPECIES_SLOWKING, SPECIES_VOLATILEDWEEVIL, SPECIES_ORBEETLE, SPECIES_NECROZMA_DUSK_MANE},
        [8] = {SPECIES_SIGILYPH, SPECIES_JELLICENT_F, SPECIES_BANETTE_MEGA, SPECIES_TREVENANT, SPECIES_GRUMPIG, SPECIES_SLOWBRO, SPECIES_PRICKLEPUFF_G, SPECIES_MALAMAR, SPECIES_DOUBLADE, SPECIES_SOLROCK},
    ...
    [CLASS_LADY_RS] = {
        [0] = {SPECIES_SENTRET, SPECIES_AZURILL, SPECIES_TERAPAGOS, SPECIES_OINKOLOGNE_FEMALE, SPECIES_ZIGZAGOON_G, SPECIES_MAUSHOLD_FOUR, SPECIES_WHISMUR, SPECIES_TANDEMAUS, SPECIES_STARLY, SPECIES_QUAGGLEDMIRECLOPS},
        [1] = {SPECIES_SNOWBULBORB, SPECIES_PIDOVE, SPECIES_TERAPAGOS_TERASTAL, SPECIES_GRAFAIAI, SPECIES_GIANTBREADBUG, SPECIES_FLETCHLING, SPECIES_ZORUA_H, SPECIES_HELIOPTILE, SPECIES_FARIGIRAF, SPECIES_TERAPAGOS_STELLAR},
        [2] = {SPECIES_SKITTY, SPECIES_CRUMBUG_A, SPECIES_TERAPAGOS_STELLAR, SPECIES_DOLLIV, SPECIES_PIKIPEK, SPECIES_SKWOVET, SPECIES_HELIOPTILE, SPECIES_GRAFAIAI, SPECIES_DEERLING_SUMMER, SPECIES_OINKOLOGNE_FEMALE},
        [3] = {SPECIES_GLAMEOW, SPECIES_LOUDRED, SPECIES_TRANQUILL, SPECIES_CASTFORM, SPECIES_LINOONE_G, SPECIES_BIBAREL, SPECIES_LITLEO, SPECIES_MUNCHLAX, SPECIES_BREADBUG, SPECIES_EEVEE_GIGA},
        [4] = {SPECIES_EEVEE_GIGA, SPECIES_CHATOT, SPECIES_WOOLOO, SPECIES_STARAVIA, SPECIES_GOOLIX, SPECIES_TEDDIURSA, SPECIES_GIRAFARIG, SPECIES_RUFFLET, SPECIES_GLAMEOW, SPECIES_GUMSHOOS},
        [5] = {SPECIES_DELCATTY, SPECIES_KECLEON, SPECIES_LINOONE_G, SPECIES_STARAVIA, SPECIES_STUFFUL, SPECIES_VIGOROTH, SPECIES_PYROCLASTICSLOOCH, SPECIES_CASTFORM, SPECIES_BREADBUG_A, SPECIES_DWARFFROSTYBULBORB},
        ...
        [9] = {SPECIES_PORYGON2, SPECIES_FURFROU_STAR, SPECIES_KANGASKHAN_MEGA, SPECIES_FURFROU_LA_REINE, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_INDEEDEE, SPECIES_INDEEDEE_FEMALE, SPECIES_AUDINO, SPECIES_HELIOLISK, SPECIES_SNORLAX},
    },
    [CLASS_BEAUTY_RS] = {
        [0] = {SPECIES_SENTRET, SPECIES_FARIGIRAF, SPECIES_SQUAWKABILLY_YELLOW, SPECIES_DOLLIV, SPECIES_SQUAWKABILLY, SPECIES_BUNNELBY, SPECIES_DEERLING_WINTER, SPECIES_DUDUNSPARCE, SPECIES_DWARFBULBORB, SPECIES_YUNGOOS},
        [1] = {SPECIES_QUAGGLEDMIRECLOPS, SPECIES_HELIOPTILE, SPECIES_DEERLING_SUMMER, SPECIES_DWARFBULBORB, SPECIES_GIANTBREADBUG, SPECIES_DUDUNSPARCE_THREE, SPECIES_LECHONK, SPECIES_TAILLOW, SPECIES_ZIGZAGOON_G, SPECIES_TERAPAGOS_TERASTAL},
        [2] = {SPECIES_BIDOOF, SPECIES_YUNGOOS, SPECIES_SQUAWKABILLY, SPECIES_DWARFBULBORB, SPECIES_OINKOLOGNE_FEMALE, SPECIES_SNOWBULBORB, SPECIES_URSALUNA_BLOODMOON, SPECIES_MINCCINO, SPECIES_MAUSHOLD_FOUR, SPECIES_DEERLING_AUTUMN},
        [3] = {SPECIES_BREADBUG, SPECIES_SPINDA, SPECIES_DUNSPARCE, SPECIES_WOOLOO, SPECIES_LINOONE, SPECIES_PORYGON, SPECIES_STUFFUL, SPECIES_GUMSHOOS, SPECIES_SWABLU, SPECIES_BREADBUG_A},
        [4] = {SPECIES_MOCKIWI, SPECIES_SMEARGLE, SPECIES_SPINDA, SPECIES_BUNEARY, SPECIES_LINOONE_G, SPECIES_EEVEE_GIGA, SPECIES_GLAMEOW, SPECIES_FARFETCHD, SPECIES_GOOLIX, SPECIES_KECLEON},
        [5] = {SPECIES_RUFFLET, SPECIES_PORYGON, SPECIES_TRANQUILL, SPECIES_FARFETCHD, SPECIES_STARAVIA, SPECIES_GIRAFARIG, SPECIES_HERDIER, SPECIES_DIGGERSBY, SPECIES_BREADBUG_A, SPECIES_VIGOROTH},
        ...
        [7] = {SPECIES_AMBIPOM, SPECIES_SAWSBUCK_WINTER, SPECIES_ZANGOOSE, SPECIES_KOMALA, SPECIES_FURFROU_HEART, SPECIES_FURFROU_STAR, SPECIES_FEAROW, SPECIES_LOPUNNY_MEGA, SPECIES_INDEEDEE, SPECIES_FROSTYBULBORB_MEGA},
    ...
    [CLASS_RICH_BOY] = {
        [0] = {SPECIES_SNOWBULBORB, SPECIES_ZIGZAGOON, SPECIES_DUDUNSPARCE, SPECIES_ZIGZAGOON_G, SPECIES_DWARFBULBORB, SPECIES_IRON_JUGULIS, SPECIES_TING_LU, SPECIES_DEINO, SPECIES_TERAPAGOS_TERASTAL, SPECIES_OINKOLOGNE_FEMALE},
        [1] = {SPECIES_MABOSSTIFF, SPECIES_DWARFBULBORB_A, SPECIES_MAUSHOLD, SPECIES_ZIGZAGOON, SPECIES_TING_LU, SPECIES_TANDEMAUS, SPECIES_PIKIPEK, SPECIES_KINGAMBIT, SPECIES_CRUMBUG, SPECIES_ZIGZAGOON_G},
        [2] = {SPECIES_HELIOPTILE, SPECIES_IMPIDIMP, SPECIES_SKITTY, SPECIES_BOMBIRDIER, SPECIES_DWARFBULBORB_A, SPECIES_CHIEN_PAO, SPECIES_WHISMUR, SPECIES_BRUTE_BONNET, SPECIES_SQUAWKABILLY_WHITE, SPECIES_GRAFAIAI},
        [3] = {SPECIES_KECLEON, SPECIES_MIGHTYENA, SPECIES_FURRET, SPECIES_QWILFISH_H, SPECIES_DWARFORANGEBULBORB, SPECIES_BIBAREL, SPECIES_GLAMEOW, SPECIES_DWARFFROSTYBULBORB, SPECIES_STARAVIA, SPECIES_GRIMER_A},
        [4] = {SPECIES_GLAMEOW, SPECIES_PYROCLASTICSLOOCH, SPECIES_VULLABY, SPECIES_DIGGERSBY, SPECIES_DWARFBULBEAR, SPECIES_GRIMER_A, SPECIES_MORGREM, SPECIES_DWARFORANGEBULBORB_A, SPECIES_LITLEO, SPECIES_ZWEILOUS},
        ...
        [7] = {SPECIES_MANDIBUZZ, SPECIES_AMBIPOM, SPECIES_GUZZLORD, SPECIES_STANTLER, SPECIES_AUDINO_MEGA, SPECIES_ASHGRENINJA, SPECIES_SCRAFTY, SPECIES_ZOROARK_H, SPECIES_FROSTYBULBORB_MEGA, SPECIES_WYRDEER},
        ...
        [9] = {SPECIES_ABSOL_MEGA, SPECIES_KOMALA, SPECIES_ZARUDE_DADA, SPECIES_SLAKING, SPECIES_MALAMAR, SPECIES_INDEEDEE_FEMALE, SPECIES_MASTERONION_MEGA, SPECIES_SAWSBUCK_AUTUMN, SPECIES_HAPPINY, SPECIES_TYRANITAR},
    },
    [CLASS_POKEMANIAC_RS] = {
        [0] = {SPECIES_DEERLING_WINTER, SPECIES_TERAPAGOS_TERASTAL, SPECIES_OINKOLOGNE_FEMALE, SPECIES_DEERLING, SPECIES_GIANTBREADBUG, SPECIES_HELIOPTILE, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_SNOWBULBORB, SPECIES_SQUAWKABILLY, SPECIES_GRAFAIAI},
        [1] = {SPECIES_MINCCINO, SPECIES_OINKOLOGNE_FEMALE, SPECIES_YUNGOOS, SPECIES_ARBOLIVA, SPECIES_SQUAWKABILLY_BLUE, SPECIES_SENTRET, SPECIES_BIDOOF, SPECIES_CRUMBUG, SPECIES_WHISMUR, SPECIES_BUNNELBY},
        [2] = {SPECIES_PATRAT, SPECIES_GRAFAIAI, SPECIES_DEERLING_SUMMER, SPECIES_GIANTBREADBUG, SPECIES_HOOTHOOT, SPECIES_WHISMUR, SPECIES_LILLIPUP, SPECIES_TERAPAGOS_STELLAR, SPECIES_TANDEMAUS, SPECIES_IGGLYBUFF},
        [3] = {SPECIES_DUNSPARCE, SPECIES_AIPOM, SPECIES_SMEARGLE, SPECIES_KECLEON, SPECIES_FOOLIX, SPECIES_HERDIER, SPECIES_DWARFFROSTYBULBORB, SPECIES_MOCKIWI, SPECIES_WATCHOG, SPECIES_SLAKOTH},
        [4] = {SPECIES_SPINDA, SPECIES_BREADBUG, SPECIES_WATCHOG, SPECIES_DUNSPARCE, SPECIES_VIGOROTH, SPECIES_LITLEO, SPECIES_BREADBUG_A, SPECIES_SWABLU, SPECIES_STARAVIA, SPECIES_MUNCHLAX},
        [5] = {SPECIES_WATCHOG, SPECIES_AIPOM, SPECIES_LINOONE_G, SPECIES_TYPE_NULL, SPECIES_DUNSPARCE, SPECIES_PYROCLASTICSLOOCH, SPECIES_KECLEON, SPECIES_LOUDRED, SPECIES_SWABLU, SPECIES_BUNEARY},
        ...
        [9] = {SPECIES_PORYGON_Z, SPECIES_FROSTYBULBORB_MEGA, SPECIES_SNORLAX_GIGA, SPECIES_SAWSBUCK_WINTER, SPECIES_SAWSBUCK_SUMMER, SPECIES_SLAKING, SPECIES_STANTLER, SPECIES_MILTANK, SPECIES_WYRDEER, SPECIES_DRAMPA},
    },
    [CLASS_PKMN_TRAINER_RSE] = {
        ...
        [1] = {SPECIES_ZIGZAGOON_G, SPECIES_TERAPAGOS_STELLAR, SPECIES_LILLIPUP, SPECIES_AZURILL, SPECIES_YUNGOOS, SPECIES_DWARFBULBORB, SPECIES_GRAFAIAI, SPECIES_ZIGZAGOON, SPECIES_CRUMBUG_A, SPECIES_DEERLING_AUTUMN},
        ...
        [3] = {SPECIES_SMEARGLE, SPECIES_BUNEARY, SPECIES_KECLEON, SPECIES_CHATOT, SPECIES_BIBAREL, SPECIES_LINOONE, SPECIES_FARFETCHD, SPECIES_DUNSPARCE, SPECIES_STARAVIA, SPECIES_BREADBUG_A},
        [4] = {SPECIES_MOCKIWI, SPECIES_DUNSPARCE, SPECIES_TEDDIURSA, SPECIES_GLAMEOW, SPECIES_GUMSHOOS, SPECIES_KECLEON, SPECIES_STUFFUL, SPECIES_HERDIER, SPECIES_GOOLIX, SPECIES_EEVEE_GIGA},
        [5] = {SPECIES_MUNCHLAX, SPECIES_BUNEARY, SPECIES_LINOONE_G, SPECIES_GOOLIX, SPECIES_MOCKIWI, SPECIES_BREADBUG, SPECIES_LINOONE, SPECIES_EEVEE, SPECIES_AIPOM, SPECIES_DWARFORANGEBULBORB},
        ...
        [7] = {SPECIES_LOPUNNY, SPECIES_FROSTYBULBORB_MEGA, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_FURFROU, SPECIES_SAWSBUCK, SPECIES_FEAROW, SPECIES_ZOROARK_H, SPECIES_UNFEZANT, SPECIES_DUBWOOL, SPECIES_OBSTAGOON},
        [8] = {SPECIES_HAPPINY, SPECIES_FURFROU_MATRON, SPECIES_PORYGON_Z, SPECIES_SILVALLY, SPECIES_SLAKING, SPECIES_FROSTYBULBORB_MEGA, SPECIES_TOUCANNON, SPECIES_CINCCINO, SPECIES_MELOETTA, SPECIES_LESSERSPOTTEDJELLYFLOAT},
    ...
    [CLASS_BLACK_BELT_RS] = {
        [0] = {SPECIES_HOOTHOOT, SPECIES_CRUMBUG_A, SPECIES_STARLY, SPECIES_SHROODLE, SPECIES_LILLIPUP, SPECIES_BIDOOF, SPECIES_TAILLOW, SPECIES_SENTRET, SPECIES_DEERLING_AUTUMN, SPECIES_SQUAWKABILLY_WHITE},
        [1] = {SPECIES_TERAPAGOS_TERASTAL, SPECIES_CRUMBUG, SPECIES_SQUAWKABILLY_WHITE, SPECIES_IGGLYBUFF, SPECIES_DOLLIV, SPECIES_PIKIPEK, SPECIES_MAUSHOLD_FOUR, SPECIES_ARBOLIVA, SPECIES_MAUSHOLD, SPECIES_LILLIPUP},
        [2] = {SPECIES_SKWOVET, SPECIES_MINCCINO, SPECIES_BUNNELBY, SPECIES_YUNGOOS, SPECIES_SQUAWKABILLY_WHITE, SPECIES_SQUAWKABILLY_YELLOW, SPECIES_TERAPAGOS_TERASTAL, SPECIES_DWARFBULBORB_GIGA, SPECIES_SKITTY, SPECIES_AZURILL},
        [3] = {SPECIES_SLAKOTH, SPECIES_MOCKIWI, SPECIES_GOOLIX, SPECIES_LOUDRED, SPECIES_CASTFORM, SPECIES_TRUMBEAK, SPECIES_STARAVIA, SPECIES_GIRAFARIG, SPECIES_RUFFLET, SPECIES_CHATOT},
        [4] = {SPECIES_KECLEON, SPECIES_DWARFORANGEBULBORB, SPECIES_TRANQUILL, SPECIES_BREADBUG, SPECIES_GIRAFARIG, SPECIES_TEDDIURSA, SPECIES_LINOONE_G, SPECIES_CHATOT, SPECIES_DWARFFROSTYBULBORB, SPECIES_RUFFLET},
        [5] = {SPECIES_BIBAREL, SPECIES_GUMSHOOS, SPECIES_LINOONE, SPECIES_FOOLIX, SPECIES_TYPE_NULL, SPECIES_DIGGERSBY, SPECIES_TRANQUILL, SPECIES_BREADBUG, SPECIES_BREADBUG_A, SPECIES_GIRAFARIG},
    ...
    [CLASS_GUITARIST_RS] = {
        [0] = {SPECIES_EGG, SPECIES_OINKOLOGNE_FEMALE, SPECIES_DEERLING_AUTUMN, SPECIES_CRUMBUG, SPECIES_MINCCINO, SPECIES_TAILLOW, SPECIES_TERAPAGOS_STELLAR, SPECIES_ZORUA_H, SPECIES_CYCLIZAR, SPECIES_WHISMUR},
        [1] = {SPECIES_SKITTY, SPECIES_MAUSHOLD, SPECIES_OINKOLOGNE_FEMALE, SPECIES_DUDUNSPARCE_THREE, SPECIES_CRUMBUG_A, SPECIES_SNOWBULBORB, SPECIES_HOOTHOOT, SPECIES_BUNNELBY, SPECIES_PIKIPEK, SPECIES_SHROODLE},
        [2] = {SPECIES_LECHONK, SPECIES_DEERLING_AUTUMN, SPECIES_SNOWBULBORB, SPECIES_HOOTHOOT, SPECIES_AZURILL, SPECIES_SQUAWKABILLY, SPECIES_MAUSHOLD, SPECIES_SQUAWKABILLY_BLUE, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_SKITTY},
        [3] = {SPECIES_BUNEARY, SPECIES_DELCATTY, SPECIES_WATCHOG, SPECIES_STUFFUL, SPECIES_PYROCLASTICSLOOCH, SPECIES_WOOLOO, SPECIES_BIBAREL, SPECIES_PORYGON, SPECIES_DWARFORANGEBULBORB, SPECIES_TRUMBEAK},
        [4] = {SPECIES_BUNEARY, SPECIES_KECLEON, SPECIES_LITLEO, SPECIES_FOOLIX, SPECIES_STUFFUL, SPECIES_LOUDRED, SPECIES_SPINDA, SPECIES_BREADBUG_A, SPECIES_EEVEE_GIGA, SPECIES_PORYGON},
        [5] = {SPECIES_LINOONE, SPECIES_DIGGERSBY, SPECIES_DUNSPARCE, SPECIES_TYPE_NULL, SPECIES_STUFFUL, SPECIES_CHATOT, SPECIES_DWARFFROSTYBULBORB, SPECIES_BUNEARY, SPECIES_SMEARGLE, SPECIES_PORYGON},
    ...
    [CLASS_KINDLER] = {
        ...
        [1] = {SPECIES_CERULEDGE, SPECIES_FIERYBLOWLET, SPECIES_CHARCADET, SPECIES_ARISTOCRABOFFSPRING, SPECIES_TAUROS_BLAZE_P, SPECIES_GOUGING_FIRE, SPECIES_TEPIG, SPECIES_CROCALOR, SPECIES_ARMAROUGE, SPECIES_SKELEDIRGE},
        ...
        [3] = {SPECIES_BULBMIN, SPECIES_SILVALLY_FIRE, SPECIES_SLUGMA, SPECIES_LAMPENT, SPECIES_TORRACAT, SPECIES_COMBUSKEN, SPECIES_BULBMIN_H, SPECIES_RABOOT, SPECIES_CARKOL, SPECIES_NUMEL},
        [4] = {SPECIES_SCORCHCAKE_A, SPECIES_SUNFLORA, SPECIES_SLUGMA, SPECIES_LARVESTA, SPECIES_FLETCHINDER, SPECIES_BRAIXEN, SPECIES_HOUNDOUR, SPECIES_LITLEO, SPECIES_PANSEAR, SPECIES_SALANDIT},
        [5] = {SPECIES_FLETCHINDER, SPECIES_BULBMIN, SPECIES_QUILAVA, SPECIES_SILVALLY_FIRE, SPECIES_LITLEO, SPECIES_TORRACAT, SPECIES_COMBUSKEN, SPECIES_SLUGMA, SPECIES_ROTOM_HEAT, SPECIES_BULBMIN_H},
        [6] = {SPECIES_BLAZIKEN_MEGA, SPECIES_CAMERUPT, SPECIES_COALOSSAL_GIGA, SPECIES_GROUDON_PRIMAL, SPECIES_TITANBLOWHOG_MEGA_X, SPECIES_DARMANITAN, SPECIES_TALONFLAME, SPECIES_ENTEI, SPECIES_TYPHLOSION_H, SPECIES_CHANDELURE},
        [7] = {SPECIES_DARMANITAN, SPECIES_SALAZZLE, SPECIES_DELPHOX, SPECIES_HOUNDOOM, SPECIES_PRICKLEPUFF, SPECIES_PYROAR, SPECIES_RESHIRAM, SPECIES_SIMISEAR, SPECIES_BLAZIKEN, SPECIES_ORICORIO},
        [8] = {SPECIES_COALOSSAL, SPECIES_MAGCARGO, SPECIES_TORKOAL, SPECIES_ARCEUS_FIRE, SPECIES_HEATMOR, SPECIES_CENTISKORCH, SPECIES_PYROAR, SPECIES_ADULTBULBMIN_H, SPECIES_ENTEI, SPECIES_TITANBLOWHOG_MEGA_Y},
        [9] = {SPECIES_BLAZIKEN, SPECIES_TURTONATOR, SPECIES_TALONFLAME, SPECIES_BLAZIKEN_MEGA, SPECIES_HOUNDOOM, SPECIES_FLAREON, SPECIES_MAGMAR, SPECIES_ARISTOCRAB, SPECIES_COALOSSAL_GIGA, SPECIES_MOLTRES},
    },
    [CLASS_CAMPER_RS] = {
        [0] = {SPECIES_DEERLING_AUTUMN, SPECIES_CRUMBUG_A, SPECIES_AZURILL, SPECIES_ARBOLIVA, SPECIES_TANDEMAUS, SPECIES_TAILLOW, SPECIES_OINKOLOGNE, SPECIES_URSALUNA_BLOODMOON, SPECIES_FARIGIRAF, SPECIES_SKITTY},
        [1] = {SPECIES_WHISMUR, SPECIES_PIKIPEK, SPECIES_SMOLIV, SPECIES_ARBOLIVA, SPECIES_CRUMBUG, SPECIES_URSALUNA_BLOODMOON, SPECIES_HELIOPTILE, SPECIES_DUDUNSPARCE, SPECIES_PATRAT, SPECIES_DEERLING},
        ...
        [3] = {SPECIES_TEDDIURSA, SPECIES_EEVEE, SPECIES_RUFFLET, SPECIES_STUFFUL, SPECIES_PORYGON, SPECIES_KECLEON, SPECIES_GUMSHOOS, SPECIES_DWARFORANGEBULBORB, SPECIES_VIGOROTH, SPECIES_FURRET},
        [4] = {SPECIES_FOOLIX, SPECIES_BUNEARY, SPECIES_MOCKIWI, SPECIES_LINOONE_G, SPECIES_DUNSPARCE, SPECIES_TRANQUILL, SPECIES_FURRET, SPECIES_PORYGON, SPECIES_LITLEO, SPECIES_GOOLIX},
        [5] = {SPECIES_DWARFORANGEBULBORB, SPECIES_KECLEON, SPECIES_DWARFFROSTYBULBORB, SPECIES_CHATOT, SPECIES_WATCHOG, SPECIES_PYROCLASTICSLOOCH, SPECIES_GUMSHOOS, SPECIES_TEDDIURSA, SPECIES_DELCATTY, SPECIES_LOUDRED},
        [6] = {SPECIES_PYROAR, SPECIES_PYROAR_FEMALE, SPECIES_FURFROU_LA_REINE, SPECIES_FROSTYBULBORB, SPECIES_BOUFFALANT, SPECIES_FROSTYBULBORB_MEGA, SPECIES_STARAPTOR, SPECIES_EXPLOUD, SPECIES_LICKILICKY, SPECIES_SAWSBUCK},
        [7] = {SPECIES_SAWSBUCK_WINTER, SPECIES_REGIGIGAS, SPECIES_FROSTYBULBORB, SPECIES_FURFROU_DANDY, SPECIES_STOUTLAND, SPECIES_ZANGOOSE, SPECIES_STARAPTOR, SPECIES_BRAVIARY, SPECIES_FURFROU_DIAMOND, SPECIES_LOPUNNY},
    ...
    [CLASS_BUG_MANIAC] = {
        ...
        [3] = {SPECIES_SHEDINJA, SPECIES_YANMA, SPECIES_RIBOMBEE, SPECIES_ANORITH, SPECIES_CUTIEFLY, SPECIES_ARMOREDCANNONBEETLE, SPECIES_ARAQUANID, SPECIES_SHUCKLE, SPECIES_FORRETRESS, SPECIES_WORMADAM_TRASH},
        [4] = {SPECIES_SEWADDLE, SPECIES_LARVESTA, SPECIES_LEDIAN, SPECIES_CASCOON, SPECIES_STARTLESPORE, SPECIES_DOODLEBUG, SPECIES_ARIADOS, SPECIES_SILVALLY_BUG, SPECIES_SHEDINJA, SPECIES_CHARJABUG},
        [5] = {SPECIES_VIBRAVA, SPECIES_SWADLOON, SPECIES_ARAQUANID, SPECIES_LARVESTA, SPECIES_SKORUPI, SPECIES_RIBOMBEE, SPECIES_SPEWPA, SPECIES_ILLUMISE, SPECIES_WHIRLIPEDE, SPECIES_BUMBLINGSNITCHBUG},
        [6] = {SPECIES_DIRIGIBUG_MEGA, SPECIES_CENTISKORCH_GIGA, SPECIES_VIVILLON_CONTINENTAL, SPECIES_GLINTBEETLE_GIGA, SPECIES_HERACROSS, SPECIES_FROSMOTH, SPECIES_ARMALDO, SPECIES_VIVILLON_GARDEN, SPECIES_VIVILLON_ELEGANT, SPECIES_DIRIGIBUG},
        ...
        [8] = {SPECIES_YANMEGA, SPECIES_NINJASK, SPECIES_VIVILLON_POKEBALL, SPECIES_DIRIGIBUG_MEGA, SPECIES_MOTHIM, SPECIES_GENESECT_CHILL, SPECIES_VIVILLON_CONTINENTAL, SPECIES_VESPIQUEN, SPECIES_LEAVANNY, SPECIES_SCYTHER},
        [9] = {SPECIES_VIVILLON_HIGH_PLAINS, SPECIES_DIRIGIBUG_MEGA, SPECIES_ARCEUS_BUG, SPECIES_KLEAVOR, SPECIES_SCIZOR_MEGA, SPECIES_ACCELGOR, SPECIES_CRUSTLE, SPECIES_SCYTHER, SPECIES_VESPIQUEN, SPECIES_BUZZWOLE},
    },
    [CLASS_PSYCHIC_RS] = {
        [0] = {SPECIES_DOLLIV, SPECIES_TANDEMAUS, SPECIES_FLETCHLING, SPECIES_EGG, SPECIES_HELIOPTILE, SPECIES_LECHONK, SPECIES_SQUAWKABILLY_YELLOW, SPECIES_WHISMUR, SPECIES_CRUMBUG, SPECIES_MAUSHOLD},
        ...
        [2] = {SPECIES_AZURILL, SPECIES_CRUMBUG, SPECIES_BUNNELBY, SPECIES_ZIGZAGOON_G, SPECIES_PATRAT, SPECIES_SQUAWKABILLY_WHITE, SPECIES_HELIOPTILE, SPECIES_SQUAWKABILLY_YELLOW, SPECIES_DEERLING_AUTUMN, SPECIES_MINCCINO},
        [3] = {SPECIES_DUNSPARCE, SPECIES_SWABLU, SPECIES_PYROCLASTICSLOOCH, SPECIES_GOOLIX, SPECIES_FURRET, SPECIES_CASTFORM, SPECIES_WATCHOG, SPECIES_GLAMEOW, SPECIES_VIGOROTH, SPECIES_BREADBUG_A},
        [4] = {SPECIES_FOOLIX, SPECIES_DWARFORANGEBULBORB, SPECIES_SPINDA, SPECIES_BUNEARY, SPECIES_DIGGERSBY, SPECIES_GOOLIX, SPECIES_STARAVIA, SPECIES_TRANQUILL, SPECIES_CHATOT, SPECIES_LINOONE},
        [5] = {SPECIES_LOUDRED, SPECIES_BREADBUG_A, SPECIES_GIRAFARIG, SPECIES_DWARFFROSTYBULBORB, SPECIES_CASTFORM, SPECIES_DWARFORANGEBULBORB, SPECIES_RUFFLET, SPECIES_TEDDIURSA, SPECIES_VIGOROTH, SPECIES_TYPE_NULL},
        [6] = {SPECIES_FROSTYBULBORB, SPECIES_PYROAR, SPECIES_OBSTAGOON, SPECIES_FURFROU_STAR, SPECIES_PORYGON_Z, SPECIES_UNFEZANT, SPECIES_ZOROARK_H, SPECIES_SNORLAX_GIGA, SPECIES_SAWSBUCK_AUTUMN, SPECIES_LOPUNNY_MEGA},
        ...
        [8] = {SPECIES_FROSTYBULBORB, SPECIES_DRAMPA, SPECIES_FURFROU_DIAMOND, SPECIES_AMBIPOM, SPECIES_BEWEAR, SPECIES_OBSTAGOON, SPECIES_FURFROU_DEBUTANTE, SPECIES_SILVALLY, SPECIES_UNFEZANT, SPECIES_URSARING},
    ...
    [CLASS_GENTLEMAN_RS] = {
        ...
        [3] = {SPECIES_TEDDIURSA, SPECIES_FOOLIX, SPECIES_DWARFFROSTYBULBORB, SPECIES_STUFFUL, SPECIES_EEVEE_GIGA, SPECIES_AIPOM, SPECIES_DWARFORANGEBULBORB, SPECIES_PYROCLASTICSLOOCH, SPECIES_KECLEON, SPECIES_CHATOT},
        [4] = {SPECIES_BIBAREL, SPECIES_SLAKOTH, SPECIES_STARAVIA, SPECIES_TRUMBEAK, SPECIES_BREADBUG, SPECIES_DIGGERSBY, SPECIES_FARFETCHD, SPECIES_MOCKIWI, SPECIES_HERDIER, SPECIES_PORYGON},
        [5] = {SPECIES_TEDDIURSA, SPECIES_SPINDA, SPECIES_AIPOM, SPECIES_GUMSHOOS, SPECIES_FURRET, SPECIES_RUFFLET, SPECIES_GLAMEOW, SPECIES_DWARFORANGEBULBORB, SPECIES_LITLEO, SPECIES_DWARFFROSTYBULBORB},
    ...
    [CLASS_ELITE_FOUR_RS] = {
        [0] = {SPECIES_SMOLIV, SPECIES_EGG, SPECIES_PATRAT, SPECIES_HOOTHOOT, SPECIES_DEERLING, SPECIES_DOLLIV, SPECIES_GIANTBREADBUG, SPECIES_MINCCINO, SPECIES_ZIGZAGOON_G, SPECIES_SKITTY},
        [1] = {SPECIES_MAUSHOLD, SPECIES_URSALUNA_BLOODMOON, SPECIES_GIANTBREADBUG, SPECIES_GRAFAIAI, SPECIES_STARLY, SPECIES_ZIGZAGOON, SPECIES_SQUAWKABILLY_BLUE, SPECIES_SKWOVET, SPECIES_DEERLING, SPECIES_SQUAWKABILLY_WHITE},
        [2] = {SPECIES_MINCCINO, SPECIES_DEERLING, SPECIES_ZIGZAGOON, SPECIES_SNOWBULBORB, SPECIES_LILLIPUP, SPECIES_CRUMBUG_A, SPECIES_PIKIPEK, SPECIES_AZURILL, SPECIES_ARBOLIVA, SPECIES_DEERLING_SUMMER},
        [3] = {SPECIES_STARAVIA, SPECIES_LITLEO, SPECIES_DUNSPARCE, SPECIES_TYPE_NULL, SPECIES_BREADBUG, SPECIES_CASTFORM, SPECIES_LOUDRED, SPECIES_BIBAREL, SPECIES_MUNCHLAX, SPECIES_DWARFFROSTYBULBORB},
        [4] = {SPECIES_DIGGERSBY, SPECIES_DWARFORANGEBULBORB, SPECIES_PYROCLASTICSLOOCH, SPECIES_MOCKIWI, SPECIES_TRUMBEAK, SPECIES_FURRET, SPECIES_FARFETCHD, SPECIES_HERDIER, SPECIES_PORYGON, SPECIES_SLAKOTH},
        [5] = {SPECIES_PYROCLASTICSLOOCH, SPECIES_TRUMBEAK, SPECIES_PORYGON, SPECIES_LOUDRED, SPECIES_SLAKOTH, SPECIES_CASTFORM, SPECIES_CHATOT, SPECIES_WOOLOO, SPECIES_BUNEARY, SPECIES_EEVEE},
    ...
    [CLASS_LEADER_RS] = {
        ...
        [1] = {SPECIES_DWARFBULBORB_GIGA, SPECIES_GRAFAIAI, SPECIES_ARBOLIVA, SPECIES_SKITTY, SPECIES_PIDOVE, SPECIES_BUNNELBY, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_DUDUNSPARCE_THREE, SPECIES_EGG, SPECIES_DEERLING_SUMMER},
        [2] = {SPECIES_SQUAWKABILLY_WHITE, SPECIES_HELIOPTILE, SPECIES_AZURILL, SPECIES_DOLLIV, SPECIES_DUDUNSPARCE_THREE, SPECIES_DWARFBULBORB_GIGA, SPECIES_SNOWBULBORB, SPECIES_TAILLOW, SPECIES_BUNNELBY, SPECIES_GRAFAIAI},
        [3] = {SPECIES_GLAMEOW, SPECIES_FOOLIX, SPECIES_DWARFORANGEBULBORB, SPECIES_SPINDA, SPECIES_TRANQUILL, SPECIES_RUFFLET, SPECIES_STUFFUL, SPECIES_AIPOM, SPECIES_BIBAREL, SPECIES_GOOLIX},
        [4] = {SPECIES_MUNCHLAX, SPECIES_GIRAFARIG, SPECIES_AIPOM, SPECIES_BREADBUG, SPECIES_VIGOROTH, SPECIES_BUNEARY, SPECIES_PORYGON, SPECIES_KECLEON, SPECIES_WATCHOG, SPECIES_BIBAREL},
        [5] = {SPECIES_WOOLOO, SPECIES_EEVEE, SPECIES_GOOLIX, SPECIES_TEDDIURSA, SPECIES_MOCKIWI, SPECIES_HERDIER, SPECIES_TRANQUILL, SPECIES_FURRET, SPECIES_BREADBUG_A, SPECIES_DELCATTY},
        ...
        [7] = {SPECIES_SILVALLY, SPECIES_PORYGON_Z, SPECIES_SNORLAX_GIGA, SPECIES_SAWSBUCK, SPECIES_KANGASKHAN_MEGA, SPECIES_BLISSEY, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_BEWEAR, SPECIES_SAWSBUCK_WINTER, SPECIES_CHANSEY},
        ...
        [9] = {SPECIES_AMBIPOM, SPECIES_HELIOLISK, SPECIES_OBSTAGOON, SPECIES_SAWSBUCK, SPECIES_LOPUNNY, SPECIES_FURFROU_STAR, SPECIES_CINCCINO, SPECIES_UNFEZANT, SPECIES_FURFROU, SPECIES_FROSTYBULBORB},
    },
    [CLASS_SCHOOL_KID] = {
        ...
        [1] = {SPECIES_YAMPER, SPECIES_TAILLOW, SPECIES_WHISMUR, SPECIES_DWARFBULBORB_GIGA, SPECIES_URSALUNA_BLOODMOON, SPECIES_SQUAWKABILLY_YELLOW, SPECIES_TOXEL, SPECIES_LECHONK, SPECIES_PAWMOT, SPECIES_TANDEMAUS},
        ...
        [3] = {SPECIES_LUXIO, SPECIES_TOGEDEMARU, SPECIES_PACHIRISU, SPECIES_CHINCHOU, SPECIES_MOCKIWI, SPECIES_CHATOT, SPECIES_DELCATTY, SPECIES_SPOTTYBULBEAR_COSPLAY, SPECIES_EELEKTRIK, SPECIES_VEHEAMOTHPHOSBAT_A},
        [4] = {SPECIES_HONEYWISP_A, SPECIES_LUXIO, SPECIES_LOUDRED, SPECIES_DIGGERSBY, SPECIES_DWARFFROSTYBULBORB, SPECIES_ROTOM_HEAT, SPECIES_SLAKOTH, SPECIES_PYROCLASTICSLOOCH, SPECIES_RUFFLET, SPECIES_FARFETCHD},
        [5] = {SPECIES_GLAMEOW, SPECIES_GIRAFARIG, SPECIES_SPOTTYBULBEAR_CAP_ALOLA, SPECIES_LITLEO, SPECIES_SPOTTYBULBEAR_CAP_ORIGINAL, SPECIES_CASTFORM, SPECIES_SMEARGLE, SPECIES_EELEKTRIK, SPECIES_DIGGERSBY, SPECIES_MUNCHLAX},
        [6] = {SPECIES_EMOLGA, SPECIES_SPUTTLEFISH_A, SPECIES_PYROAR_FEMALE, SPECIES_MORPEKO, SPECIES_FURFROU_DIAMOND, SPECIES_TAPU_KOKO, SPECIES_GREEDENT, SPECIES_PURUGLY, SPECIES_CINCCINO, SPECIES_DRAMPA},
    ...
    [CLASS_SR_AND_JR] = {
        ...
        [1] = {SPECIES_HELIOPTILE, SPECIES_DUDUNSPARCE, SPECIES_SMOLIV, SPECIES_TERAPAGOS_STELLAR, SPECIES_ZORUA_H, SPECIES_FLETCHLING, SPECIES_FARIGIRAF, SPECIES_URSALUNA_BLOODMOON, SPECIES_OINKOLOGNE_FEMALE, SPECIES_DWARFBULBORB_GIGA},
        [2] = {SPECIES_IGGLYBUFF, SPECIES_FARIGIRAF, SPECIES_GIANTBREADBUG, SPECIES_WHISMUR, SPECIES_HOOTHOOT, SPECIES_SENTRET, SPECIES_DEERLING_SUMMER, SPECIES_CRUMBUG_A, SPECIES_DOLLIV, SPECIES_OINKOLOGNE_FEMALE},
        [3] = {SPECIES_MOCKIWI, SPECIES_SMEARGLE, SPECIES_WOOLOO, SPECIES_DUNSPARCE, SPECIES_TYPE_NULL, SPECIES_FARFETCHD, SPECIES_SWABLU, SPECIES_GOOLIX, SPECIES_LINOONE_G, SPECIES_TRUMBEAK},
        [4] = {SPECIES_TEDDIURSA, SPECIES_STUFFUL, SPECIES_DUNSPARCE, SPECIES_LINOONE, SPECIES_CHATOT, SPECIES_BREADBUG, SPECIES_EEVEE, SPECIES_BREADBUG_A, SPECIES_LITLEO, SPECIES_FURRET},
        [5] = {SPECIES_SLAKOTH, SPECIES_FARFETCHD, SPECIES_DUNSPARCE, SPECIES_EEVEE, SPECIES_LOUDRED, SPECIES_BREADBUG, SPECIES_TRANQUILL, SPECIES_TEDDIURSA, SPECIES_AIPOM, SPECIES_DIGGERSBY},
        ...
        [9] = {SPECIES_FURFROU_STAR, SPECIES_MELOETTA_PIROUETTE, SPECIES_PYROAR_FEMALE, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_BLISSEY, SPECIES_FURFROU_LA_REINE, SPECIES_HAPPINY, SPECIES_SAWSBUCK_SUMMER, SPECIES_URSALUNA, SPECIES_FEAROW},
    },
    [CLASS_POKEFAN] = {
        [0] = {SPECIES_PATRAT, SPECIES_CRUMBUG_A, SPECIES_ZIGZAGOON, SPECIES_FARIGIRAF, SPECIES_DEERLING, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_PIKIPEK, SPECIES_ZIGZAGOON_G, SPECIES_SHROODLE, SPECIES_CYCLIZAR},
        [1] = {SPECIES_DOLLIV, SPECIES_DWARFBULBORB, SPECIES_DEERLING_AUTUMN, SPECIES_FLETCHLING, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_TAILLOW, SPECIES_LILLIPUP, SPECIES_OINKOLOGNE, SPECIES_MINCCINO, SPECIES_BUNNELBY},
        ...
        [3] = {SPECIES_LINOONE_G, SPECIES_STUFFUL, SPECIES_EEVEE_GIGA, SPECIES_VIGOROTH, SPECIES_BUNEARY, SPECIES_MUNCHLAX, SPECIES_WATCHOG, SPECIES_TRANQUILL, SPECIES_RUFFLET, SPECIES_GOOLIX},
        [4] = {SPECIES_SPINDA, SPECIES_WATCHOG, SPECIES_LOUDRED, SPECIES_FOOLIX, SPECIES_BREADBUG, SPECIES_GIRAFARIG, SPECIES_TEDDIURSA, SPECIES_BREADBUG_A, SPECIES_STARAVIA, SPECIES_GUMSHOOS},
        [5] = {SPECIES_SMEARGLE, SPECIES_EEVEE, SPECIES_STUFFUL, SPECIES_TEDDIURSA, SPECIES_GLAMEOW, SPECIES_LINOONE_G, SPECIES_BREADBUG, SPECIES_GOOLIX, SPECIES_TRUMBEAK, SPECIES_STARAVIA},
        [6] = {SPECIES_PORYGON2, SPECIES_INDEEDEE, SPECIES_FURFROU_MATRON, SPECIES_LICKILICKY, SPECIES_BEWEAR, SPECIES_FURFROU, SPECIES_UNFEZANT_F, SPECIES_URSALUNA, SPECIES_CHANSEY, SPECIES_FROSTYBULBORB_MEGA},
        ...
        [8] = {SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_CHANSEY, SPECIES_SWELLOW, SPECIES_BLISSEY, SPECIES_CINCCINO, SPECIES_HAPPINY, SPECIES_PORYGON_Z, SPECIES_ZOROARK_H, SPECIES_FROSTYBULBORB, SPECIES_FURFROU_DIAMOND},
    ...
    [CLASS_EXPERT] = {
        ...
        [4] = {SPECIES_RIOLU, SPECIES_BEADYLONGLEGS, SPECIES_SNEASEL_H, SPECIES_SLOWPOKE, SPECIES_MONFERNO, SPECIES_CHINGLING, SPECIES_HATTREM, SPECIES_SPOTTYBULBEAR_PHD, SPECIES_SUNQUISH, SPECIES_ARMOREDMAWDAD},
        [5] = {SPECIES_CRABRAWLER, SPECIES_SILVALLY_FIGHT, SPECIES_STUFFUL, SPECIES_PANCHAM, SPECIES_MAKUHITA, SPECIES_COSMOEM, SPECIES_TYROGUE, SPECIES_SNEASLER, SPECIES_RALTS, SPECIES_SPOTTYBULBEAR_LIBRE},
        ...
        [7] = {SPECIES_HOOPA_UNBOUND, SPECIES_MIENSHAO, SPECIES_EXEGGUTOR, SPECIES_BEARTIC, SPECIES_SOLROCK, SPECIES_PRICKLEPUFF_G, SPECIES_GARDEVOIR_MEGA, SPECIES_HOOPA, SPECIES_DARMANITANZEN, SPECIES_CALYREX_SHADOW_RIDER},
    ...
    [CLASS_YOUNGSTER_RS] = {
        ...
        [1] = {SPECIES_SQUAWKABILLY_YELLOW, SPECIES_MAUSHOLD_FOUR, SPECIES_CRUMBUG, SPECIES_BUNNELBY, SPECIES_MAUSHOLD, SPECIES_LECHONK, SPECIES_DUDUNSPARCE, SPECIES_GIANTBREADBUG, SPECIES_DWARFBULBORB_GIGA, SPECIES_BIDOOF},
        [2] = {SPECIES_HELIOPTILE, SPECIES_DUDUNSPARCE, SPECIES_DUDUNSPARCE_THREE, SPECIES_GRAFAIAI, SPECIES_DWARFBULBORB, SPECIES_EGG, SPECIES_DEERLING_AUTUMN, SPECIES_SQUAWKABILLY_YELLOW, SPECIES_TERAPAGOS, SPECIES_BIDOOF},
        ...
        [4] = {SPECIES_TRUMBEAK, SPECIES_BIBAREL, SPECIES_GOOLIX, SPECIES_BUNEARY, SPECIES_LINOONE, SPECIES_TYPE_NULL, SPECIES_DUNSPARCE, SPECIES_KECLEON, SPECIES_STUFFUL, SPECIES_MOCKIWI},
        [5] = {SPECIES_WOOLOO, SPECIES_BUNEARY, SPECIES_BREADBUG_A, SPECIES_PORYGON, SPECIES_CASTFORM, SPECIES_AIPOM, SPECIES_SLAKOTH, SPECIES_SMEARGLE, SPECIES_EEVEE_GIGA, SPECIES_TRUMBEAK},
        [6] = {SPECIES_INDEEDEE, SPECIES_OBSTAGOON, SPECIES_SAWSBUCK_SUMMER, SPECIES_FURFROU_DANDY, SPECIES_KOMALA, SPECIES_STARAPTOR, SPECIES_TAUROS, SPECIES_BEWEAR, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_STOUTLAND},
        ...
        [9] = {SPECIES_CINCCINO, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_AMBIPOM, SPECIES_INDEEDEE, SPECIES_FURFROU_DANDY, SPECIES_KANGASKHAN_MEGA, SPECIES_LICKILICKY, SPECIES_ARCEUS, SPECIES_INDEEDEE_FEMALE, SPECIES_AUDINO_MEGA},
    },
    [CLASS_CHAMPION_RS] = {
        [0] = {SPECIES_SMOLIV, SPECIES_AZURILL, SPECIES_WHISMUR, SPECIES_EGG, SPECIES_TANDEMAUS, SPECIES_DUDUNSPARCE, SPECIES_DUDUNSPARCE_THREE, SPECIES_TAILLOW, SPECIES_DWARFBULBORB_GIGA, SPECIES_OINKOLOGNE},
        [1] = {SPECIES_TERAPAGOS_TERASTAL, SPECIES_DUDUNSPARCE_THREE, SPECIES_SKWOVET, SPECIES_LILLIPUP, SPECIES_ZIGZAGOON_G, SPECIES_GIANTBREADBUG, SPECIES_URSALUNA_BLOODMOON, SPECIES_CYCLIZAR, SPECIES_CRUMBUG, SPECIES_SQUAWKABILLY_WHITE},
        [2] = {SPECIES_HELIOPTILE, SPECIES_OINKOLOGNE_FEMALE, SPECIES_DUDUNSPARCE_THREE, SPECIES_EGG, SPECIES_GRAFAIAI, SPECIES_IGGLYBUFF, SPECIES_CRUMBUG_A, SPECIES_DWARFBULBORB, SPECIES_DEERLING, SPECIES_OINKOLOGNE},
        [3] = {SPECIES_BREADBUG_A, SPECIES_SMEARGLE, SPECIES_TEDDIURSA, SPECIES_TYPE_NULL, SPECIES_FURRET, SPECIES_CASTFORM, SPECIES_RUFFLET, SPECIES_FARFETCHD, SPECIES_KECLEON, SPECIES_LITLEO},
        [4] = {SPECIES_GLAMEOW, SPECIES_HERDIER, SPECIES_DWARFFROSTYBULBORB, SPECIES_EEVEE_GIGA, SPECIES_PORYGON, SPECIES_TEDDIURSA, SPECIES_SMEARGLE, SPECIES_LOUDRED, SPECIES_CASTFORM, SPECIES_FOOLIX},
        [5] = {SPECIES_BREADBUG, SPECIES_BUNEARY, SPECIES_DWARFFROSTYBULBORB, SPECIES_STARAVIA, SPECIES_EEVEE_GIGA, SPECIES_HERDIER, SPECIES_EEVEE, SPECIES_FOOLIX, SPECIES_CHATOT, SPECIES_SPINDA},
        ...
        [7] = {SPECIES_SLAKING, SPECIES_FURFROU_LA_REINE, SPECIES_INDEEDEE, SPECIES_PURUGLY, SPECIES_URSARING, SPECIES_LICKILICKY, SPECIES_MELOETTA_PIROUETTE, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_SAWSBUCK, SPECIES_PORYGON_Z},
        ...
        [9] = {SPECIES_HAPPINY, SPECIES_FROSTYBULBORB, SPECIES_FURFROU_DANDY, SPECIES_STOUTLAND, SPECIES_BRAVIARY, SPECIES_MELOETTA, SPECIES_WYRDEER, SPECIES_INDEEDEE, SPECIES_PYROAR_FEMALE, SPECIES_AUDINO_MEGA},
    },
    [CLASS_FISHERMAN_RS] = {
        [0] = {SPECIES_SHROODLE, SPECIES_GRAFAIAI, SPECIES_FARIGIRAF, SPECIES_TERAPAGOS_STELLAR, SPECIES_DWARFBULBORB_GIGA, SPECIES_SKITTY, SPECIES_URSALUNA_BLOODMOON, SPECIES_DEERLING_SUMMER, SPECIES_TERAPAGOS_TERASTAL, SPECIES_SENTRET},
        [1] = {SPECIES_OINKOLOGNE_FEMALE, SPECIES_ZORUA_H, SPECIES_SENTRET, SPECIES_SKWOVET, SPECIES_CRUMBUG, SPECIES_EGG, SPECIES_HELIOPTILE, SPECIES_LILLIPUP, SPECIES_HOOTHOOT, SPECIES_DUDUNSPARCE},
        [2] = {SPECIES_BIDOOF, SPECIES_URSALUNA_BLOODMOON, SPECIES_TAILLOW, SPECIES_MINCCINO, SPECIES_WHISMUR, SPECIES_ARBOLIVA, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_OINKOLOGNE, SPECIES_FARIGIRAF, SPECIES_IGGLYBUFF},
        [3] = {SPECIES_GIRAFARIG, SPECIES_GLAMEOW, SPECIES_TYPE_NULL, SPECIES_DUNSPARCE, SPECIES_BREADBUG_A, SPECIES_BREADBUG, SPECIES_TRANQUILL, SPECIES_STARAVIA, SPECIES_SWABLU, SPECIES_SLAKOTH},
        [4] = {SPECIES_STUFFUL, SPECIES_PYROCLASTICSLOOCH, SPECIES_GIRAFARIG, SPECIES_BUNEARY, SPECIES_SLAKOTH, SPECIES_DELCATTY, SPECIES_DWARFFROSTYBULBORB, SPECIES_KECLEON, SPECIES_RUFFLET, SPECIES_TRUMBEAK},
        [5] = {SPECIES_LINOONE_G, SPECIES_STARAVIA, SPECIES_DIGGERSBY, SPECIES_FARFETCHD, SPECIES_LITLEO, SPECIES_DUNSPARCE, SPECIES_BREADBUG, SPECIES_RUFFLET, SPECIES_SMEARGLE, SPECIES_GLAMEOW},
        [6] = {SPECIES_PORYGON2, SPECIES_ZANGOOSE, SPECIES_KOMALA, SPECIES_SAWSBUCK_SUMMER, SPECIES_SNORLAX, SPECIES_FROSTYBULBORB_MEGA, SPECIES_TAUROS, SPECIES_STANTLER, SPECIES_SAWSBUCK, SPECIES_HELIOLISK},
        ...
        [8] = {SPECIES_FROSTYBULBORB_MEGA, SPECIES_PORYGON_Z, SPECIES_FURFROU_DANDY, SPECIES_REGIGIGAS, SPECIES_TAUROS, SPECIES_INDEEDEE, SPECIES_ZOROARK_H, SPECIES_FROSTYBULBORB, SPECIES_LICKILICKY, SPECIES_MELOETTA_PIROUETTE},
    ...
    [CLASS_TRIATHLETE] = {
        ...
        [3] = {SPECIES_SPOTTYBULBEAR_GIGA, SPECIES_PIGNITE, SPECIES_BALDYLONGLEGS, SPECIES_SPOTTYBULBEAR_CAP_UNOVA, SPECIES_HONEYWISP_A, SPECIES_BOGSWALLOW, SPECIES_PUFFMIN_H, SPECIES_TIMBURR, SPECIES_PACHIRISU, SPECIES_SPOTTYBULBEAR_FLYING},
        [4] = {SPECIES_TOGEDEMARU, SPECIES_ELECTRIKE, SPECIES_MONFERNO, SPECIES_PUCKERINGBLINNOW_A, SPECIES_FLAAFFY, SPECIES_SNEASLER, SPECIES_ROTOM, SPECIES_MANATLEGS, SPECIES_SPOTTYBULBEAR_BELLE, SPECIES_SPOTTYBULBEAR_GIGA},
        [5] = {SPECIES_SPOTTYBULBEAR, SPECIES_PUCKERINGBLINNOW_A, SPECIES_HONEYWISP, SPECIES_MINUN, SPECIES_ROTOM_FROST, SPECIES_EELEKTRIK, SPECIES_SPOTTYBULBEAR_FLYING, SPECIES_SPOTTYBULBEAR_CAP_HOENN, SPECIES_MEDITITE, SPECIES_SPOTTYBULBEAR_CAP_ALOLA},
        [6] = {SPECIES_RAIKOU, SPECIES_VIKAVOLT, SPECIES_TAPU_KOKO, SPECIES_ZAMAZENTA, SPECIES_TOXTRICITY_GIGA, SPECIES_KELDEO, SPECIES_EELEKTROSS, SPECIES_PUFFMIN, SPECIES_ZERAORA, SPECIES_THROH},
    ...
    [CLASS_BIRD_KEEPER_RS] = {
        [0] = {SPECIES_TERAPAGOS_STELLAR, SPECIES_CRUMBUG, SPECIES_DUDUNSPARCE, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_IGGLYBUFF, SPECIES_DOLLIV, SPECIES_WHISMUR, SPECIES_TAILLOW, SPECIES_ARBOLIVA, SPECIES_FLETCHLING},
        [1] = {SPECIES_SQUAWKABILLY_YELLOW, SPECIES_DEERLING_AUTUMN, SPECIES_GIANTBREADBUG, SPECIES_MINCCINO, SPECIES_PIKIPEK, SPECIES_SKWOVET, SPECIES_GRAFAIAI, SPECIES_LECHONK, SPECIES_ARBOLIVA, SPECIES_BIDOOF},
        [2] = {SPECIES_HOOTHOOT, SPECIES_TERAPAGOS_STELLAR, SPECIES_MAUSHOLD_FOUR, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_DUDUNSPARCE_THREE, SPECIES_SQUAWKABILLY_YELLOW, SPECIES_SQUAWKABILLY_WHITE, SPECIES_HELIOPTILE, SPECIES_DOLLIV, SPECIES_URSALUNA_BLOODMOON},
        [3] = {SPECIES_WATCHOG, SPECIES_STARAVIA, SPECIES_DWARFORANGEBULBORB, SPECIES_SPINDA, SPECIES_LITLEO, SPECIES_AIPOM, SPECIES_MOCKIWI, SPECIES_DIGGERSBY, SPECIES_GUMSHOOS, SPECIES_GOOLIX},
        [4] = {SPECIES_LOUDRED, SPECIES_BIBAREL, SPECIES_TYPE_NULL, SPECIES_GIRAFARIG, SPECIES_SMEARGLE, SPECIES_BREADBUG, SPECIES_PYROCLASTICSLOOCH, SPECIES_CASTFORM, SPECIES_TRUMBEAK, SPECIES_PORYGON},
        [5] = {SPECIES_FOOLIX, SPECIES_DUNSPARCE, SPECIES_TYPE_NULL, SPECIES_SWABLU, SPECIES_SMEARGLE, SPECIES_LINOONE, SPECIES_DWARFFROSTYBULBORB, SPECIES_WATCHOG, SPECIES_EEVEE_GIGA, SPECIES_MOCKIWI},
        [6] = {SPECIES_HAPPINY, SPECIES_SAWSBUCK, SPECIES_STOUTLAND, SPECIES_KANGASKHAN, SPECIES_MILTANK, SPECIES_UNFEZANT_F, SPECIES_BEWEAR, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_SLAKING, SPECIES_PYROAR_FEMALE},
        ...
        [8] = {SPECIES_FEAROW, SPECIES_AUDINO, SPECIES_EXPLOUD, SPECIES_KANGASKHAN, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_TOUCANNON, SPECIES_ZANGOOSE, SPECIES_INDEEDEE_FEMALE, SPECIES_SAWSBUCK_AUTUMN, SPECIES_FURFROU_DEBUTANTE},
        [9] = {SPECIES_STARAPTOR, SPECIES_PYROAR_FEMALE, SPECIES_LOPUNNY, SPECIES_AUDINO_MEGA, SPECIES_FURFROU_KABUKI, SPECIES_AMBIPOM, SPECIES_LICKILICKY, SPECIES_STANTLER, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_WYRDEER},
    },
    [CLASS_NINJA_BOY] = {
        ...
        [2] = {SPECIES_MASCHIFF, SPECIES_WO_CHIEN, SPECIES_BULBORBLARVA, SPECIES_EKANS, SPECIES_POOCHYENA, SPECIES_TRUBBISH, SPECIES_CRUMBUG_A, SPECIES_CLODSIRE, SPECIES_WOOPER_P, SPECIES_ZORUA},
        [3] = {SPECIES_SABLEYE, SPECIES_GLOOM, SPECIES_GULPIN, SPECIES_MIGHTYENA, SPECIES_BREADBUG_A, SPECIES_WHIRLIPEDE, SPECIES_MORGREM, SPECIES_SABLEYE_MEGA, SPECIES_STUNKY, SPECIES_GASTLY},
        [4] = {SPECIES_TOXSTOOL, SPECIES_GASTLY, SPECIES_CREEPINGCHRYSANTHEMUM, SPECIES_SILVALLY_POISON, SPECIES_MAMASHEARGRUB, SPECIES_ZWEILOUS, SPECIES_MURKROW, SPECIES_SNEASEL, SPECIES_STARTLESPORE, SPECIES_PILEATEDSNAGRET},
        [5] = {SPECIES_DWARFORANGEBULBORB_A, SPECIES_OVERQWIL, SPECIES_GRIMER, SPECIES_SKITTERLEAF, SPECIES_MORGREM, SPECIES_HAUNTER, SPECIES_BUMBLINGSNITCHBUG, SPECIES_KOFFING, SPECIES_GULPIN, SPECIES_WHIRLIPEDE},
        ...
        [7] = {SPECIES_CACTURNE, SPECIES_SKUNTANK, SPECIES_MALAMAR, SPECIES_DRAGALGE, SPECIES_ARCEUS_POISON, SPECIES_JUMBOBULBORB_MEGA, SPECIES_DARKRAI, SPECIES_ARCTICCANNONBEETLE, SPECIES_WEAVILE, SPECIES_DRAPION},
        [8] = {SPECIES_MANDIBUZZ, SPECIES_ETERNATUS, SPECIES_SNOWYBLOWHOG, SPECIES_URSHIFU_SINGLE, SPECIES_GRENINJA, SPECIES_NIHILEGO, SPECIES_DARKRAI, SPECIES_SHARPEDO, SPECIES_TOXTRICITY_GIGA, SPECIES_TYRANITAR},
        [9] = {SPECIES_LUXRAY, SPECIES_PHOSBAT, SPECIES_SLOWKING_G, SPECIES_TYRANITAR, SPECIES_ARMOREDCANNONLARVA, SPECIES_CROBAT, SPECIES_ABSOL, SPECIES_MOLDYSLOOCH, SPECIES_SKUNTANK, SPECIES_SHARPEDO},
    },
    [CLASS_BATTLE_GIRL] = {
        ...
        [4] = {SPECIES_RIOLU, SPECIES_TYROGUE, SPECIES_MAKUHITA, SPECIES_PANCHAM, SPECIES_SILVALLY_FIGHT, SPECIES_TIMBURR, SPECIES_SNEASLER, SPECIES_SNEASEL_H, SPECIES_CROAGUNK, SPECIES_MANATLEGS},
        [5] = {SPECIES_LILLIGANT_H, SPECIES_LONGWATERDUMPLE, SPECIES_SPOTTYBULBEAR_LIBRE, SPECIES_MIENFOO, SPECIES_MEDITITE, SPECIES_STUFFUL, SPECIES_TYROGUE, SPECIES_COMBUSKEN, SPECIES_PIGNITE, SPECIES_MONFERNO},
        ...
        [8] = {SPECIES_KELDEO_RESOLUTE, SPECIES_ARCEUS_FIGHT, SPECIES_BURROWNIT, SPECIES_VIRIZION, SPECIES_MACHAMP, SPECIES_CHESNAUGHT, SPECIES_MEDICHAM, SPECIES_URSHIFU_RAPID_GIGA, SPECIES_INFERNAPE, SPECIES_DECIDUEYE_H},
    ...
    [CLASS_ARMOREDCANNONBEETLEOL_LADY] = {
        ...
        [1] = {SPECIES_FIDOUGH, SPECIES_SOBBLE, SPECIES_QUAQUAVAL, SPECIES_TINKATUFF, SPECIES_FLABEBE_WHITE, SPECIES_FROAKIE, SPECIES_QUAXLY, SPECIES_FINIZEN, SPECIES_PELLETPOSY, SPECIES_FEZANDIPITI},
        [2] = {SPECIES_TATSUGIRI_RED, SPECIES_FEEBAS, SPECIES_SWIRLIX, SPECIES_POPPLIO, SPECIES_FLABEBE_YELLOW, SPECIES_FLABEBE_BLUE, SPECIES_FEZANDIPITI, SPECIES_FLABEBE, SPECIES_PELLETPOSY, SPECIES_FINIZEN},
        [3] = {SPECIES_BLIZZARDINGBLOWHOG, SPECIES_MORGREM, SPECIES_STARYU, SPECIES_GOOLIX, SPECIES_SPOTTYBULBEAR_POP_STAR, SPECIES_CORSOLA, SPECIES_OMANYTE, SPECIES_FLOETTE_WHITE, SPECIES_BEADYLONGLEGS, SPECIES_GOLDEEN},
        ...
        [6] = {SPECIES_SHARPEDO_MEGA, SPECIES_KINGDRA, SPECIES_SWAMPERT, SPECIES_RELICANTH, SPECIES_BEARDEDAMPRAT, SPECIES_SUICUNE, SPECIES_PALKIA, SPECIES_WEEZING_G, SPECIES_PHOSBAT, SPECIES_ARCEUS_FAIRY},
        [7] = {SPECIES_XERNEAS, SPECIES_DREDNAW_GIGA, SPECIES_FERALIGATR, SPECIES_URSHIFU_RAPID, SPECIES_OATCHI, SPECIES_ENAMORUS, SPECIES_DREDNAW, SPECIES_AUDINO_MEGA, SPECIES_SHARPEDO, SPECIES_BURROWNIT},
        [8] = {SPECIES_FLORGES_BLUE, SPECIES_GRIMMSNARL, SPECIES_BURROWNIT, SPECIES_GATTLINGGROINK, SPECIES_FLORGES_WHITE, SPECIES_HATTERENE, SPECIES_PRIMARINA, SPECIES_SLOWKING, SPECIES_LUMINEON, SPECIES_KELDEO},
    ...
    [CLASS_SWIMMER_F_RS] = {
        [0] = {SPECIES_SQUAWKABILLY_BLUE, SPECIES_TANDEMAUS, SPECIES_SNOWBULBORB, SPECIES_SHROODLE, SPECIES_SMOLIV, SPECIES_LECHONK, SPECIES_ZORUA_H, SPECIES_WHISMUR, SPECIES_MAUSHOLD_FOUR, SPECIES_DUDUNSPARCE},
        [1] = {SPECIES_ARBOLIVA, SPECIES_SQUAWKABILLY, SPECIES_PATRAT, SPECIES_DWARFBULBORB_GIGA, SPECIES_PIDOVE, SPECIES_HOOTHOOT, SPECIES_PIKIPEK, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_EGG, SPECIES_TERAPAGOS},
        [2] = {SPECIES_DEERLING_AUTUMN, SPECIES_SQUAWKABILLY_BLUE, SPECIES_TERAPAGOS, SPECIES_DOLLIV, SPECIES_HELIOPTILE, SPECIES_EGG, SPECIES_DEERLING, SPECIES_DEERLING_WINTER, SPECIES_AZURILL, SPECIES_GIANTBREADBUG},
        [3] = {SPECIES_BIBAREL, SPECIES_MUNCHLAX, SPECIES_MOCKIWI, SPECIES_GOOLIX, SPECIES_FARFETCHD, SPECIES_GLAMEOW, SPECIES_CHATOT, SPECIES_CASTFORM, SPECIES_BREADBUG, SPECIES_STUFFUL},
        [4] = {SPECIES_RUFFLET, SPECIES_TEDDIURSA, SPECIES_BUNEARY, SPECIES_PYROCLASTICSLOOCH, SPECIES_LOUDRED, SPECIES_LINOONE, SPECIES_DIGGERSBY, SPECIES_WATCHOG, SPECIES_FURRET, SPECIES_TRUMBEAK},
        [5] = {SPECIES_DWARFORANGEBULBORB, SPECIES_EEVEE, SPECIES_DUNSPARCE, SPECIES_BREADBUG, SPECIES_BIBAREL, SPECIES_STUFFUL, SPECIES_DELCATTY, SPECIES_DWARFFROSTYBULBORB, SPECIES_BREADBUG_A, SPECIES_FOOLIX},
        ...
        [9] = {SPECIES_FURFROU_PHAROAH, SPECIES_UNFEZANT, SPECIES_AMBIPOM, SPECIES_TAUROS, SPECIES_LOPUNNY_MEGA, SPECIES_FROSTYBULBORB, SPECIES_SNORLAX, SPECIES_BOUFFALANT, SPECIES_HELIOLISK, SPECIES_PORYGON2},
    },
    [CLASS_PICNICKER_RS] = {
        ...
        [1] = {SPECIES_BUNNELBY, SPECIES_DEERLING_WINTER, SPECIES_CRUMBUG_A, SPECIES_SQUAWKABILLY_WHITE, SPECIES_GIANTBREADBUG, SPECIES_DUDUNSPARCE_THREE, SPECIES_AZURILL, SPECIES_SQUAWKABILLY_YELLOW, SPECIES_FLETCHLING, SPECIES_DWARFBULBORB},
        [2] = {SPECIES_DEERLING_AUTUMN, SPECIES_TERAPAGOS_TERASTAL, SPECIES_URSALUNA_BLOODMOON, SPECIES_ARBOLIVA, SPECIES_IGGLYBUFF, SPECIES_DWARFBULBORB, SPECIES_SQUAWKABILLY_BLUE, SPECIES_SKITTY, SPECIES_OINKOLOGNE, SPECIES_DEERLING},
        [3] = {SPECIES_FARFETCHD, SPECIES_TRUMBEAK, SPECIES_GUMSHOOS, SPECIES_EEVEE, SPECIES_MUNCHLAX, SPECIES_GOOLIX, SPECIES_GIRAFARIG, SPECIES_SMEARGLE, SPECIES_SWABLU, SPECIES_FURRET},
        [4] = {SPECIES_DUNSPARCE, SPECIES_SWABLU, SPECIES_TYPE_NULL, SPECIES_WOOLOO, SPECIES_FARFETCHD, SPECIES_GOOLIX, SPECIES_PORYGON, SPECIES_SPINDA, SPECIES_GLAMEOW, SPECIES_LINOONE},
        [5] = {SPECIES_GIRAFARIG, SPECIES_SPINDA, SPECIES_BIBAREL, SPECIES_BREADBUG_A, SPECIES_BUNEARY, SPECIES_WATCHOG, SPECIES_KECLEON, SPECIES_TEDDIURSA, SPECIES_GLAMEOW, SPECIES_GOOLIX},
        ...
        [8] = {SPECIES_PORYGON2, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_URSARING, SPECIES_FROSTYBULBORB, SPECIES_UNFEZANT, SPECIES_MELOETTA_PIROUETTE, SPECIES_LICKILICKY, SPECIES_FROSTYBULBORB_MEGA, SPECIES_FURFROU_PHAROAH, SPECIES_STANTLER},
        [9] = {SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_STOUTLAND, SPECIES_INDEEDEE_FEMALE, SPECIES_PYROAR_FEMALE, SPECIES_ARCEUS, SPECIES_AUDINO, SPECIES_BEWEAR, SPECIES_URSARING, SPECIES_REGIGIGAS, SPECIES_FURFROU_PHAROAH},
    },
    [CLASS_TWINS_RS] = {
        [0] = {SPECIES_DEERLING_AUTUMN, SPECIES_DOLLIV, SPECIES_GIANTBREADBUG, SPECIES_HELIOPTILE, SPECIES_DEERLING_SUMMER, SPECIES_FLETCHLING, SPECIES_ZIGZAGOON_G, SPECIES_TANDEMAUS, SPECIES_LILLIPUP, SPECIES_TERAPAGOS_TERASTAL},
        ...
        [2] = {SPECIES_TERAPAGOS_TERASTAL, SPECIES_DWARFBULBORB, SPECIES_ZIGZAGOON_G, SPECIES_SHROODLE, SPECIES_TAILLOW, SPECIES_DUDUNSPARCE, SPECIES_SQUAWKABILLY_YELLOW, SPECIES_SQUAWKABILLY, SPECIES_BUNNELBY, SPECIES_AZURILL},
        [3] = {SPECIES_CHATOT, SPECIES_MOCKIWI, SPECIES_FOOLIX, SPECIES_FURRET, SPECIES_TRANQUILL, SPECIES_DUNSPARCE, SPECIES_EEVEE_GIGA, SPECIES_BREADBUG_A, SPECIES_MUNCHLAX, SPECIES_LINOONE},
        [4] = {SPECIES_SPINDA, SPECIES_SLAKOTH, SPECIES_DELCATTY, SPECIES_GIRAFARIG, SPECIES_HERDIER, SPECIES_TRANQUILL, SPECIES_DIGGERSBY, SPECIES_LINOONE, SPECIES_MOCKIWI, SPECIES_SMEARGLE},
        ...
        [8] = {SPECIES_CINCCINO, SPECIES_ZANGOOSE, SPECIES_TAUROS, SPECIES_URSALUNA, SPECIES_BLISSEY, SPECIES_KANGASKHAN_MEGA, SPECIES_SAWSBUCK_SUMMER, SPECIES_DRAMPA, SPECIES_LICKILICKY, SPECIES_FROSTYBULBORB_MEGA},
    ...
    [CLASS_SAILOR_RS] = {
        ...
        [1] = {SPECIES_SKITTY, SPECIES_ARBOLIVA, SPECIES_CRUMBUG, SPECIES_SQUAWKABILLY, SPECIES_EGG, SPECIES_TERAPAGOS, SPECIES_ZIGZAGOON, SPECIES_PATRAT, SPECIES_HELIOPTILE, SPECIES_MAUSHOLD_FOUR},
        [2] = {SPECIES_MINCCINO, SPECIES_CYCLIZAR, SPECIES_SKITTY, SPECIES_GRAFAIAI, SPECIES_HOOTHOOT, SPECIES_SQUAWKABILLY_WHITE, SPECIES_URSALUNA_BLOODMOON, SPECIES_DEERLING, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_HELIOPTILE},
        [3] = {SPECIES_GOOLIX, SPECIES_RUFFLET, SPECIES_GUMSHOOS, SPECIES_VIGOROTH, SPECIES_DWARFORANGEBULBORB, SPECIES_BIBAREL, SPECIES_BUNEARY, SPECIES_CHATOT, SPECIES_PORYGON, SPECIES_DWARFFROSTYBULBORB},
        [4] = {SPECIES_BREADBUG, SPECIES_DWARFFROSTYBULBORB, SPECIES_SPINDA, SPECIES_GUMSHOOS, SPECIES_WOOLOO, SPECIES_GIRAFARIG, SPECIES_EEVEE, SPECIES_MOCKIWI, SPECIES_CASTFORM, SPECIES_EEVEE_GIGA},
        [5] = {SPECIES_HERDIER, SPECIES_SWABLU, SPECIES_GOOLIX, SPECIES_CHATOT, SPECIES_EEVEE_GIGA, SPECIES_DWARFFROSTYBULBORB, SPECIES_BREADBUG_A, SPECIES_DELCATTY, SPECIES_MUNCHLAX, SPECIES_MOCKIWI},
        [6] = {SPECIES_PYROAR_FEMALE, SPECIES_FROSTYBULBORB, SPECIES_STARAPTOR, SPECIES_LOPUNNY, SPECIES_PYROAR, SPECIES_KANGASKHAN_MEGA, SPECIES_ARCEUS, SPECIES_SAWSBUCK_SUMMER, SPECIES_WYRDEER, SPECIES_FURFROU},
    ...
    [CLASS_BOARDER] = {
        [0] = {SPECIES_CETODDLE, SPECIES_ARCTIBAX, SPECIES_IRON_BUNDLE, SPECIES_VANILLITE, SPECIES_FRIGIBAX, SPECIES_CETITAN, SPECIES_CHIEN_PAO, SPECIES_DARUMAKA_G, SPECIES_ARISTOCRABOFFSPRING_A, SPECIES_BERGMITE},
        [1] = {SPECIES_CETITAN, SPECIES_SNOM, SPECIES_IRON_BUNDLE, SPECIES_ARCTIBAX, SPECIES_BERGMITE, SPECIES_DARUMAKA_G, SPECIES_ARISTOCRABOFFSPRING_A, SPECIES_CETODDLE, SPECIES_FRIGIBAX, SPECIES_VANILLITE},
        [2] = {SPECIES_FRIGIBAX, SPECIES_ARISTOCRABOFFSPRING_A, SPECIES_CUBCHOO, SPECIES_DARUMAKA_G, SPECIES_SNOM, SPECIES_CETITAN, SPECIES_ARCTIBAX, SPECIES_VANILLITE, SPECIES_CETODDLE, SPECIES_BAXCALIBUR},
        [3] = {SPECIES_SEALEO, SPECIES_SWINUB, SPECIES_VANILLISH, SPECIES_SNOVER, SPECIES_SPHEAL, SPECIES_SMOOCHUM, SPECIES_DANDELFLY_A, SPECIES_SNEASEL, SPECIES_SPOTTYBULBEAR_BELLE, SPECIES_ARMOREDMAWDAD},
        [4] = {SPECIES_SILVALLY_ICE, SPECIES_SPHEAL, SPECIES_AURORUS, SPECIES_DANDELFLY_A, SPECIES_ROTOM_FROST, SPECIES_SNORUNT, SPECIES_SNOVER, SPECIES_SNEASEL, SPECIES_ARMOREDMAWDAD, SPECIES_SWINUB},
        [5] = {SPECIES_AURORUS, SPECIES_SNEASEL, SPECIES_SPHEAL, SPECIES_ARMOREDMAWDAD, SPECIES_ROTOM_FROST, SPECIES_SILVALLY_ICE, SPECIES_DANDELFLY_A, SPECIES_MR_MIME_G, SPECIES_SWINUB, SPECIES_VANILLISH},
        ...
        [7] = {SPECIES_ABOMASNOW, SPECIES_WALREIN, SPECIES_GLACEON, SPECIES_ARTICUNO, SPECIES_FROSLASS, SPECIES_CLOYSTER, SPECIES_EISCUE_NOICE, SPECIES_DEWGONG, SPECIES_ARCTOZOLT, SPECIES_ARISTOCRAB_A},
        [8] = {SPECIES_GLASTRIER, SPECIES_KYUREM_WHITE, SPECIES_MR_RIME, SPECIES_VANILLUXE, SPECIES_ARCTOZOLT, SPECIES_DARMANITAN_G, SPECIES_AVALUGG, SPECIES_DARMANITAN_G_ZEN, SPECIES_ARISTOCRAB_A, SPECIES_CRABOMINABLE},
        [9] = {SPECIES_FROSLASS, SPECIES_KYUREM_WHITE, SPECIES_ARCTOVISH, SPECIES_MR_RIME, SPECIES_WALREIN, SPECIES_OATCHI, SPECIES_DARMANITAN_G_ZEN, SPECIES_DELIBIRD, SPECIES_DOWNYSNAGRET_A, SPECIES_CLOYSTER},
    },
    [CLASS_COLLECTOR] = {
        [0] = {SPECIES_CRUMBUG_A, SPECIES_DWARFBULBORB, SPECIES_LILLIPUP, SPECIES_SKITTY, SPECIES_DEERLING_WINTER, SPECIES_YUNGOOS, SPECIES_HELIOPTILE, SPECIES_HYDRAPPLE, SPECIES_DIPPLIN, SPECIES_ARBOLIVA},
        ...
        [3] = {SPECIES_DUNSPARCE, SPECIES_FOOLIX, SPECIES_JANGMO_O, SPECIES_SWABLU, SPECIES_SLAKOTH, SPECIES_AIPOM, SPECIES_WATCHOG, SPECIES_ZWEILOUS, SPECIES_HERDIER, SPECIES_EEVEE_GIGA},
        [4] = {SPECIES_LOUDRED, SPECIES_RUFFLET, SPECIES_SPINDA, SPECIES_DIGGERSBY, SPECIES_GIRAFARIG, SPECIES_TYPE_NULL, SPECIES_MOCKIWI, SPECIES_GOOLIX, SPECIES_HERDIER, SPECIES_MUNCHLAX},
    ...
    [CLASS_PKMN_TRAINER_3] = {
        [0] = {SPECIES_ZIGZAGOON, SPECIES_ZORUA_H, SPECIES_SQUAWKABILLY, SPECIES_DEERLING_AUTUMN, SPECIES_CYCLIZAR, SPECIES_DUDUNSPARCE_THREE, SPECIES_HOOTHOOT, SPECIES_DWARFBULBORB, SPECIES_DOLLIV, SPECIES_TAILLOW},
        [1] = {SPECIES_OINKOLOGNE_FEMALE, SPECIES_GIANTBREADBUG, SPECIES_TANDEMAUS, SPECIES_MAUSHOLD_FOUR, SPECIES_ZIGZAGOON, SPECIES_WHISMUR, SPECIES_SQUAWKABILLY_WHITE, SPECIES_CRUMBUG_A, SPECIES_SHROODLE, SPECIES_TERAPAGOS_STELLAR},
        [2] = {SPECIES_IGGLYBUFF, SPECIES_CRUMBUG_A, SPECIES_SKITTY, SPECIES_BIDOOF, SPECIES_MAUSHOLD, SPECIES_DUDUNSPARCE, SPECIES_SQUAWKABILLY_YELLOW, SPECIES_ZIGZAGOON, SPECIES_TERAPAGOS, SPECIES_MINCCINO},
        [3] = {SPECIES_SWABLU, SPECIES_TEDDIURSA, SPECIES_LITLEO, SPECIES_HERDIER, SPECIES_GLAMEOW, SPECIES_SMEARGLE, SPECIES_MOCKIWI, SPECIES_VIGOROTH, SPECIES_PORYGON, SPECIES_FOOLIX},
        [4] = {SPECIES_SWABLU, SPECIES_SPINDA, SPECIES_FOOLIX, SPECIES_SLAKOTH, SPECIES_VIGOROTH, SPECIES_CHATOT, SPECIES_RUFFLET, SPECIES_BREADBUG, SPECIES_CASTFORM, SPECIES_STARAVIA},
        [5] = {SPECIES_BUNEARY, SPECIES_CHATOT, SPECIES_BREADBUG, SPECIES_DUNSPARCE, SPECIES_RUFFLET, SPECIES_FARFETCHD, SPECIES_LITLEO, SPECIES_EEVEE_GIGA, SPECIES_BREADBUG_A, SPECIES_SMEARGLE},
        ...
        [7] = {SPECIES_SWELLOW, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_HELIOLISK, SPECIES_FROSTYBULBORB, SPECIES_FURFROU_KABUKI, SPECIES_LICKILICKY, SPECIES_URSALUNA, SPECIES_UNFEZANT, SPECIES_STOUTLAND, SPECIES_STARAPTOR},
    ...
    [CLASS_PKMN_BREEDER_RS] = {
        [0] = {SPECIES_LILLIPUP, SPECIES_TERAPAGOS, SPECIES_ZIGZAGOON_G, SPECIES_ARBOLIVA, SPECIES_IGGLYBUFF, SPECIES_DEERLING_AUTUMN, SPECIES_SNOWBULBORB, SPECIES_SKITTY, SPECIES_FLETCHLING, SPECIES_SQUAWKABILLY_YELLOW},
        [1] = {SPECIES_FARIGIRAF, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_PATRAT, SPECIES_DWARFBULBORB, SPECIES_MAUSHOLD_FOUR, SPECIES_BIDOOF, SPECIES_SNOWBULBORB, SPECIES_SQUAWKABILLY_YELLOW, SPECIES_SMOLIV, SPECIES_DUDUNSPARCE},
        ...
        [3] = {SPECIES_PYROCLASTICSLOOCH, SPECIES_EEVEE_GIGA, SPECIES_LOUDRED, SPECIES_RUFFLET, SPECIES_BREADBUG, SPECIES_SWABLU, SPECIES_BREADBUG_A, SPECIES_BIBAREL, SPECIES_TRUMBEAK, SPECIES_PORYGON},
        [4] = {SPECIES_SWABLU, SPECIES_SPINDA, SPECIES_STUFFUL, SPECIES_MOCKIWI, SPECIES_GOOLIX, SPECIES_BIBAREL, SPECIES_PORYGON, SPECIES_HERDIER, SPECIES_BREADBUG, SPECIES_EEVEE_GIGA},
        [5] = {SPECIES_BREADBUG_A, SPECIES_BUNEARY, SPECIES_GLAMEOW, SPECIES_FARFETCHD, SPECIES_LINOONE_G, SPECIES_DWARFORANGEBULBORB, SPECIES_STUFFUL, SPECIES_PORYGON, SPECIES_DUNSPARCE, SPECIES_SLAKOTH},
        [6] = {SPECIES_TOUCANNON, SPECIES_FURFROU, SPECIES_MELOETTA, SPECIES_AMBIPOM, SPECIES_FEAROW, SPECIES_FROSTYBULBORB_MEGA, SPECIES_FURFROU_LA_REINE, SPECIES_BRAVIARY, SPECIES_ZANGOOSE, SPECIES_SAWSBUCK_SUMMER},
    ...
    [CLASS_PKMN_RANGER_RS] = {
        [0] = {SPECIES_WHISMUR, SPECIES_MINCCINO, SPECIES_BUNNELBY, SPECIES_SENTRET, SPECIES_DOLLIV, SPECIES_STARLY, SPECIES_LECHONK, SPECIES_DWARFBULBORB_GIGA, SPECIES_PATRAT, SPECIES_EGG},
        [1] = {SPECIES_AZURILL, SPECIES_DUDUNSPARCE, SPECIES_DEERLING_WINTER, SPECIES_PIKIPEK, SPECIES_DEERLING, SPECIES_SQUAWKABILLY_BLUE, SPECIES_SKWOVET, SPECIES_FLETCHLING, SPECIES_TERAPAGOS_TERASTAL, SPECIES_DWARFBULBORB},
        [2] = {SPECIES_HELIOPTILE, SPECIES_DEERLING_WINTER, SPECIES_MAUSHOLD_FOUR, SPECIES_YUNGOOS, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_FARIGIRAF, SPECIES_STARLY, SPECIES_GIANTBREADBUG, SPECIES_TERAPAGOS_TERASTAL, SPECIES_SENTRET},
        [3] = {SPECIES_EEVEE, SPECIES_LOUDRED, SPECIES_SPINDA, SPECIES_TYPE_NULL, SPECIES_BUNEARY, SPECIES_FARFETCHD, SPECIES_DIGGERSBY, SPECIES_DUNSPARCE, SPECIES_GIRAFARIG, SPECIES_DWARFORANGEBULBORB},
        [4] = {SPECIES_BREADBUG, SPECIES_MUNCHLAX, SPECIES_LITLEO, SPECIES_WOOLOO, SPECIES_BIBAREL, SPECIES_LOUDRED, SPECIES_TRANQUILL, SPECIES_BREADBUG_A, SPECIES_STARAVIA, SPECIES_WATCHOG},
        [5] = {SPECIES_DIGGERSBY, SPECIES_LINOONE_G, SPECIES_BREADBUG, SPECIES_STUFFUL, SPECIES_GLAMEOW, SPECIES_BREADBUG_A, SPECIES_PYROCLASTICSLOOCH, SPECIES_LINOONE, SPECIES_GOOLIX, SPECIES_WOOLOO},
        ...
        [7] = {SPECIES_FURFROU_DANDY, SPECIES_AUDINO_MEGA, SPECIES_MELOETTA_PIROUETTE, SPECIES_SAWSBUCK, SPECIES_FROSTYBULBORB, SPECIES_PYROAR_FEMALE, SPECIES_HAPPINY, SPECIES_TAUROS, SPECIES_CINCCINO, SPECIES_HELIOLISK},
    ...
    [CLASS_MAGMA_LEADER] = {
        [0] = {SPECIES_SKWOVET, SPECIES_SQUAWKABILLY, SPECIES_DEERLING, SPECIES_TANDEMAUS, SPECIES_SMOLIV, SPECIES_DWARFBULBORB_GIGA, SPECIES_GIANTBREADBUG, SPECIES_MAUSHOLD_FOUR, SPECIES_SENTRET, SPECIES_DWARFBULBORB},
        ...
        [2] = {SPECIES_WHISMUR, SPECIES_DWARFBULBORB, SPECIES_TERAPAGOS, SPECIES_IGGLYBUFF, SPECIES_DWARFBULBORB_GIGA, SPECIES_EGG, SPECIES_ARBOLIVA, SPECIES_MAUSHOLD_FOUR, SPECIES_ZIGZAGOON, SPECIES_ZIGZAGOON_G},
        [3] = {SPECIES_SMEARGLE, SPECIES_CHATOT, SPECIES_DWARFORANGEBULBORB, SPECIES_PORYGON, SPECIES_TRUMBEAK, SPECIES_BREADBUG, SPECIES_FURRET, SPECIES_DELCATTY, SPECIES_MOCKIWI, SPECIES_SPINDA},
        [4] = {SPECIES_EEVEE, SPECIES_BIBAREL, SPECIES_SWABLU, SPECIES_TYPE_NULL, SPECIES_WOOLOO, SPECIES_DWARFORANGEBULBORB, SPECIES_MOCKIWI, SPECIES_VIGOROTH, SPECIES_SPINDA, SPECIES_DUNSPARCE},
        [5] = {SPECIES_HERDIER, SPECIES_BIBAREL, SPECIES_LITLEO, SPECIES_DWARFFROSTYBULBORB, SPECIES_KECLEON, SPECIES_STUFFUL, SPECIES_MUNCHLAX, SPECIES_TEDDIURSA, SPECIES_STARAVIA, SPECIES_FURRET},
        [6] = {SPECIES_DUBWOOL, SPECIES_REGIGIGAS, SPECIES_FURFROU_KABUKI, SPECIES_FROSTYBULBORB, SPECIES_WYRDEER, SPECIES_PORYGON2, SPECIES_TAUROS, SPECIES_STOUTLAND, SPECIES_STANTLER, SPECIES_SAWSBUCK_WINTER},
        [7] = {SPECIES_PORYGON_Z, SPECIES_DUBWOOL, SPECIES_KANGASKHAN, SPECIES_FURFROU_PHAROAH, SPECIES_MELOETTA, SPECIES_WYRDEER, SPECIES_OBSTAGOON, SPECIES_FROSTYBULBORB_MEGA, SPECIES_STANTLER, SPECIES_DRAMPA},
    ...
    [CLASS_TEAM_MAGMA] = {
        ...
        [1] = {SPECIES_GIANTBREADBUG, SPECIES_MAUSHOLD_FOUR, SPECIES_SQUAWKABILLY_WHITE, SPECIES_TERAPAGOS_STELLAR, SPECIES_DEERLING_WINTER, SPECIES_DEERLING_AUTUMN, SPECIES_DUDUNSPARCE, SPECIES_BIDOOF, SPECIES_BUNNELBY, SPECIES_STARLY},
        [2] = {SPECIES_STARLY, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_AZURILL, SPECIES_BIDOOF, SPECIES_OINKOLOGNE_FEMALE, SPECIES_TERAPAGOS, SPECIES_TERAPAGOS_STELLAR, SPECIES_EGG, SPECIES_SENTRET, SPECIES_SNOWBULBORB},
        [3] = {SPECIES_VIGOROTH, SPECIES_BREADBUG, SPECIES_SMEARGLE, SPECIES_GUMSHOOS, SPECIES_HERDIER, SPECIES_DWARFFROSTYBULBORB, SPECIES_DUNSPARCE, SPECIES_SWABLU, SPECIES_CASTFORM, SPECIES_MOCKIWI},
        [4] = {SPECIES_SLAKOTH, SPECIES_FURRET, SPECIES_CHATOT, SPECIES_CASTFORM, SPECIES_GIRAFARIG, SPECIES_DIGGERSBY, SPECIES_STUFFUL, SPECIES_BREADBUG_A, SPECIES_PYROCLASTICSLOOCH, SPECIES_LOUDRED},
        [5] = {SPECIES_LITLEO, SPECIES_EEVEE, SPECIES_MOCKIWI, SPECIES_GOOLIX, SPECIES_GLAMEOW, SPECIES_WATCHOG, SPECIES_KECLEON, SPECIES_SLAKOTH, SPECIES_RUFFLET, SPECIES_GIRAFARIG},
        [6] = {SPECIES_LOPUNNY, SPECIES_SLAKING, SPECIES_FURFROU_LA_REINE, SPECIES_TAUROS, SPECIES_FURFROU_HEART, SPECIES_EXPLOUD, SPECIES_KANGASKHAN_MEGA, SPECIES_SWELLOW, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_HAPPINY},
        ...
        [8] = {SPECIES_DRAMPA, SPECIES_SNORLAX, SPECIES_HAPPINY, SPECIES_FURFROU_DIAMOND, SPECIES_STANTLER, SPECIES_UNFEZANT, SPECIES_AMBIPOM, SPECIES_FROSTYBULBORB_MEGA, SPECIES_MILTANK, SPECIES_BRAVIARY},
        [9] = {SPECIES_SAWSBUCK_AUTUMN, SPECIES_AUDINO_MEGA, SPECIES_INDEEDEE, SPECIES_FURFROU_STAR, SPECIES_EXPLOUD, SPECIES_FURFROU_LA_REINE, SPECIES_FROSTYBULBORB_MEGA, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_REGIGIGAS, SPECIES_KOMALA},
    },
    [CLASS_LASS_RS] = {
        [0] = {SPECIES_PATRAT, SPECIES_GIANTBREADBUG, SPECIES_SQUAWKABILLY_YELLOW, SPECIES_ZIGZAGOON, SPECIES_DEERLING_WINTER, SPECIES_SHROODLE, SPECIES_WHISMUR, SPECIES_FARIGIRAF, SPECIES_GRAFAIAI, SPECIES_BIDOOF},
        [1] = {SPECIES_OINKOLOGNE_FEMALE, SPECIES_DEERLING_WINTER, SPECIES_MAUSHOLD, SPECIES_DWARFBULBORB_GIGA, SPECIES_CYCLIZAR, SPECIES_SQUAWKABILLY_BLUE, SPECIES_PIDOVE, SPECIES_OINKOLOGNE, SPECIES_DUDUNSPARCE, SPECIES_SQUAWKABILLY},
        [2] = {SPECIES_TERAPAGOS_TERASTAL, SPECIES_EGG, SPECIES_SENTRET, SPECIES_DOLLIV, SPECIES_OINKOLOGNE_FEMALE, SPECIES_AZURILL, SPECIES_LECHONK, SPECIES_CRUMBUG_A, SPECIES_SKWOVET, SPECIES_LILLIPUP},
        [3] = {SPECIES_EEVEE, SPECIES_PYROCLASTICSLOOCH, SPECIES_HERDIER, SPECIES_TYPE_NULL, SPECIES_EEVEE_GIGA, SPECIES_LITLEO, SPECIES_AIPOM, SPECIES_CASTFORM, SPECIES_TEDDIURSA, SPECIES_DWARFORANGEBULBORB},
        [4] = {SPECIES_LINOONE_G, SPECIES_LINOONE, SPECIES_SLAKOTH, SPECIES_SMEARGLE, SPECIES_DELCATTY, SPECIES_GOOLIX, SPECIES_LITLEO, SPECIES_DUNSPARCE, SPECIES_DWARFFROSTYBULBORB, SPECIES_PYROCLASTICSLOOCH},
        [5] = {SPECIES_DIGGERSBY, SPECIES_PORYGON, SPECIES_DWARFFROSTYBULBORB, SPECIES_PYROCLASTICSLOOCH, SPECIES_HERDIER, SPECIES_GOOLIX, SPECIES_DELCATTY, SPECIES_GIRAFARIG, SPECIES_TRANQUILL, SPECIES_EEVEE},
        [6] = {SPECIES_FEAROW, SPECIES_ARCEUS, SPECIES_EXPLOUD, SPECIES_FROSTYBULBORB, SPECIES_SAWSBUCK_SUMMER, SPECIES_AUDINO_MEGA, SPECIES_FURFROU_PHAROAH, SPECIES_SWELLOW, SPECIES_FURFROU_KABUKI, SPECIES_BRAVIARY},
        [7] = {SPECIES_FURFROU_MATRON, SPECIES_AMBIPOM, SPECIES_FEAROW, SPECIES_SAWSBUCK_AUTUMN, SPECIES_FURFROU_DANDY, SPECIES_CINCCINO, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_LICKILICKY, SPECIES_LOPUNNY, SPECIES_FURFROU_LA_REINE},
    ...
    [CLASS_BUG_CATCHER_RS] = {
        [0] = {SPECIES_URSALUNA_BLOODMOON, SPECIES_SQUAWKABILLY_WHITE, SPECIES_DEERLING_WINTER, SPECIES_DUDUNSPARCE, SPECIES_SQUAWKABILLY_YELLOW, SPECIES_FARIGIRAF, SPECIES_EGG, SPECIES_CRUMBUG_A, SPECIES_ZIGZAGOON, SPECIES_YUNGOOS},
        [1] = {SPECIES_HELIOPTILE, SPECIES_EGG, SPECIES_URSALUNA_BLOODMOON, SPECIES_SHROODLE, SPECIES_DEERLING_AUTUMN, SPECIES_MAUSHOLD, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_DEERLING, SPECIES_MINCCINO, SPECIES_STARLY},
        ...
        [3] = {SPECIES_SMEARGLE, SPECIES_TRANQUILL, SPECIES_EEVEE_GIGA, SPECIES_PORYGON, SPECIES_BUNEARY, SPECIES_TYPE_NULL, SPECIES_STUFFUL, SPECIES_DWARFORANGEBULBORB, SPECIES_SLAKOTH, SPECIES_LINOONE_G},
        [4] = {SPECIES_VIGOROTH, SPECIES_LINOONE, SPECIES_SMEARGLE, SPECIES_LINOONE_G, SPECIES_SPINDA, SPECIES_MOCKIWI, SPECIES_TEDDIURSA, SPECIES_GUMSHOOS, SPECIES_GIRAFARIG, SPECIES_BREADBUG},
        [5] = {SPECIES_BREADBUG_A, SPECIES_TYPE_NULL, SPECIES_EEVEE_GIGA, SPECIES_WATCHOG, SPECIES_SMEARGLE, SPECIES_WOOLOO, SPECIES_VIGOROTH, SPECIES_DELCATTY, SPECIES_TRANQUILL, SPECIES_LITLEO},
        [6] = {SPECIES_FURFROU_MATRON, SPECIES_SWELLOW, SPECIES_FURFROU_HEART, SPECIES_FURFROU_STAR, SPECIES_ARCEUS, SPECIES_FROSTYBULBORB_MEGA, SPECIES_HELIOLISK, SPECIES_DRAMPA, SPECIES_SAWSBUCK, SPECIES_UNFEZANT_F},
        [7] = {SPECIES_FURFROU_MATRON, SPECIES_SNORLAX, SPECIES_BLISSEY, SPECIES_REGIGIGAS, SPECIES_FROSTYBULBORB, SPECIES_SAWSBUCK, SPECIES_WYRDEER, SPECIES_URSARING, SPECIES_STOUTLAND, SPECIES_INDEEDEE_FEMALE},
        [8] = {SPECIES_ARCEUS, SPECIES_LOPUNNY_MEGA, SPECIES_FURFROU_HEART, SPECIES_BOUFFALANT, SPECIES_GREEDENT, SPECIES_UNFEZANT, SPECIES_SILVALLY, SPECIES_STANTLER, SPECIES_FURFROU_KABUKI, SPECIES_FROSTYBULBORB},
    ...
    [CLASS_HIKER_RS] = {
        [0] = {SPECIES_SQUAWKABILLY, SPECIES_SQUAWKABILLY_YELLOW, SPECIES_TERAPAGOS, SPECIES_FARIGIRAF, SPECIES_WHISMUR, SPECIES_SNOWBULBORB, SPECIES_CRUMBUG, SPECIES_OINKOLOGNE_FEMALE, SPECIES_DOLLIV, SPECIES_TERAPAGOS_TERASTAL},
        ...
        [2] = {SPECIES_HOOTHOOT, SPECIES_SNOWBULBORB, SPECIES_ARBOLIVA, SPECIES_MAUSHOLD_FOUR, SPECIES_SQUAWKABILLY_YELLOW, SPECIES_GRAFAIAI, SPECIES_SENTRET, SPECIES_PIDOVE, SPECIES_ZIGZAGOON, SPECIES_EGG},
        [3] = {SPECIES_SLAKOTH, SPECIES_LINOONE_G, SPECIES_DWARFORANGEBULBORB, SPECIES_FOOLIX, SPECIES_EEVEE, SPECIES_BUNEARY, SPECIES_SPINDA, SPECIES_EEVEE_GIGA, SPECIES_LINOONE, SPECIES_HERDIER},
        [4] = {SPECIES_BUNEARY, SPECIES_SWABLU, SPECIES_RUFFLET, SPECIES_VIGOROTH, SPECIES_BIBAREL, SPECIES_LINOONE, SPECIES_GIRAFARIG, SPECIES_GUMSHOOS, SPECIES_DWARFFROSTYBULBORB, SPECIES_FOOLIX},
        [5] = {SPECIES_BUNEARY, SPECIES_BREADBUG, SPECIES_LITLEO, SPECIES_EEVEE_GIGA, SPECIES_LOUDRED, SPECIES_EEVEE, SPECIES_SMEARGLE, SPECIES_CASTFORM, SPECIES_GIRAFARIG, SPECIES_WOOLOO},
        [6] = {SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_UNFEZANT, SPECIES_REGIGIGAS, SPECIES_FURFROU, SPECIES_PORYGON2, SPECIES_FROSTYBULBORB, SPECIES_KANGASKHAN, SPECIES_ARCEUS, SPECIES_TOUCANNON, SPECIES_DUBWOOL},
        [7] = {SPECIES_SILVALLY, SPECIES_FURFROU_KABUKI, SPECIES_EXPLOUD, SPECIES_FROSTYBULBORB, SPECIES_DUBWOOL, SPECIES_FURFROU_DIAMOND, SPECIES_SNORLAX, SPECIES_SAWSBUCK_AUTUMN, SPECIES_STARAPTOR, SPECIES_PORYGON_Z},
    ...
    [CLASS_YOUNG_COUPLE_RS] = {
        [0] = {SPECIES_IGGLYBUFF, SPECIES_BUNNELBY, SPECIES_DEERLING_AUTUMN, SPECIES_TANDEMAUS, SPECIES_SKITTY, SPECIES_TERAPAGOS, SPECIES_SKWOVET, SPECIES_SNOWBULBORB, SPECIES_STARLY, SPECIES_SQUAWKABILLY_WHITE},
        [1] = {SPECIES_OINKOLOGNE_FEMALE, SPECIES_DEERLING_SUMMER, SPECIES_SKWOVET, SPECIES_HELIOPTILE, SPECIES_CRUMBUG_A, SPECIES_CYCLIZAR, SPECIES_SQUAWKABILLY, SPECIES_ZIGZAGOON, SPECIES_DEERLING_WINTER, SPECIES_DWARFBULBORB_GIGA},
        [2] = {SPECIES_LECHONK, SPECIES_IGGLYBUFF, SPECIES_ZORUA_H, SPECIES_OINKOLOGNE, SPECIES_FLETCHLING, SPECIES_ARBOLIVA, SPECIES_ZIGZAGOON, SPECIES_CRUMBUG_A, SPECIES_GRAFAIAI, SPECIES_PIKIPEK},
        [3] = {SPECIES_KECLEON, SPECIES_GLAMEOW, SPECIES_WOOLOO, SPECIES_LOUDRED, SPECIES_SMEARGLE, SPECIES_GIRAFARIG, SPECIES_FARFETCHD, SPECIES_MUNCHLAX, SPECIES_BUNEARY, SPECIES_DWARFORANGEBULBORB},
        [4] = {SPECIES_BUNEARY, SPECIES_MOCKIWI, SPECIES_GLAMEOW, SPECIES_RUFFLET, SPECIES_GOOLIX, SPECIES_BREADBUG_A, SPECIES_LINOONE, SPECIES_LINOONE_G, SPECIES_STARAVIA, SPECIES_SWABLU},
        [5] = {SPECIES_FOOLIX, SPECIES_HERDIER, SPECIES_CHATOT, SPECIES_DWARFFROSTYBULBORB, SPECIES_BREADBUG_A, SPECIES_KECLEON, SPECIES_GOOLIX, SPECIES_GUMSHOOS, SPECIES_VIGOROTH, SPECIES_BIBAREL},
        ...
        [7] = {SPECIES_FURFROU_DANDY, SPECIES_SAWSBUCK, SPECIES_URSARING, SPECIES_LOPUNNY_MEGA, SPECIES_KANGASKHAN_MEGA, SPECIES_FROSTYBULBORB, SPECIES_SNORLAX_GIGA, SPECIES_MELOETTA, SPECIES_FURFROU, SPECIES_LICKILICKY},
        ...
        [9] = {SPECIES_AUDINO_MEGA, SPECIES_FURFROU_DANDY, SPECIES_PORYGON_Z, SPECIES_BLISSEY, SPECIES_CHANSEY, SPECIES_ZANGOOSE, SPECIES_KOMALA, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_FURFROU_STAR, SPECIES_KANGASKHAN_MEGA},
    },
    [CLASS_OLD_COUPLE] = {
        [0] = {SPECIES_TERAPAGOS_STELLAR, SPECIES_DEERLING_SUMMER, SPECIES_SMOLIV, SPECIES_PIKIPEK, SPECIES_DUDUNSPARCE, SPECIES_PIDOVE, SPECIES_EGG, SPECIES_CRUMBUG, SPECIES_CRUMBUG_A, SPECIES_TERAPAGOS},
        [1] = {SPECIES_DWARFBULBORB, SPECIES_LILLIPUP, SPECIES_URSALUNA_BLOODMOON, SPECIES_WHISMUR, SPECIES_PIDOVE, SPECIES_GIANTBREADBUG, SPECIES_TAILLOW, SPECIES_BIDOOF, SPECIES_DWARFBULBORB_GIGA, SPECIES_SQUAWKABILLY_BLUE},
        [2] = {SPECIES_DWARFBULBORB, SPECIES_DWARFBULBORB_GIGA, SPECIES_DEERLING, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_MINCCINO, SPECIES_HOOTHOOT, SPECIES_HELIOPTILE, SPECIES_ZIGZAGOON, SPECIES_BIDOOF, SPECIES_MAUSHOLD},
        [3] = {SPECIES_CASTFORM, SPECIES_WOOLOO, SPECIES_KECLEON, SPECIES_LOUDRED, SPECIES_AIPOM, SPECIES_DWARFORANGEBULBORB, SPECIES_PYROCLASTICSLOOCH, SPECIES_SPINDA, SPECIES_VIGOROTH, SPECIES_PORYGON},
        [4] = {SPECIES_EEVEE, SPECIES_STARAVIA, SPECIES_LITLEO, SPECIES_LINOONE, SPECIES_BIBAREL, SPECIES_PYROCLASTICSLOOCH, SPECIES_FARFETCHD, SPECIES_LOUDRED, SPECIES_TRUMBEAK, SPECIES_BREADBUG_A},
        [5] = {SPECIES_BIBAREL, SPECIES_TRANQUILL, SPECIES_TYPE_NULL, SPECIES_TEDDIURSA, SPECIES_BREADBUG, SPECIES_FARFETCHD, SPECIES_LOUDRED, SPECIES_AIPOM, SPECIES_TRUMBEAK, SPECIES_LINOONE},
    ...
    [CLASS_SIS_AND_BRO_RS] = {
        ...
        [1] = {SPECIES_WHISMUR, SPECIES_DUDUNSPARCE, SPECIES_SENTRET, SPECIES_ARBOLIVA, SPECIES_DWARFBULBORB, SPECIES_LILLIPUP, SPECIES_CRUMBUG_A, SPECIES_PATRAT, SPECIES_FLETCHLING, SPECIES_ZORUA_H},
        [2] = {SPECIES_GIANTBREADBUG, SPECIES_SENTRET, SPECIES_SQUAWKABILLY, SPECIES_DWARFBULBORB_GIGA, SPECIES_DEERLING, SPECIES_DOLLIV, SPECIES_MAUSHOLD_FOUR, SPECIES_SQUAWKABILLY_BLUE, SPECIES_TERAPAGOS, SPECIES_BUNNELBY},
        [3] = {SPECIES_PYROCLASTICSLOOCH, SPECIES_FURRET, SPECIES_BREADBUG_A, SPECIES_MOCKIWI, SPECIES_BIBAREL, SPECIES_GIRAFARIG, SPECIES_LINOONE, SPECIES_TRUMBEAK, SPECIES_GOOLIX, SPECIES_DELCATTY},
        [4] = {SPECIES_BREADBUG, SPECIES_PORYGON, SPECIES_GLAMEOW, SPECIES_GUMSHOOS, SPECIES_DWARFORANGEBULBORB, SPECIES_LITLEO, SPECIES_WOOLOO, SPECIES_GOOLIX, SPECIES_DIGGERSBY, SPECIES_WATCHOG},
        [5] = {SPECIES_DELCATTY, SPECIES_STARAVIA, SPECIES_TRUMBEAK, SPECIES_BREADBUG, SPECIES_LINOONE, SPECIES_FURRET, SPECIES_MUNCHLAX, SPECIES_GOOLIX, SPECIES_WOOLOO, SPECIES_GLAMEOW},
        ...
        [8] = {SPECIES_BLISSEY, SPECIES_DUBWOOL, SPECIES_TAUROS, SPECIES_STOUTLAND, SPECIES_KANGASKHAN, SPECIES_SAWSBUCK_SUMMER, SPECIES_AUDINO_MEGA, SPECIES_URSALUNA, SPECIES_PORYGON2, SPECIES_LESSERSPOTTEDJELLYFLOAT},
        [9] = {SPECIES_FROSTYBULBORB, SPECIES_WYRDEER, SPECIES_LOPUNNY_MEGA, SPECIES_PYROAR, SPECIES_GREEDENT, SPECIES_URSALUNA, SPECIES_INDEEDEE_FEMALE, SPECIES_MELOETTA_PIROUETTE, SPECIES_FURFROU_HEART, SPECIES_BEWEAR},
    },
    [CLASS_AQUA_ADMIN] = {
        [0] = {SPECIES_SQUAWKABILLY_WHITE, SPECIES_DOLLIV, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_SHROODLE, SPECIES_MINCCINO, SPECIES_OINKOLOGNE, SPECIES_ZORUA_H, SPECIES_OINKOLOGNE_FEMALE, SPECIES_AZURILL, SPECIES_LILLIPUP},
        [1] = {SPECIES_ARBOLIVA, SPECIES_PIDOVE, SPECIES_MAUSHOLD_FOUR, SPECIES_STARLY, SPECIES_YUNGOOS, SPECIES_DEERLING, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_DOLLIV, SPECIES_MINCCINO, SPECIES_TANDEMAUS},
        [2] = {SPECIES_OINKOLOGNE, SPECIES_BUNNELBY, SPECIES_DEERLING, SPECIES_SQUAWKABILLY, SPECIES_DEERLING_AUTUMN, SPECIES_YUNGOOS, SPECIES_HOOTHOOT, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_CYCLIZAR, SPECIES_FARIGIRAF},
        [3] = {SPECIES_DIGGERSBY, SPECIES_FURRET, SPECIES_BIBAREL, SPECIES_TYPE_NULL, SPECIES_GIRAFARIG, SPECIES_GLAMEOW, SPECIES_TRUMBEAK, SPECIES_BUNEARY, SPECIES_MOCKIWI, SPECIES_LITLEO},
        [4] = {SPECIES_BREADBUG_A, SPECIES_STUFFUL, SPECIES_HERDIER, SPECIES_EEVEE, SPECIES_GIRAFARIG, SPECIES_KECLEON, SPECIES_DWARFORANGEBULBORB, SPECIES_BREADBUG, SPECIES_PYROCLASTICSLOOCH, SPECIES_TRUMBEAK},
        [5] = {SPECIES_KECLEON, SPECIES_EEVEE, SPECIES_GOOLIX, SPECIES_DUNSPARCE, SPECIES_BREADBUG_A, SPECIES_GUMSHOOS, SPECIES_CHATOT, SPECIES_CASTFORM, SPECIES_VIGOROTH, SPECIES_SPINDA},
        ...
        [8] = {SPECIES_KOMALA, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_FURFROU_PHAROAH, SPECIES_STARAPTOR, SPECIES_MELOETTA, SPECIES_SAWSBUCK_WINTER, SPECIES_FURFROU_LA_REINE, SPECIES_DUBWOOL, SPECIES_CINCCINO, SPECIES_STOUTLAND},
    ...
    [CLASS_MAGMA_ADMIN] = {
        [0] = {SPECIES_DWARFBULBORB, SPECIES_SKITTY, SPECIES_AZURILL, SPECIES_CYCLIZAR, SPECIES_GIANTBREADBUG, SPECIES_DUDUNSPARCE_THREE, SPECIES_SNOWBULBORB, SPECIES_HOOTHOOT, SPECIES_MAUSHOLD, SPECIES_LILLIPUP},
        ...
        [2] = {SPECIES_DEERLING, SPECIES_OINKOLOGNE, SPECIES_YUNGOOS, SPECIES_IGGLYBUFF, SPECIES_SKWOVET, SPECIES_DWARFBULBORB, SPECIES_TERAPAGOS, SPECIES_SQUAWKABILLY_YELLOW, SPECIES_TAILLOW, SPECIES_SNOWBULBORB},
        ...
        [4] = {SPECIES_RUFFLET, SPECIES_SMEARGLE, SPECIES_SPINDA, SPECIES_GLAMEOW, SPECIES_VIGOROTH, SPECIES_GOOLIX, SPECIES_MUNCHLAX, SPECIES_LITLEO, SPECIES_HERDIER, SPECIES_TYPE_NULL},
        [5] = {SPECIES_LITLEO, SPECIES_DELCATTY, SPECIES_DUNSPARCE, SPECIES_FURRET, SPECIES_SLAKOTH, SPECIES_HERDIER, SPECIES_MOCKIWI, SPECIES_RUFFLET, SPECIES_AIPOM, SPECIES_SMEARGLE},
        ...
        [7] = {SPECIES_PURUGLY, SPECIES_STOUTLAND, SPECIES_FURFROU_STAR, SPECIES_FURFROU_MATRON, SPECIES_CINCCINO, SPECIES_DRAMPA, SPECIES_FURFROU, SPECIES_FROSTYBULBORB_MEGA, SPECIES_ZOROARK_H, SPECIES_LESSERSPOTTEDJELLYFLOAT},
        [8] = {SPECIES_SNORLAX, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_PYROAR_FEMALE, SPECIES_GREEDENT, SPECIES_AMBIPOM, SPECIES_HELIOLISK, SPECIES_PYROAR, SPECIES_CINCCINO, SPECIES_FURFROU_STAR, SPECIES_FURFROU_HEART},
    ...
    [CLASS_YOUNGSTER] = {
        ...
        [1] = {SPECIES_TERAPAGOS_TERASTAL, SPECIES_DUDUNSPARCE_THREE, SPECIES_GIANTBREADBUG, SPECIES_CRUMBUG_A, SPECIES_BURMY, SPECIES_SQUAWKABILLY_BLUE, SPECIES_SENTRET, SPECIES_FLETCHLING, SPECIES_YUNGOOS, SPECIES_SKWOVET},
        [2] = {SPECIES_DEERLING_WINTER, SPECIES_SKWOVET, SPECIES_DWARFBULBORB, SPECIES_SNOM, SPECIES_ZORUA_H, SPECIES_VENIPEDE, SPECIES_JOLTIK, SPECIES_GIANTBREADBUG, SPECIES_MAUSHOLD_FOUR, SPECIES_RELLOR},
        [3] = {SPECIES_BREADBUG, SPECIES_ARMOREDCANNONBEETLE, SPECIES_TRAPINCH, SPECIES_STARAVIA, SPECIES_STARTLESPORE, SPECIES_HORNEDCANNONBEETLE, SPECIES_WORMADAM_TRASH, SPECIES_ARAQUANID, SPECIES_SHEDINJA, SPECIES_MUNCHLAX},
        [4] = {SPECIES_BUMBLINGSNITCHBUG, SPECIES_WOOLOO, SPECIES_AIPOM, SPECIES_CASCOON, SPECIES_SHUCKLE, SPECIES_SMEARGLE, SPECIES_PYROCLASTICSLOOCH, SPECIES_BIBAREL, SPECIES_FORRETRESS, SPECIES_ARMOREDCANNONBEETLE},
        [5] = {SPECIES_KECLEON, SPECIES_ARIADOS, SPECIES_MUNCHLAX, SPECIES_CREEPINGCHRYSANTHEMUM, SPECIES_SILCOON, SPECIES_LOUDRED, SPECIES_SILVALLY_BUG, SPECIES_TEDDIURSA, SPECIES_WOOLOO, SPECIES_SWADLOON},
        ...
        [9] = {SPECIES_ARCEUS, SPECIES_FURFROU_KABUKI, SPECIES_TOUCANNON, SPECIES_PURUGLY, SPECIES_DRAMPA, SPECIES_BEAUTIFLY, SPECIES_VIVILLON_CONTINENTAL, SPECIES_BRAVIARY, SPECIES_HERACROSS, SPECIES_DIRIGIBUG},
    },
    [CLASS_BUG_CATCHER] = {
        [0] = {SPECIES_BURMY, SPECIES_RELLOR, SPECIES_SLITHER_WING, SPECIES_GRUBBIN, SPECIES_SWOOPINGSNITCHBUG, SPECIES_JOLTIK, SPECIES_LOKIX, SPECIES_WIMPOD, SPECIES_VENIPEDE, SPECIES_NYMBLE},
        [1] = {SPECIES_GRUBBIN, SPECIES_RELLOR, SPECIES_JOLTIK, SPECIES_SWOOPINGSNITCHBUG, SPECIES_LEDYBA, SPECIES_BURMY_TRASH, SPECIES_LOKIX, SPECIES_NYMBLE, SPECIES_COMBEE, SPECIES_BURMY},
        [2] = {SPECIES_SNOM, SPECIES_BURMY_SANDY, SPECIES_BLIPBUG, SPECIES_FLINTBEETLE, SPECIES_COMBEE, SPECIES_SHELMET, SPECIES_DEWPIDER, SPECIES_TAROUNTULA, SPECIES_NINCADA, SPECIES_DWEBBLE},
        [3] = {SPECIES_DOTTLER, SPECIES_ARMOREDCANNONBEETLE, SPECIES_SILCOON, SPECIES_WHIRLIPEDE, SPECIES_SKORUPI, SPECIES_SWADLOON, SPECIES_DOODLEBUG, SPECIES_CASCOON, SPECIES_BUMBLINGSNITCHBUG, SPECIES_ANORITH},
        ...
        [5] = {SPECIES_VOLBEAT, SPECIES_SILVALLY_BUG, SPECIES_ARMOREDCANNONBEETLE, SPECIES_DOTTLER, SPECIES_LEDIAN, SPECIES_LARVESTA, SPECIES_SPEWPA, SPECIES_DOODLEBUG, SPECIES_CASCOON, SPECIES_SWADLOON},
        [6] = {SPECIES_HERACROSS, SPECIES_YANMEGA, SPECIES_VIVILLON_HIGH_PLAINS, SPECIES_GLINTBEETLE, SPECIES_CENTISKORCH_GIGA, SPECIES_VIVILLON_POLAR, SPECIES_VIVILLON_MONSOON, SPECIES_GENESECT_CHILL, SPECIES_VIVILLON_MARINE, SPECIES_VIVILLON_RIVER},
        [7] = {SPECIES_ORBEETLE, SPECIES_VIVILLON, SPECIES_GENESECT_DOUSE, SPECIES_BEAUTIFLY, SPECIES_VIVILLON_POKEBALL, SPECIES_HERACROSS, SPECIES_VIVILLON_OCEAN, SPECIES_VIVILLON_ARCHIPELAGO, SPECIES_ARCEUS_BUG, SPECIES_DIRIGIBUG},
        [8] = {SPECIES_GALVANTULA, SPECIES_VIVILLON_SUN, SPECIES_CENTISKORCH_GIGA, SPECIES_GENESECT_BURN, SPECIES_GLINTBEETLE, SPECIES_BEAUTIFLY, SPECIES_ARMALDO, SPECIES_DUSTOX, SPECIES_WORMADAM, SPECIES_ACCELGOR},
    ...
    [CLASS_LASS] = {
        ...
        [3] = {SPECIES_MIME_JR, SPECIES_PANSAGE, SPECIES_DARTRIX, SPECIES_PUFFMIN_H, SPECIES_GOOLIX, SPECIES_QUEENSHEARWIG, SPECIES_SUNFLORA, SPECIES_CHERRIM, SPECIES_ARACHNODE, SPECIES_THWACKEY},
        [4] = {SPECIES_GOOLIX, SPECIES_SKIDDO, SPECIES_KIRLIA, SPECIES_SKIPLOOM, SPECIES_MAWILE_MEGA, SPECIES_SERVINE, SPECIES_SKITTERLEAF, SPECIES_MORGREM, SPECIES_HORNEDCANNONBEETLE, SPECIES_LOMBRE},
        [5] = {SPECIES_MR_MIME, SPECIES_SEWADDLE, SPECIES_SKITTERLEAF, SPECIES_GLOOM, SPECIES_MAWILE, SPECIES_BULBORB, SPECIES_FLOETTE_ETERNAL, SPECIES_SPOTTYBULBEAR_POP_STAR, SPECIES_GOOLIX, SPECIES_PANSAGE},
        [6] = {SPECIES_SHAYMIN_SKY, SPECIES_SAWSBUCK_WINTER, SPECIES_TOGEKISS, SPECIES_GARDEVOIR_MEGA, SPECIES_AMOONGUSS, SPECIES_GRIMMSNARL_GIGA, SPECIES_TAPU_FINI, SPECIES_SHIFTRY, SPECIES_MOLDYDWARFBULBORB, SPECIES_ELDEGOSS},
        [7] = {SPECIES_MOLDYSLOOCH, SPECIES_FLORGES_YELLOW, SPECIES_CARNIVINE, SPECIES_SAWSBUCK_SUMMER, SPECIES_JUMBOBULBORB_MEGA, SPECIES_ALCREMIE_BERRY, SPECIES_AZUMARILL, SPECIES_HATTERENE, SPECIES_ARCEUS_GRASS, SPECIES_DHELMISE},
        [8] = {SPECIES_CALYREX, SPECIES_BRELOOM, SPECIES_SHIFTRY, SPECIES_ARMOREDCANNONLARVA, SPECIES_SCEPTILE, SPECIES_FLORGES, SPECIES_ALCREMIE_RIBBON, SPECIES_FERROTHORN, SPECIES_ROSELIA, SPECIES_TAPU_FINI},
    ...
    [CLASS_SAILOR] = {
        ...
        [1] = {SPECIES_TATSUGIRI_RED, SPECIES_CLOBBOPUS, SPECIES_DUCKLETT, SPECIES_QUAQUAVAL, SPECIES_FINIZEN, SPECIES_WALKING_WAKE, SPECIES_FEEBAS, SPECIES_QUAXLY, SPECIES_MARILL, SPECIES_WOLPOLE},
        ...
        [3] = {SPECIES_DRIZZILE, SPECIES_MEDITITE, SPECIES_ARAQUANID, SPECIES_SILVALLY_FIGHT, SPECIES_BUIZEL, SPECIES_FINNEON, SPECIES_MANATLEGS, SPECIES_WISHIWASHI_S, SPECIES_MANTYKE, SPECIES_RIOLU},
        [4] = {SPECIES_FROGADIER, SPECIES_WISHIWASHI_S, SPECIES_TOXSTOOL, SPECIES_BRIONNE, SPECIES_SLOWPOKE, SPECIES_GOLDEEN, SPECIES_KRABBY, SPECIES_MACHOKE, SPECIES_ARAQUANID, SPECIES_ROTOM_WASH},
        ...
        [7] = {SPECIES_OATCHI, SPECIES_CARRACOSTA, SPECIES_MASTERHOP_MEGA, SPECIES_GASTRODON_EAST, SPECIES_ZAMAZENTA_CROWNED, SPECIES_TOXICROAK, SPECIES_ALOMOMOLA, SPECIES_EMBOAR, SPECIES_TAPU_FINI, SPECIES_MASTERHOP},
        [8] = {SPECIES_PRIMARINA, SPECIES_MASTERHOP_MEGA, SPECIES_GASTRODON, SPECIES_FERALIGATR, SPECIES_PALKIA_ORIGIN, SPECIES_BURROWNIT, SPECIES_BLAZIKEN_MEGA, SPECIES_GOLISOPOD, SPECIES_HERACROSS_MEGA, SPECIES_MANTINE},
        [9] = {SPECIES_ASHGRENINJA, SPECIES_BRELOOM, SPECIES_SHARPEDO_MEGA, SPECIES_KABUTOPS, SPECIES_BURROWNIT, SPECIES_POLITOED, SPECIES_MARSHADOW, SPECIES_MASTERONION_MEGA, SPECIES_GOLISOPOD, SPECIES_LUDICOLO},
    },
    [CLASS_CAMPER] = {
        [0] = {SPECIES_SQUAWKABILLY_WHITE, SPECIES_SILICOBRA, SPECIES_ZIGZAGOON, SPECIES_CRUMBUG, SPECIES_GREAT_TUSK, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_MINCCINO, SPECIES_SHROODLE, SPECIES_SQUAWKABILLY, SPECIES_SQUAWKABILLY_BLUE},
        [1] = {SPECIES_MAUSHOLD_FOUR, SPECIES_SENTRET, SPECIES_SHROODLE, SPECIES_SQUAWKABILLY, SPECIES_OINKOLOGNE_FEMALE, SPECIES_GREAT_TUSK, SPECIES_TOEDSCRUEL, SPECIES_CRUMBUG_A, SPECIES_SQUAWKABILLY_WHITE, SPECIES_FARIGIRAF},
        ...
        [3] = {SPECIES_WATCHOG, SPECIES_CHATOT, SPECIES_PYROCLASTICSLOOCH, SPECIES_KROKOROK, SPECIES_GOOLIX, SPECIES_HIPPOPOTAS, SPECIES_HERMITCRAWMAD, SPECIES_HIPPOPOTAS_F, SPECIES_LOUDRED, SPECIES_SCORCHCAKE},
        [4] = {SPECIES_DRILBUR, SPECIES_KROKOROK, SPECIES_VIGOROTH, SPECIES_CASTFORM, SPECIES_EEVEE, SPECIES_QUAGSIRE, SPECIES_CUBONE, SPECIES_GABITE, SPECIES_SCORCHCAKE, SPECIES_SANDYGAST},
        [5] = {SPECIES_WATCHOG, SPECIES_EEVEE_GIGA, SPECIES_SMEARGLE, SPECIES_LOUDRED, SPECIES_DELCATTY, SPECIES_TRUMBEAK, SPECIES_BARBOACH, SPECIES_BIBAREL, SPECIES_MOCKIWI, SPECIES_QUAGSIRE},
        [6] = {SPECIES_INDEEDEE, SPECIES_SANDACONDA, SPECIES_FURFROU_DEBUTANTE, SPECIES_CAMERUPT_MEGA, SPECIES_SAWSBUCK_WINTER, SPECIES_FROSTYBULBORB_MEGA, SPECIES_RHYDON, SPECIES_LOPUNNY, SPECIES_FURFROU_DANDY, SPECIES_SAWSBUCK},
        [7] = {SPECIES_FEMALESHEARGRUB, SPECIES_PORYGON_Z, SPECIES_SWELLOW, SPECIES_SAWSBUCK, SPECIES_FURFROU_DEBUTANTE, SPECIES_AUDINO_MEGA, SPECIES_OBSTAGOON, SPECIES_GLISCOR, SPECIES_FURFROU_DIAMOND, SPECIES_SPUTTLEFISH},
    ...
    [CLASS_PICNICKER] = {
        ...
        [3] = {SPECIES_SKIPLOOM, SPECIES_SPOTTYBULBEAR_POP_STAR, SPECIES_MAWILE_MEGA, SPECIES_GOOLIX, SPECIES_RIBOMBEE, SPECIES_NUZLEAF, SPECIES_SILVALLY_FAIRY, SPECIES_PANSAGE, SPECIES_CARBINK, SPECIES_HORNEDCANNONBEETLE},
        [4] = {SPECIES_FLOETTE_BLUE, SPECIES_SUNFLORA, SPECIES_HORNEDCANNONBEETLE, SPECIES_STEENEE, SPECIES_ROTOM_MOW, SPECIES_QUEENSHEARWIG, SPECIES_MR_MIME, SPECIES_BOGSWALLOW_H, SPECIES_LOMBRE, SPECIES_FOMANTIS},
        [5] = {SPECIES_MAWILE, SPECIES_GLOOM, SPECIES_MORELULL, SPECIES_SWADLOON, SPECIES_MORGREM, SPECIES_DARTRIX, SPECIES_LILLIGANT_H, SPECIES_BOGSWALLOW_H, SPECIES_FOMANTIS, SPECIES_SKIPLOOM},
        [6] = {SPECIES_SAWSBUCK_SUMMER, SPECIES_AMOONGUSS, SPECIES_TAPU_FINI, SPECIES_SCEPTILE_MEGA, SPECIES_FLAPPLE, SPECIES_GOGOAT, SPECIES_ARMOREDCANNONLARVA, SPECIES_SLURPUFF, SPECIES_ZACIAN, SPECIES_ALCREMIE_CLOVER},
    ...
    [CLASS_POKEMANIAC] = {
        ...
        [3] = {SPECIES_GABITE, SPECIES_AMAURA, SPECIES_NOSEPASS, SPECIES_VIBRAVA, SPECIES_ZWEILOUS, SPECIES_PUCKERINGBLINNOW_A, SPECIES_JANGMO_O, SPECIES_BAGON, SPECIES_KABUTO, SPECIES_CARKOL},
        [4] = {SPECIES_SILVALLY_DRAGON, SPECIES_VEHEAMOTHPHOSBAT, SPECIES_MINIOR_BLUE, SPECIES_AMAURA, SPECIES_LILEEP, SPECIES_CARKOL, SPECIES_PUCKERINGBLINNOW, SPECIES_BAGON, SPECIES_ONIX, SPECIES_ARCHEN},
        [5] = {SPECIES_VIBRAVA, SPECIES_PUCKERINGBLINNOW_A, SPECIES_FRAXURE, SPECIES_ARCHEN, SPECIES_RHYHORN, SPECIES_CARBINK, SPECIES_KABUTO, SPECIES_MINIOR_SHIELD, SPECIES_PUPITAR, SPECIES_CRANIDOS},
        ...
        [9] = {SPECIES_STONJOURNER, SPECIES_TITANBLOWHOG_MEGA_X, SPECIES_ADULTBULBMIN_H, SPECIES_ARCEUS_ROCK, SPECIES_ALTARIA_MEGA, SPECIES_DRAGAPULT, SPECIES_TURTONATOR, SPECIES_KYUREM, SPECIES_DREDNAW_GIGA, SPECIES_EXEGGUTOR_A},
    },
    [CLASS_SUPER_NERD] = {
        [0] = {SPECIES_WATTREL, SPECIES_TYNAMO, SPECIES_TINKATUFF, SPECIES_FERROSEED, SPECIES_PICHU, SPECIES_DWARFBULBORB_G, SPECIES_REVAVROOM, SPECIES_MIRAIDON, SPECIES_IRON_THORNS, SPECIES_PAWMOT},
        ...
        [3] = {SPECIES_MAGEARNA_P, SPECIES_SPOTTYBULBEAR_FLYING, SPECIES_SPOTTYBULBEAR_CAP_ORIGINAL, SPECIES_ROTOM_FAN, SPECIES_SPOTTYBULBEAR_CAP_ALOLA, SPECIES_SPOTTYBULBEAR_POP_STAR, SPECIES_PLUSLE, SPECIES_ROTOM_HEAT, SPECIES_PUFFMIN_H, SPECIES_ELECTRIKE},
        [4] = {SPECIES_SILVALLY_ELECTRIC, SPECIES_MAWILE, SPECIES_BRONZOR, SPECIES_HERMITCRAWMAD_A, SPECIES_MINUN, SPECIES_SPOTTYBULBEAR_SURFING, SPECIES_SPOTTYBULBEAR_FLYING, SPECIES_SPOTTYBULBEAR_GIGA, SPECIES_SPOTTYBULBEAR, SPECIES_SPOTTYBULBEAR_POP_STAR},
        [5] = {SPECIES_SPOTTYBULBEAR_POP_STAR, SPECIES_SPOTTYBULBEAR_PHD, SPECIES_FLAAFFY, SPECIES_SPOTTYBULBEAR_CAP_ALOLA, SPECIES_SILVALLY_STEEL, SPECIES_ROTOM, SPECIES_TOGEDEMARU, SPECIES_SPOTTYBULBEAR_LIBRE, SPECIES_SPOTTYBULBEAR, SPECIES_HERMITCRAWMAD_A},
        ...
        [7] = {SPECIES_TOXTRICITY_LOW_KEY_GIGA, SPECIES_BUGEYEDCRAWMAD_A, SPECIES_MANECTRIC, SPECIES_AGGRON_MEGA, SPECIES_ZAMAZENTA_CROWNED, SPECIES_ARCTOZOLT, SPECIES_ZAPDOS, SPECIES_JOLTEON, SPECIES_PUFFMIN, SPECIES_LANTURN},
    ...
    [CLASS_HIKER] = {
        ...
        [3] = {SPECIES_VEHEAMOTHPHOSBAT, SPECIES_CARKOL, SPECIES_KROKOROK, SPECIES_TRAPINCH, SPECIES_PHANPY, SPECIES_BOLDORE, SPECIES_ANORITH, SPECIES_DIGGERSBY, SPECIES_PUPITAR, SPECIES_CORSOLA},
        [4] = {SPECIES_CUBONE, SPECIES_GLIGAR, SPECIES_MINIOR_BLUE, SPECIES_MINIOR_INDIGO, SPECIES_PUCKERINGBLINNOW, SPECIES_VEHEAMOTHPHOSBAT_A, SPECIES_ROGGENROLA, SPECIES_BULBMIN_H, SPECIES_MINIOR_SHIELD, SPECIES_KROKOROK},
        [5] = {SPECIES_HERMITCRAWMAD_A, SPECIES_LILEEP, SPECIES_SWINUB, SPECIES_LYCANROC_N, SPECIES_ARON, SPECIES_MINIOR_INDIGO, SPECIES_MINIOR_GREEN, SPECIES_CUBONE_A, SPECIES_MINIOR_VIOLET, SPECIES_WORMADAM_SANDY},
        [6] = {SPECIES_CRUSTLE, SPECIES_TORTERRA, SPECIES_LAIRON, SPECIES_KABUTOPS, SPECIES_BUGEYEDCRAWMAD, SPECIES_MAGCARGO, SPECIES_AERODACTYL, SPECIES_CARRACOSTA, SPECIES_AERODACTYL_MEGA, SPECIES_STEELIX},
        [7] = {SPECIES_COALOSSAL, SPECIES_BUGEYEDCRAWMAD, SPECIES_LUNATONE, SPECIES_DIANCIE, SPECIES_LAIRON, SPECIES_WHISCASH, SPECIES_MUDSDALE, SPECIES_TYRANITAR_MEGA, SPECIES_COALOSSAL_GIGA, SPECIES_AERODACTYL_MEGA},
        [8] = {SPECIES_STAKATAKA, SPECIES_PROBOPASS, SPECIES_TERRAKION, SPECIES_LAIRON, SPECIES_BUGEYEDCRAWMAD_A, SPECIES_REGIROCK, SPECIES_TYRANTRUM, SPECIES_KLEAVOR, SPECIES_SANDACONDA, SPECIES_ZYGARDE_10},
    ...
    [CLASS_BIKER] = {
        [0] = {SPECIES_LOKIX, SPECIES_DEINO, SPECIES_WO_CHIEN, SPECIES_MASCHIFF, SPECIES_SWARMINGSHEARGRUB, SPECIES_SPINARAK, SPECIES_TING_LU, SPECIES_SHROODLE, SPECIES_IRON_JUGULIS, SPECIES_PURRLOIN},
        [1] = {SPECIES_TRUBBISH, SPECIES_VAROOM, SPECIES_PURRLOIN, SPECIES_EKANS, SPECIES_BURROWINGSNAGRET, SPECIES_LOKIX, SPECIES_DWARFBULBORB_A, SPECIES_IRON_JUGULIS, SPECIES_BRUTE_BONNET, SPECIES_MABOSSTIFF},
        [2] = {SPECIES_GRAFAIAI, SPECIES_BUDEW, SPECIES_WO_CHIEN, SPECIES_SKRELP, SPECIES_SWARMINGSHEARGRUB, SPECIES_INKAY, SPECIES_TOXEL, SPECIES_BRUTE_BONNET, SPECIES_MABOSSTIFF, SPECIES_TING_LU},
        [3] = {SPECIES_GASTLY, SPECIES_CREEPINGCHRYSANTHEMUM, SPECIES_LINOONE_G, SPECIES_WHIRLIPEDE, SPECIES_DWARFORANGEBULBORB_A, SPECIES_PILEATEDSNAGRET, SPECIES_ZWEILOUS, SPECIES_HAUNTER, SPECIES_TOXSTOOL, SPECIES_SILVALLY_DARK},
        [4] = {SPECIES_GLOOM, SPECIES_LIEPARD, SPECIES_STARTLESPORE, SPECIES_DWARFBULBEAR, SPECIES_NUZLEAF, SPECIES_SCRAGGY, SPECIES_DWARFORANGEBULBORB_A, SPECIES_SABLEYE, SPECIES_SKORUPI, SPECIES_MIGHTYENA},
        [5] = {SPECIES_TOXSTOOL, SPECIES_GLOOM, SPECIES_CARVANHA, SPECIES_BREADBUG_A, SPECIES_SNEASEL_H, SPECIES_STUNKY, SPECIES_GULPIN, SPECIES_HAUNTER, SPECIES_HOUNDOUR, SPECIES_WHIRLIPEDE},
        [6] = {SPECIES_TOXTRICITY_LOW_KEY, SPECIES_GENGAR_GIGA, SPECIES_GRIMMSNARL_GIGA, SPECIES_INCINEROAR, SPECIES_TOXTRICITY_LOW_KEY_GIGA, SPECIES_ASHGRENINJA, SPECIES_UMBREON, SPECIES_TYRANITAR_MEGA, SPECIES_SWALOT, SPECIES_SNOWYBLOWHOG},
        [7] = {SPECIES_SNOWYBLOWHOG_A, SPECIES_HOOPA_UNBOUND, SPECIES_THIEVUL, SPECIES_CRAWDAUNT, SPECIES_MALAMAR, SPECIES_HYDREIGON, SPECIES_DRAGALGE, SPECIES_ZOROARK, SPECIES_SLOWKING_G, SPECIES_ZARUDE_DADA},
        [8] = {SPECIES_TOXTRICITY_GIGA, SPECIES_GARBODOR, SPECIES_SNOWYBLOWHOG_A, SPECIES_THIEVUL, SPECIES_ARCEUS_DARK, SPECIES_INCINEROAR, SPECIES_ARMOREDCANNONLARVA, SPECIES_SEVIPER, SPECIES_MORPEKO, SPECIES_DIRIGIBUG},
        [9] = {SPECIES_TYRANITAR, SPECIES_ZARUDE, SPECIES_WEEZING, SPECIES_HONCHKROW, SPECIES_TOXTRICITY, SPECIES_URSHIFU_SINGLE_GIGA, SPECIES_DIRIGIBUG, SPECIES_DUSTOX, SPECIES_SNOWYBLOWHOG_A, SPECIES_ZOROARK},
    },
    [CLASS_BURGLAR] = {
        [0] = {SPECIES_FUECOCO, SPECIES_ARMAROUGE, SPECIES_CHIEN_PAO, SPECIES_TAUROS_BLAZE_P, SPECIES_DWARFBULBORB_A, SPECIES_SCORBUNNY, SPECIES_TING_LU, SPECIES_CROCALOR, SPECIES_IMPIDIMP, SPECIES_BOMBIRDIER},
        [1] = {SPECIES_CYNDAQUIL, SPECIES_CHIMCHAR, SPECIES_CRUMBUG_A, SPECIES_CHARCADET, SPECIES_MABOSSTIFF, SPECIES_SKELEDIRGE, SPECIES_CROCALOR, SPECIES_WO_CHIEN, SPECIES_SIZZLIPEDE, SPECIES_DWARFBULBORB_A},
        [2] = {SPECIES_DWARFBULBORB_A, SPECIES_LOKIX, SPECIES_TEPIG, SPECIES_CYNDAQUIL, SPECIES_BOMBIRDIER, SPECIES_CHI_YU, SPECIES_MEOWSCARADA, SPECIES_LITTEN, SPECIES_TORCHIC, SPECIES_IMPIDIMP},
        [3] = {SPECIES_TORRACAT, SPECIES_SILVALLY_FIRE, SPECIES_PANSEAR, SPECIES_BREADBUG_A, SPECIES_NUMEL, SPECIES_COMBUSKEN, SPECIES_NUZLEAF, SPECIES_HOUNDOUR, SPECIES_BULBMIN, SPECIES_SNEASEL},
        [4] = {SPECIES_BREADBUG_A, SPECIES_DWARFORANGEBULBORB_A, SPECIES_GRIMER_A, SPECIES_BULBMIN, SPECIES_PIGNITE, SPECIES_SABLEYE_MEGA, SPECIES_SABLEYE, SPECIES_SLUGMA, SPECIES_MIGHTYENA, SPECIES_QWILFISH_H},
        [5] = {SPECIES_DWARFORANGEBULBORB_A, SPECIES_SABLEYE_MEGA, SPECIES_BULBMIN, SPECIES_SCRAGGY, SPECIES_MURKROW, SPECIES_OVERQWIL, SPECIES_BULBMIN_H, SPECIES_HOUNDOUR, SPECIES_COMBUSKEN, SPECIES_MAGBY},
        [6] = {SPECIES_KROOKODILE, SPECIES_HONCHKROW, SPECIES_GUZZLORD, SPECIES_LUXRAY, SPECIES_BLAZIKEN_MEGA, SPECIES_TURTONATOR, SPECIES_MAGMORTAR, SPECIES_GRENINJA, SPECIES_SNOWYBLOWHOG_A, SPECIES_FLAREON},
        [7] = {SPECIES_ORICORIO, SPECIES_INFERNAPE, SPECIES_TYPHLOSION_H, SPECIES_DARMANITAN, SPECIES_TITANBLOWHOG_GIGA, SPECIES_ZOROARK, SPECIES_DARMANITAN_G_ZEN, SPECIES_HO_OH, SPECIES_TALONFLAME, SPECIES_TITANBLOWHOG_MEGA_X},
        ...
        [9] = {SPECIES_ENTEI, SPECIES_CAMERUPT, SPECIES_MAGMORTAR, SPECIES_MAGMAR, SPECIES_SHARPEDO_MEGA, SPECIES_ZARUDE_DADA, SPECIES_WEAVILE, SPECIES_GRENINJA, SPECIES_TITANBLOWHOG_GIGA, SPECIES_SAMUROTT_H},
    },
    [CLASS_ENGINEER] = {
        ...
        [3] = {SPECIES_FLAAFFY, SPECIES_TOGEDEMARU, SPECIES_HONEYWISP_A, SPECIES_SPOTTYBULBEAR_COSPLAY, SPECIES_FORRETRESS, SPECIES_SILVALLY_STEEL, SPECIES_MAGEARNA_P, SPECIES_CHARJABUG, SPECIES_PLUSLE, SPECIES_DANDELFLY_A},
        [4] = {SPECIES_SPOTTYBULBEAR, SPECIES_ELECTRIKE, SPECIES_PUFFYFIERYBLOWHOG, SPECIES_HERMITCRAWMAD_A, SPECIES_MAGEARNA_P, SPECIES_CHINCHOU, SPECIES_ROTOM, SPECIES_ROTOM_MOW, SPECIES_HONEYWISP, SPECIES_ELEKID},
        [5] = {SPECIES_SPOTTYBULBEAR_BELLE, SPECIES_CHARJABUG, SPECIES_PUFFYFIERYBLOWHOG, SPECIES_BOGSWALLOW_H, SPECIES_SPOTTYBULBEAR_CAP_KALOS, SPECIES_SPOTTYBULBEAR_POP_STAR, SPECIES_HONEYWISP, SPECIES_MAWILE_MEGA, SPECIES_SPOTTYBULBEAR, SPECIES_SPOTTYBULBEAR_CAP_UNOVA},
        ...
        [9] = {SPECIES_CORVIKNIGHT_GIGA, SPECIES_REGISTEEL, SPECIES_BASTIODON, SPECIES_ZEBSTRIKA, SPECIES_HEATRAN, SPECIES_BISHARP, SPECIES_METAGROSS_MEGA, SPECIES_BUGEYEDCRAWMAD_A, SPECIES_SOLGALEO, SPECIES_MORPEKO},
    },
    [CLASS_FISHERMAN] = {
        ...
        [1] = {SPECIES_SHELLOS_EAST, SPECIES_SURSKIT, SPECIES_FRILLISH, SPECIES_QUAQUAVAL, SPECIES_WUGTRIO, SPECIES_DONDOZO, SPECIES_OGERPON_WELLSPRING_MASK, SPECIES_WIMPOD, SPECIES_PIPLUP, SPECIES_PELLETPOSY},
        ...
        [3] = {SPECIES_SILVALLY_WATER, SPECIES_BASCULEGION_F, SPECIES_BUIZEL, SPECIES_LUVDISC, SPECIES_YELLOWWOLLYHOP, SPECIES_FINNEON, SPECIES_BARBOACH, SPECIES_BRIONNE, SPECIES_SPHEAL, SPECIES_BASCULIN_BLUE},
        [4] = {SPECIES_SHELLOS, SPECIES_MAREANIE, SPECIES_PANPOUR, SPECIES_ARAQUANID, SPECIES_PALPITOAD, SPECIES_OMANYTE, SPECIES_DEWOTT, SPECIES_BLIZZARDINGBLOWHOG, SPECIES_BASCULEGION_M, SPECIES_SCORNET},
        ...
        [6] = {SPECIES_BARRASKEWDA, SPECIES_SHARPEDO, SPECIES_DRACOVISH, SPECIES_PHOSBAT, SPECIES_INTELEON, SPECIES_PALKIA_ORIGIN, SPECIES_GRENINJA, SPECIES_KABUTOPS, SPECIES_SNOWFLAKEFLUTTERTAIL, SPECIES_BEARDEDAMPRAT},
        [7] = {SPECIES_CRAWDAUNT, SPECIES_ASHGRENINJA, SPECIES_GOLISOPOD, SPECIES_DEWGONG, SPECIES_KYOGRE, SPECIES_OATCHI_GIGA, SPECIES_FERALIGATR, SPECIES_KELDEO_RESOLUTE, SPECIES_PHOSBAT, SPECIES_TAPU_FINI},
        [8] = {SPECIES_GASTRODON, SPECIES_GOREBYSS, SPECIES_KYOGRE, SPECIES_DRACOVISH, SPECIES_KELDEO_RESOLUTE, SPECIES_ARCTOVISH, SPECIES_EMPOLEON, SPECIES_BRUXISH, SPECIES_RAGINGLONGLEGS, SPECIES_TOXAPEX},
        [9] = {SPECIES_CRAWDAUNT, SPECIES_INTELEON_GIGA, SPECIES_WALREIN, SPECIES_SWAMPERT, SPECIES_RAGINGLONGLEGS, SPECIES_OATCHI_GIGA, SPECIES_DRACOVISH, SPECIES_MILOTIC, SPECIES_PALKIA_ORIGIN, SPECIES_RELICANTH},
    },
    [CLASS_SWIMMER_M] = {
        ...
        [3] = {SPECIES_CLAWITZER, SPECIES_BIBAREL, SPECIES_DEWOTT, SPECIES_QUAGSIRE, SPECIES_OMANYTE, SPECIES_SILVALLY_WATER, SPECIES_GREATERSPOTTEDJELLYFLOAT, SPECIES_MARSHTOMP, SPECIES_PANPOUR, SPECIES_CHINCHOU},
        ...
        [5] = {SPECIES_CLAWITZER, SPECIES_POLIWHIRL, SPECIES_CARVANHA, SPECIES_SEALEO, SPECIES_CROCONAW, SPECIES_BASCULIN_BLUE, SPECIES_SHELLOS, SPECIES_HORSEA, SPECIES_FROGADIER, SPECIES_PYUKUSNOWYBLOWHOGU},
        [6] = {SPECIES_TAPU_FINI, SPECIES_SHARPEDO, SPECIES_PHOSBAT, SPECIES_CLOYSTER, SPECIES_CRAWDAUNT, SPECIES_BARRASKEWDA, SPECIES_OATCHI_GIGA, SPECIES_WHISCASH, SPECIES_MASTERHOP, SPECIES_SAMUROTT_H},
        [7] = {SPECIES_MASTERHOP_GIGA, SPECIES_SUICUNE, SPECIES_OMASTAR, SPECIES_MASTERONION_MEGA, SPECIES_SIMIPOUR, SPECIES_WAILORD, SPECIES_POLITOED, SPECIES_TOXAPEX, SPECIES_SWANNA, SPECIES_GOREBYSS},
        [8] = {SPECIES_KINGDRA, SPECIES_PALKIA, SPECIES_PHOSBAT, SPECIES_ARCTOVISH, SPECIES_URSHIFU_RAPID_GIGA, SPECIES_INTELEON, SPECIES_BRUXISH, SPECIES_SWANNA, SPECIES_SUICUNE, SPECIES_EMPOLEON},
        [9] = {SPECIES_POLITOED, SPECIES_SNOWFLAKEFLUTTERTAIL, SPECIES_MASTERHOP, SPECIES_SLOWKING, SPECIES_JELLICENT, SPECIES_KYOGRE_PRIMAL, SPECIES_PHOSBAT, SPECIES_FLOATZEL, SPECIES_DREDNAW, SPECIES_SHARPEDO_MEGA},
    },
    [CLASS_CUE_BALL] = {
        [0] = {SPECIES_SNOWBULBORB, SPECIES_HELIOPTILE, SPECIES_GIANTBREADBUG, SPECIES_ZORUA_H, SPECIES_AZURILL, SPECIES_ZIGZAGOON_G, SPECIES_WHISMUR, SPECIES_ARBOLIVA, SPECIES_TANDEMAUS, SPECIES_DWARFBULBORB},
        ...
        [2] = {SPECIES_HOOTHOOT, SPECIES_TAILLOW, SPECIES_SNOWBULBORB, SPECIES_STARLY, SPECIES_WHISMUR, SPECIES_FLETCHLING, SPECIES_SQUAWKABILLY_YELLOW, SPECIES_LECHONK, SPECIES_TERAPAGOS_TERASTAL, SPECIES_BUNNELBY},
        [3] = {SPECIES_RUFFLET, SPECIES_GUMSHOOS, SPECIES_FOOLIX, SPECIES_BREADBUG_A, SPECIES_SMEARGLE, SPECIES_TRANQUILL, SPECIES_TRUMBEAK, SPECIES_TEDDIURSA, SPECIES_MOCKIWI, SPECIES_SWABLU},
        [4] = {SPECIES_DIGGERSBY, SPECIES_BIBAREL, SPECIES_MOCKIWI, SPECIES_FOOLIX, SPECIES_RUFFLET, SPECIES_GLAMEOW, SPECIES_LINOONE, SPECIES_PYROCLASTICSLOOCH, SPECIES_EEVEE, SPECIES_GIRAFARIG},
        ...
        [9] = {SPECIES_BEWEAR, SPECIES_TAUROS, SPECIES_ZANGOOSE, SPECIES_INDEEDEE_FEMALE, SPECIES_FROSTYBULBORB, SPECIES_HAPPINY, SPECIES_MELOETTA, SPECIES_BLISSEY, SPECIES_CINCCINO, SPECIES_LOPUNNY},
    },
    [CLASS_GAMER] = {
        [0] = {SPECIES_BUNNELBY, SPECIES_SQUAWKABILLY, SPECIES_DOLLIV, SPECIES_TERAPAGOS_STELLAR, SPECIES_DEERLING, SPECIES_DWARFBULBORB, SPECIES_STARLY, SPECIES_TAILLOW, SPECIES_WHISMUR, SPECIES_TANDEMAUS},
        [1] = {SPECIES_MINCCINO, SPECIES_OINKOLOGNE_FEMALE, SPECIES_SQUAWKABILLY_WHITE, SPECIES_BUNNELBY, SPECIES_HOOTHOOT, SPECIES_SNOWBULBORB, SPECIES_TERAPAGOS, SPECIES_TAILLOW, SPECIES_SKITTY, SPECIES_SKWOVET},
        [2] = {SPECIES_PATRAT, SPECIES_TERAPAGOS, SPECIES_MAUSHOLD, SPECIES_IGGLYBUFF, SPECIES_LILLIPUP, SPECIES_SHROODLE, SPECIES_FLETCHLING, SPECIES_EGG, SPECIES_CRUMBUG_A, SPECIES_DUDUNSPARCE},
        [3] = {SPECIES_SPINDA, SPECIES_MUNCHLAX, SPECIES_DIGGERSBY, SPECIES_GOOLIX, SPECIES_TRUMBEAK, SPECIES_GIRAFARIG, SPECIES_WATCHOG, SPECIES_CHATOT, SPECIES_TRANQUILL, SPECIES_LINOONE},
        ...
        [5] = {SPECIES_WOOLOO, SPECIES_PYROCLASTICSLOOCH, SPECIES_CHATOT, SPECIES_SMEARGLE, SPECIES_LINOONE_G, SPECIES_TYPE_NULL, SPECIES_CASTFORM, SPECIES_STUFFUL, SPECIES_EEVEE_GIGA, SPECIES_MUNCHLAX},
        [6] = {SPECIES_INDEEDEE, SPECIES_KANGASKHAN, SPECIES_MILTANK, SPECIES_SILVALLY, SPECIES_LOPUNNY, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_UNFEZANT_F, SPECIES_SNORLAX_GIGA, SPECIES_URSARING, SPECIES_FURFROU_KABUKI},
        [7] = {SPECIES_FURFROU_STAR, SPECIES_FURFROU_DEBUTANTE, SPECIES_BOUFFALANT, SPECIES_DUBWOOL, SPECIES_FROSTYBULBORB_MEGA, SPECIES_SLAKING, SPECIES_PYROAR, SPECIES_FURFROU_MATRON, SPECIES_URSARING, SPECIES_AMBIPOM},
        [8] = {SPECIES_SAWSBUCK, SPECIES_TAUROS, SPECIES_URSALUNA, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_URSARING, SPECIES_FROSTYBULBORB_MEGA, SPECIES_MILTANK, SPECIES_MELOETTA, SPECIES_ZANGOOSE, SPECIES_UNFEZANT_F},
    ...
    [CLASS_BEAUTY] = {
        ...
        [1] = {SPECIES_SENTRET, SPECIES_LECHONK, SPECIES_FLABEBE_WHITE, SPECIES_URSALUNA_BLOODMOON, SPECIES_IGGLYBUFF, SPECIES_SPRITZEE, SPECIES_DUDUNSPARCE_THREE, SPECIES_MAUSHOLD_FOUR, SPECIES_SNOWBULBORB, SPECIES_FLETCHLING},
        ...
        [3] = {SPECIES_MORELULL, SPECIES_SMEARGLE, SPECIES_CHATOT, SPECIES_TEDDIURSA, SPECIES_BREADBUG_A, SPECIES_MAGEARNA_P, SPECIES_MAWILE, SPECIES_CARBINK, SPECIES_TOGETIC, SPECIES_KIRLIA},
        [4] = {SPECIES_CARBINK, SPECIES_GLAMEOW, SPECIES_LITLEO, SPECIES_SPINDA, SPECIES_MR_MIME, SPECIES_FOOLIX, SPECIES_FLOETTE, SPECIES_SLAKOTH, SPECIES_STUFFUL, SPECIES_BREADBUG},
        [5] = {SPECIES_LITLEO, SPECIES_TEDDIURSA, SPECIES_GOOLIX, SPECIES_VIGOROTH, SPECIES_WATCHOG, SPECIES_STUFFUL, SPECIES_TOGETIC, SPECIES_TRANQUILL, SPECIES_TYPE_NULL, SPECIES_MORGREM},
        ...
        [8] = {SPECIES_ALTARIA_MEGA, SPECIES_DEDENNE, SPECIES_FROSTYBULBORB, SPECIES_WEEZING_G, SPECIES_SAWSBUCK, SPECIES_FURFROU_DANDY, SPECIES_SAWSBUCK_SUMMER, SPECIES_FLORGES_BLUE, SPECIES_URSALUNA, SPECIES_HATTERENE},
        [9] = {SPECIES_TOGEKISS, SPECIES_FURFROU_LA_REINE, SPECIES_FURFROU_HEART, SPECIES_FROSTYBULBORB, SPECIES_MELOETTA_PIROUETTE, SPECIES_COMFEY, SPECIES_CINCCINO, SPECIES_SAWSBUCK_SUMMER, SPECIES_ALCREMIE_GIGA, SPECIES_BLISSEY},
    },
    [CLASS_SWIMMER_F] = {
        [0] = {SPECIES_PALAFIN_HERO, SPECIES_QUAQUAVAL, SPECIES_SURSKIT, SPECIES_TATSUGIRI_RED, SPECIES_PIPLUP, SPECIES_VELUZA, SPECIES_WOLPOLE, SPECIES_TATSUGIRI_YELLOW, SPECIES_DONDOZO, SPECIES_WALKING_WAKE},
        ...
        [3] = {SPECIES_CORSOLA, SPECIES_SCORNET, SPECIES_GREATERSPOTTEDJELLYFLOAT, SPECIES_SLOWPOKE, SPECIES_QWILFISH, SPECIES_PRINPLUP, SPECIES_POLIWHIRL, SPECIES_BASCULEGION_F, SPECIES_BARBOACH, SPECIES_QUAGSIRE},
        ...
        [7] = {SPECIES_KYOGRE_PRIMAL, SPECIES_SIMIPOUR, SPECIES_KINGDRA, SPECIES_PHOSBAT, SPECIES_PRIMARINA, SPECIES_SHARPEDO_MEGA, SPECIES_TAPU_FINI, SPECIES_CRAMORANT_GULPING, SPECIES_VAPOREON, SPECIES_MASTERONION_MEGA},
        [8] = {SPECIES_TAPU_FINI, SPECIES_BARRASKEWDA, SPECIES_SIMIPOUR, SPECIES_ASHGRENINJA, SPECIES_SEISMITOAD, SPECIES_MASTERHOP, SPECIES_SNOWFLAKEFLUTTERTAIL, SPECIES_FERALIGATR, SPECIES_TOXAPEX, SPECIES_AZUMARILL},
    ...
    [CLASS_PSYCHIC] = {
        ...
        [3] = {SPECIES_GOTHORITA, SPECIES_SPOTTYBULBEAR_PHD, SPECIES_MUNNA, SPECIES_SWOOBAT, SPECIES_MR_MIME, SPECIES_ABRA, SPECIES_DOTTLER, SPECIES_SPOINK, SPECIES_HONEYWISP_A, SPECIES_SLOWPOKE_G},
        [4] = {SPECIES_CHIMECHO, SPECIES_COSMOEM, SPECIES_SMOOCHUM, SPECIES_BRONZOR, SPECIES_SPOTTYBULBEAR_PHD, SPECIES_DUOSION, SPECIES_NATU, SPECIES_WOOBAT, SPECIES_HATTREM, SPECIES_BEADYLONGLEGS},
        [5] = {SPECIES_DUOSION, SPECIES_ESPURR, SPECIES_SPOTTYBULBEAR_PHD, SPECIES_MEDITITE, SPECIES_GIRAFARIG, SPECIES_WOLLYHOP, SPECIES_ABRA, SPECIES_KADABRA, SPECIES_BELDUM, SPECIES_COSMOEM},
        [6] = {SPECIES_SLOWKING_G, SPECIES_NECROZMA_DUSK_MANE, SPECIES_GRUMPIG, SPECIES_NOCTOWL, SPECIES_LUNALA, SPECIES_RAGINGLONGLEGS, SPECIES_XATU, SPECIES_LUGIA, SPECIES_SLOWKING, SPECIES_BEHEEYEM},
        ...
        [8] = {SPECIES_DEOXYS_ATTACK, SPECIES_MEWTWO_MEGA_Y, SPECIES_MUSHARNA, SPECIES_HATTERENE_GIGA, SPECIES_RAPIDASH_G, SPECIES_CRESSELIA, SPECIES_MEWTWO_MEGA_X, SPECIES_SOLROCK, SPECIES_GATTLINGGROINK, SPECIES_SOLGALEO},
    ...
    [CLASS_ROCKER] = {
        ...
        [3] = {SPECIES_LUXIO, SPECIES_SPOTTYBULBEAR_SURFING, SPECIES_ROTOM_FROST, SPECIES_SPOTTYBULBEAR_PHD, SPECIES_SPOTTYBULBEAR_ROCK_STAR, SPECIES_ROTOM_FAN, SPECIES_HONEYWISP_A, SPECIES_VEHEAMOTHPHOSBAT_A, SPECIES_BLITZLE, SPECIES_PLUSLE},
        [4] = {SPECIES_PUFFYFIERYBLOWHOG, SPECIES_ELECTRIKE, SPECIES_SPOTTYBULBEAR_CAP_SINNOH, SPECIES_VEHEAMOTHPHOSBAT_A, SPECIES_ROTOM_WASH, SPECIES_SPOTTYBULBEAR_CAP_ORIGINAL, SPECIES_SPOTTYBULBEAR_CAP_UNOVA, SPECIES_SPOTTYBULBEAR_LIBRE, SPECIES_BOGSWALLOW_H, SPECIES_ELEKID},
        [5] = {SPECIES_VEHEAMOTHPHOSBAT_A, SPECIES_SPOTTYBULBEAR_CAP_KALOS, SPECIES_SPOTTYBULBEAR_BELLE, SPECIES_SILVALLY_ELECTRIC, SPECIES_SPOTTYBULBEAR, SPECIES_PUCKERINGBLINNOW_A, SPECIES_SPOTTYBULBEAR_CAP_ORIGINAL, SPECIES_HONEYWISP_A, SPECIES_ROTOM_HEAT, SPECIES_SPOTTYBULBEAR_FLYING},
    ...
    [CLASS_JUGGLER] = {
        ...
        [4] = {SPECIES_MR_MIME_G, SPECIES_ESPURR, SPECIES_BEADYLONGLEGS, SPECIES_SILVALLY_GHOST, SPECIES_SABLEYE, SPECIES_CHIMECHO, SPECIES_DRIFLOON, SPECIES_RALTS, SPECIES_HATTREM, SPECIES_SHEDINJA},
        [5] = {SPECIES_CHIMECHO, SPECIES_GASTLY, SPECIES_KIRLIA, SPECIES_MISDREAVUS, SPECIES_MIME_JR_G, SPECIES_WOLLYHOP_A, SPECIES_GOTHORITA, SPECIES_DUOSION, SPECIES_SPOINK, SPECIES_SHEDINJA},
        [6] = {SPECIES_MELOETTA, SPECIES_NOCTOWL, SPECIES_CALYREX_SHADOW_RIDER, SPECIES_AEGISLASH, SPECIES_PROQUILLION, SPECIES_JELLICENT_F, SPECIES_GIRATINA, SPECIES_RUNERIGUS, SPECIES_INDEEDEE_FEMALE, SPECIES_BRONZONG},
        ...
        [8] = {SPECIES_HOOPA, SPECIES_CRESSELIA, SPECIES_DRAGAPULT, SPECIES_MALAMAR, SPECIES_MUSHARNA, SPECIES_TREVENANT, SPECIES_BLACEPHALON, SPECIES_ORANGURU, SPECIES_RAGINGLONGLEGS, SPECIES_GOURGEIST_L},
    ...
    [CLASS_TAMER] = {
        ...
        [3] = {SPECIES_PYROCLASTICSLOOCH, SPECIES_WATCHOG, SPECIES_TYPE_NULL, SPECIES_BREADBUG, SPECIES_STUFFUL, SPECIES_HAKAMO_O, SPECIES_DELCATTY, SPECIES_RUFFLET, SPECIES_AIPOM, SPECIES_BIBAREL},
        [4] = {SPECIES_GLAMEOW, SPECIES_DWARFORANGEBULBORB, SPECIES_CASTFORM, SPECIES_LINOONE, SPECIES_SILVALLY_DRAGON, SPECIES_SHELGON, SPECIES_KECLEON, SPECIES_SPINDA, SPECIES_DRAGONAIR, SPECIES_DRAKLOAK},
        [5] = {SPECIES_LOUDRED, SPECIES_BUNEARY, SPECIES_TYPE_NULL, SPECIES_SMEARGLE, SPECIES_BAGON, SPECIES_BREADBUG, SPECIES_SPINDA, SPECIES_GUMSHOOS, SPECIES_JANGMO_O, SPECIES_VIBRAVA},
    ...
    [CLASS_BIRD_KEEPER] = {
        [0] = {SPECIES_KILOWATTREL, SPECIES_WINGULL, SPECIES_FLAMIGO, SPECIES_NOIBAT, SPECIES_BOMBIRDIER, SPECIES_SQUAWKABILLY_WHITE, SPECIES_GIANTBREADBUG, SPECIES_SNOWBULBORB, SPECIES_TAILLOW, SPECIES_FLETCHLING},
        [1] = {SPECIES_ARCTICCANNONLARVA, SPECIES_FLETCHLING, SPECIES_WINGULL, SPECIES_KILOWATTREL, SPECIES_SQUAWKABILLY_YELLOW, SPECIES_SQUAWKABILLY, SPECIES_BOMBIRDIER, SPECIES_STARLY, SPECIES_TAILLOW, SPECIES_HOOTHOOT},
        [2] = {SPECIES_FLAMIGO, SPECIES_SNOWBULBORB, SPECIES_HOOTHOOT, SPECIES_ARCTICCANNONLARVA, SPECIES_ROWLET, SPECIES_DUCKLETT, SPECIES_PIKIPEK, SPECIES_WINGULL, SPECIES_NOIBAT, SPECIES_GIANTBREADBUG},
        [3] = {SPECIES_DRIFLOON, SPECIES_DWARFFROSTYBULBORB, SPECIES_MASQUERAIN, SPECIES_MINIOR_YELLOW, SPECIES_TRANQUILL, SPECIES_SPOTTYBULBEAR_FLYING, SPECIES_MINIOR_SHIELD, SPECIES_LEDIAN, SPECIES_NATU, SPECIES_FLETCHINDER},
        ...
        [5] = {SPECIES_CORVISQUIRE, SPECIES_DRIFLOON, SPECIES_GLIGAR, SPECIES_CHATOT, SPECIES_MINIOR_VIOLET, SPECIES_SWABLU, SPECIES_YANMA, SPECIES_SKIPLOOM, SPECIES_PYROCLASTICSLOOCH, SPECIES_TRUMBEAK},
        ...
        [7] = {SPECIES_FROSTYBULBORB, SPECIES_GLISCOR, SPECIES_VIVILLON_OCEAN, SPECIES_ALTARIA, SPECIES_LANDORUS, SPECIES_CRAMORANT_GULPING, SPECIES_SHAYMIN_SKY, SPECIES_MANDIBUZZ, SPECIES_ORICORIO_P, SPECIES_VIVILLON_SANDSTORM},
        ...
        [9] = {SPECIES_DRAGONITE, SPECIES_ORICORIO_S, SPECIES_SIGILYPH, SPECIES_CRAMORANT_GORGING, SPECIES_AERODACTYL, SPECIES_DRIFBLIM, SPECIES_VIVILLON_FANCY, SPECIES_MANTINE, SPECIES_VIVILLON_HIGH_PLAINS, SPECIES_GLINTBEETLE},
    },
    [CLASS_BLACK_BELT] = {
        ...
        [3] = {SPECIES_HITMONTOP, SPECIES_BALDYLONGLEGS, SPECIES_STUFFUL, SPECIES_SPOTTYBULBEAR_LIBRE, SPECIES_COMBUSKEN, SPECIES_MAKUHITA, SPECIES_FARFETCHD_G, SPECIES_LONGWATERDUMPLE, SPECIES_MONFERNO, SPECIES_HAKAMO_O},
        [4] = {SPECIES_PANCHAM, SPECIES_RIOLU, SPECIES_MONFERNO, SPECIES_LILLIGANT_H, SPECIES_MANATLEGS, SPECIES_SCRAGGY, SPECIES_HITMONTOP, SPECIES_PIGNITE, SPECIES_CRABRAWLER, SPECIES_COMBUSKEN},
        [5] = {SPECIES_MACHOKE, SPECIES_WATERDUMPLE, SPECIES_PIGNITE, SPECIES_FARFETCHD_G, SPECIES_MONFERNO, SPECIES_MEDITITE, SPECIES_SNEASEL_H, SPECIES_HAKAMO_O, SPECIES_GURDURR, SPECIES_LONGWATERDUMPLE},
        [6] = {SPECIES_ZAPDOS_G, SPECIES_MARSHADOW, SPECIES_BRELOOM, SPECIES_INFERNAPE, SPECIES_MEDICHAM, SPECIES_KELDEO_RESOLUTE, SPECIES_FALINKS, SPECIES_BURROWNIT, SPECIES_GRAPPLOCT, SPECIES_DECIDUEYE_H},
    ...
    [CLASS_CAPTAIN] = {
        ...
        [3] = {SPECIES_SPINDA, SPECIES_BIBAREL, SPECIES_GLAMEOW, SPECIES_PORYGON, SPECIES_RUFFLET, SPECIES_AIPOM, SPECIES_SMEARGLE, SPECIES_DWARFFROSTYBULBORB, SPECIES_SLAKOTH, SPECIES_EEVEE},
        [4] = {SPECIES_WOOLOO, SPECIES_BREADBUG_A, SPECIES_MOCKIWI, SPECIES_VIGOROTH, SPECIES_RUFFLET, SPECIES_KECLEON, SPECIES_HERDIER, SPECIES_GIRAFARIG, SPECIES_GUMSHOOS, SPECIES_DWARFFROSTYBULBORB},
    ...
    [CLASS_SCIENTIST] = {
        [0] = {SPECIES_GIANTBREADBUG, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_EGG, SPECIES_MINCCINO, SPECIES_TERAPAGOS_TERASTAL, SPECIES_PIDOVE, SPECIES_SNOWBULBORB, SPECIES_LECHONK, SPECIES_SENTRET, SPECIES_GRAFAIAI},
        [1] = {SPECIES_ZIGZAGOON_G, SPECIES_DWARFBULBORB_GIGA, SPECIES_DEERLING_AUTUMN, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_URSALUNA_BLOODMOON, SPECIES_SMOLIV, SPECIES_GIANTBREADBUG, SPECIES_TAILLOW, SPECIES_TANDEMAUS, SPECIES_PATRAT},
        [2] = {SPECIES_ZIGZAGOON, SPECIES_DEERLING_AUTUMN, SPECIES_AZURILL, SPECIES_TANDEMAUS, SPECIES_DEERLING_WINTER, SPECIES_LILLIPUP, SPECIES_DWARFBULBORB, SPECIES_WHISMUR, SPECIES_DWARFBULBORB_GIGA, SPECIES_CRUMBUG},
        [3] = {SPECIES_KECLEON, SPECIES_EEVEE, SPECIES_LITLEO, SPECIES_GUMSHOOS, SPECIES_GLAMEOW, SPECIES_SMEARGLE, SPECIES_GOOLIX, SPECIES_SLAKOTH, SPECIES_BREADBUG_A, SPECIES_LINOONE},
        [4] = {SPECIES_SMEARGLE, SPECIES_LOUDRED, SPECIES_BIBAREL, SPECIES_BUNEARY, SPECIES_GOOLIX, SPECIES_SLAKOTH, SPECIES_FOOLIX, SPECIES_FARFETCHD, SPECIES_FURRET, SPECIES_SWABLU},
        [5] = {SPECIES_SLAKOTH, SPECIES_LINOONE, SPECIES_SWABLU, SPECIES_DWARFFROSTYBULBORB, SPECIES_LINOONE_G, SPECIES_DWARFORANGEBULBORB, SPECIES_EEVEE, SPECIES_GOOLIX, SPECIES_EEVEE_GIGA, SPECIES_GLAMEOW},
        ...
        [7] = {SPECIES_LICKILICKY, SPECIES_URSARING, SPECIES_AUDINO_MEGA, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_FROSTYBULBORB, SPECIES_SWELLOW, SPECIES_FURFROU, SPECIES_SAWSBUCK_AUTUMN, SPECIES_GREEDENT, SPECIES_INDEEDEE},
        [8] = {SPECIES_FROSTYBULBORB, SPECIES_OBSTAGOON, SPECIES_FURFROU_DEBUTANTE, SPECIES_UNFEZANT_F, SPECIES_FROSTYBULBORB_MEGA, SPECIES_CHANSEY, SPECIES_BOUFFALANT, SPECIES_EXPLOUD, SPECIES_AUDINO, SPECIES_ZANGOOSE},
        [9] = {SPECIES_MILTANK, SPECIES_DUBWOOL, SPECIES_KOMALA, SPECIES_STARAPTOR, SPECIES_SNORLAX, SPECIES_EXPLOUD, SPECIES_PYROAR, SPECIES_AUDINO_MEGA, SPECIES_FROSTYBULBORB_MEGA, SPECIES_FURFROU_STAR},
    },
    [CLASS_BOSS] = {
        ...
        [1] = {SPECIES_ARBOLIVA, SPECIES_MAUSHOLD, SPECIES_DWARFBULBORB, SPECIES_DUDUNSPARCE_THREE, SPECIES_SKITTY, SPECIES_ZIGZAGOON_G, SPECIES_LILLIPUP, SPECIES_DOLLIV, SPECIES_TAILLOW, SPECIES_ZIGZAGOON},
        ...
        [3] = {SPECIES_TEDDIURSA, SPECIES_VIGOROTH, SPECIES_DELCATTY, SPECIES_BREADBUG_A, SPECIES_STUFFUL, SPECIES_LOUDRED, SPECIES_BIBAREL, SPECIES_DWARFORANGEBULBORB, SPECIES_DWARFFROSTYBULBORB, SPECIES_DIGGERSBY},
        [4] = {SPECIES_DWARFFROSTYBULBORB, SPECIES_KECLEON, SPECIES_LINOONE, SPECIES_FOOLIX, SPECIES_SLAKOTH, SPECIES_PORYGON, SPECIES_WATCHOG, SPECIES_EEVEE, SPECIES_DUNSPARCE, SPECIES_PYROCLASTICSLOOCH},
        [5] = {SPECIES_TEDDIURSA, SPECIES_GOOLIX, SPECIES_EEVEE, SPECIES_LINOONE_G, SPECIES_SLAKOTH, SPECIES_TRANQUILL, SPECIES_FARFETCHD, SPECIES_MOCKIWI, SPECIES_DIGGERSBY, SPECIES_DWARFORANGEBULBORB},
        ...
        [7] = {SPECIES_STARAPTOR, SPECIES_FROSTYBULBORB, SPECIES_FURFROU_PHAROAH, SPECIES_FURFROU, SPECIES_WYRDEER, SPECIES_BRAVIARY, SPECIES_PURUGLY, SPECIES_SAWSBUCK_AUTUMN, SPECIES_LOPUNNY, SPECIES_UNFEZANT_F},
    ...
    [CLASS_LEADER] = {
        [0] = {SPECIES_SQUAWKABILLY_WHITE, SPECIES_DEERLING_AUTUMN, SPECIES_ARBOLIVA, SPECIES_IGGLYBUFF, SPECIES_PIKIPEK, SPECIES_SKITTY, SPECIES_SQUAWKABILLY, SPECIES_SNOWBULBORB, SPECIES_GIANTBREADBUG, SPECIES_TANDEMAUS},
        ...
        [4] = {SPECIES_FOOLIX, SPECIES_PORYGON, SPECIES_KECLEON, SPECIES_STUFFUL, SPECIES_CHATOT, SPECIES_DWARFFROSTYBULBORB, SPECIES_SMEARGLE, SPECIES_LITLEO, SPECIES_GLAMEOW, SPECIES_EEVEE},
        [5] = {SPECIES_WATCHOG, SPECIES_CHATOT, SPECIES_FURRET, SPECIES_GLAMEOW, SPECIES_TYPE_NULL, SPECIES_BREADBUG, SPECIES_TEDDIURSA, SPECIES_LINOONE, SPECIES_AIPOM, SPECIES_LINOONE_G},
        ...
        [7] = {SPECIES_SAWSBUCK_AUTUMN, SPECIES_FROSTYBULBORB_MEGA, SPECIES_MELOETTA_PIROUETTE, SPECIES_UNFEZANT, SPECIES_FURFROU_LA_REINE, SPECIES_SNORLAX_GIGA, SPECIES_ORANGURU, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_OBSTAGOON, SPECIES_FURFROU_KABUKI},
        [8] = {SPECIES_SAWSBUCK_AUTUMN, SPECIES_BRAVIARY, SPECIES_WYRDEER, SPECIES_URSARING, SPECIES_TAUROS, SPECIES_ARCEUS, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_AMBIPOM, SPECIES_FURFROU_MATRON, SPECIES_SILVALLY},
    ...
    [CLASS_TEAM_ROCKET] = {
        [0] = {SPECIES_FLETCHLING, SPECIES_DWARFBULBORB, SPECIES_MAUSHOLD_FOUR, SPECIES_IGGLYBUFF, SPECIES_ZORUA_H, SPECIES_BIDOOF, SPECIES_DWARFBULBORB_GIGA, SPECIES_TERAPAGOS, SPECIES_TAILLOW, SPECIES_TANDEMAUS},
        ...
        [2] = {SPECIES_DWARFBULBORB_GIGA, SPECIES_IGGLYBUFF, SPECIES_PIKIPEK, SPECIES_WHISMUR, SPECIES_TERAPAGOS_STELLAR, SPECIES_TERAPAGOS, SPECIES_GIANTBREADBUG, SPECIES_LECHONK, SPECIES_GRAFAIAI, SPECIES_DOLLIV},
        [3] = {SPECIES_CASTFORM, SPECIES_TRANQUILL, SPECIES_HERDIER, SPECIES_TRUMBEAK, SPECIES_BREADBUG_A, SPECIES_RUFFLET, SPECIES_DWARFFROSTYBULBORB, SPECIES_GOOLIX, SPECIES_GLAMEOW, SPECIES_KECLEON},
        [4] = {SPECIES_RUFFLET, SPECIES_MOCKIWI, SPECIES_PORYGON, SPECIES_EEVEE_GIGA, SPECIES_MUNCHLAX, SPECIES_GLAMEOW, SPECIES_CASTFORM, SPECIES_FARFETCHD, SPECIES_EEVEE, SPECIES_DELCATTY},
        [5] = {SPECIES_LINOONE_G, SPECIES_GOOLIX, SPECIES_GLAMEOW, SPECIES_PORYGON, SPECIES_DWARFORANGEBULBORB, SPECIES_DUNSPARCE, SPECIES_PYROCLASTICSLOOCH, SPECIES_FURRET, SPECIES_BREADBUG_A, SPECIES_GIRAFARIG},
        ...
        [9] = {SPECIES_FROSTYBULBORB_MEGA, SPECIES_AMBIPOM, SPECIES_SILVALLY, SPECIES_KANGASKHAN_MEGA, SPECIES_SWELLOW, SPECIES_LOPUNNY_MEGA, SPECIES_PORYGON2, SPECIES_KANGASKHAN, SPECIES_STANTLER, SPECIES_STOUTLAND},
    },
    [CLASS_COOLTRAINER] = {
        ...
        [3] = {SPECIES_SEALEO, SPECIES_CLAMPERL, SPECIES_BLITZLE, SPECIES_VIBRAVA, SPECIES_MR_MIME_G, SPECIES_CHARJABUG, SPECIES_VEHEAMOTHPHOSBAT_A, SPECIES_SPOINK, SPECIES_COMBUSKEN, SPECIES_MR_MIME},
        [4] = {SPECIES_HONEYWISP_A, SPECIES_SPOTTYBULBEAR_CAP_UNOVA, SPECIES_DRIZZILE, SPECIES_BULBMIN, SPECIES_STARYU, SPECIES_SPOTTYBULBEAR_FLYING, SPECIES_MINUN, SPECIES_SCORCHCAKE_A, SPECIES_KADABRA, SPECIES_SLOWPOKE_G},
        [5] = {SPECIES_VIBRAVA, SPECIES_COMBUSKEN, SPECIES_SPOTTYBULBEAR_CAP_ALOLA, SPECIES_TOXSTOOL, SPECIES_SILVALLY_DRAGON, SPECIES_BELDUM, SPECIES_CROCONAW, SPECIES_SPHEAL, SPECIES_FLAAFFY, SPECIES_SPOTTYBULBEAR_POP_STAR},
        ...
        [7] = {SPECIES_MOLTRES, SPECIES_DRACOVISH, SPECIES_RESHIRAM, SPECIES_CENTISKORCH, SPECIES_ORBEETLE_GIGA, SPECIES_DARMANITAN_G_ZEN, SPECIES_VOLATILEDWEEVIL, SPECIES_PHIONE, SPECIES_BRONZONG, SPECIES_CALYREX},
        ...
        [9] = {SPECIES_GOODRA, SPECIES_VOLATILEDWEEVIL, SPECIES_APPLETUN, SPECIES_DIALGA_ORIGIN, SPECIES_LUMINEON, SPECIES_CRAMORANT, SPECIES_DEOXYS_ATTACK, SPECIES_MASTERONION_MEGA, SPECIES_ZYGARDE_COMPLETE, SPECIES_ZYGARDE_10},
    },
    [CLASS_ELITE_FOUR] = {
        ...
        [1] = {SPECIES_WYNAUT, SPECIES_TATSUGIRI, SPECIES_IRON_TREADS, SPECIES_CHI_YU, SPECIES_PUMPKABOO_L, SPECIES_KLINK, SPECIES_BAXCALIBUR, SPECIES_GOOMY, SPECIES_DWARFBULBORB_G, SPECIES_VELUZA},
        ...
        [3] = {SPECIES_SHIELDON, SPECIES_SPOTTYBULBEAR_PHD, SPECIES_MIME_JR_G, SPECIES_SILVALLY_PSYCHIC, SPECIES_WOLLYHOP_A, SPECIES_MIGHTYENA, SPECIES_SLOWPOKE_G, SPECIES_STUNKY, SPECIES_MAGEARNA_P, SPECIES_BAGON},
        [4] = {SPECIES_PUFFYFIERYBLOWHOG, SPECIES_CHIMECHO, SPECIES_DWARFBULBEAR, SPECIES_DRAGONAIR, SPECIES_SWOOBAT, SPECIES_SHIELDON, SPECIES_SILVALLY_STEEL, SPECIES_WOLLYHOP_A, SPECIES_DRAKLOAK, SPECIES_MUNNA},
        [5] = {SPECIES_SLOWPOKE_G, SPECIES_SANDYGAST, SPECIES_SABLEYE, SPECIES_RALTS, SPECIES_JANGMO_O, SPECIES_BREADBUG_A, SPECIES_MAWILE_MEGA, SPECIES_SMOOCHUM, SPECIES_SHEDINJA, SPECIES_MORGREM},
        ...
        [8] = {SPECIES_BISHARP, SPECIES_URSHIFU_SINGLE, SPECIES_GENESECT_DOUSE, SPECIES_MANDIBUZZ, SPECIES_KYUREM_BLACK, SPECIES_UXIE, SPECIES_LUXRAY, SPECIES_NECROZMA_DAWN_WINGS, SPECIES_ZOROARK_H, SPECIES_DOWNYSNAGRET_A},
    ...
    [CLASS_GENTLEMAN] = {
        ...
        [1] = {SPECIES_SQUAWKABILLY_WHITE, SPECIES_SNOWBULBORB, SPECIES_ORTHWORM, SPECIES_IGGLYBUFF, SPECIES_SKITTY, SPECIES_HELIOPTILE, SPECIES_TAILLOW, SPECIES_ZORUA_H, SPECIES_OINKOLOGNE, SPECIES_GRAFAIAI},
        [2] = {SPECIES_IRON_TREADS, SPECIES_TINKATUFF, SPECIES_DEERLING_WINTER, SPECIES_TINKATON, SPECIES_GHOLDENGO, SPECIES_GIANTBREADBUG, SPECIES_PIDOVE, SPECIES_FLETCHLING, SPECIES_URSALUNA_BLOODMOON, SPECIES_CUFANT},
        [3] = {SPECIES_FORRETRESS, SPECIES_LITLEO, SPECIES_BRONZOR, SPECIES_VIGOROTH, SPECIES_TYPE_NULL, SPECIES_PYROCLASTICSLOOCH, SPECIES_TEDDIURSA, SPECIES_DELCATTY, SPECIES_GLAMEOW, SPECIES_BREADBUG_A},
        [4] = {SPECIES_EEVEE, SPECIES_DWARFFROSTYBULBORB, SPECIES_BRONZOR, SPECIES_BREADBUG, SPECIES_MOCKIWI, SPECIES_EEVEE_GIGA, SPECIES_LITLEO, SPECIES_MAGEARNA_P, SPECIES_STARAVIA, SPECIES_LINOONE_G},
        [5] = {SPECIES_WORMADAM_TRASH, SPECIES_SMEARGLE, SPECIES_FOOLIX, SPECIES_TYPE_NULL, SPECIES_STARAVIA, SPECIES_GOOLIX, SPECIES_HERMITCRAWMAD_A, SPECIES_GIRAFARIG, SPECIES_HERDIER, SPECIES_PUFFYFIERYBLOWHOG},
        ...
        [8] = {SPECIES_DURALUDON, SPECIES_FURFROU_KABUKI, SPECIES_GENESECT_CHILL, SPECIES_FURFROU_DANDY, SPECIES_SOLGALEO, SPECIES_FROSTYBULBORB_MEGA, SPECIES_STOUTLAND, SPECIES_GENESECT_BURN, SPECIES_BRAVIARY, SPECIES_SLIGGOO_H},
        [9] = {SPECIES_UNFEZANT, SPECIES_BOUFFALANT, SPECIES_INDEEDEE, SPECIES_STOUTLAND, SPECIES_EMPOLEON, SPECIES_LOPUNNY_MEGA, SPECIES_BUGEYEDCRAWMAD_A, SPECIES_SWELLOW, SPECIES_STEELIX, SPECIES_SCIZOR},
    },
    [CLASS_RIVAL_2] = {
        [0] = {SPECIES_DEERLING_AUTUMN, SPECIES_DEERLING_WINTER, SPECIES_DWARFBULBORB, SPECIES_CRUMBUG, SPECIES_STARLY, SPECIES_EGG, SPECIES_DUDUNSPARCE_THREE, SPECIES_DOLLIV, SPECIES_SKITTY, SPECIES_MAUSHOLD_FOUR},
        ...
        [2] = {SPECIES_SHROODLE, SPECIES_CRUMBUG_A, SPECIES_TERAPAGOS, SPECIES_AZURILL, SPECIES_DOLLIV, SPECIES_LECHONK, SPECIES_TAILLOW, SPECIES_IGGLYBUFF, SPECIES_TERAPAGOS_STELLAR, SPECIES_BUNNELBY},
        [3] = {SPECIES_BREADBUG, SPECIES_GOOLIX, SPECIES_DIGGERSBY, SPECIES_SLAKOTH, SPECIES_FOOLIX, SPECIES_LINOONE_G, SPECIES_HERDIER, SPECIES_SWABLU, SPECIES_VIGOROTH, SPECIES_MOCKIWI},
        [4] = {SPECIES_MOCKIWI, SPECIES_LITLEO, SPECIES_BUNEARY, SPECIES_SPINDA, SPECIES_PYROCLASTICSLOOCH, SPECIES_FOOLIX, SPECIES_BREADBUG, SPECIES_FURRET, SPECIES_SMEARGLE, SPECIES_BREADBUG_A},
        [5] = {SPECIES_TRANQUILL, SPECIES_DWARFORANGEBULBORB, SPECIES_STARAVIA, SPECIES_CASTFORM, SPECIES_DELCATTY, SPECIES_WATCHOG, SPECIES_PYROCLASTICSLOOCH, SPECIES_MUNCHLAX, SPECIES_TYPE_NULL, SPECIES_BUNEARY},
        ...
        [7] = {SPECIES_HELIOLISK, SPECIES_STARAPTOR, SPECIES_FURFROU_DANDY, SPECIES_SNORLAX_GIGA, SPECIES_DRAMPA, SPECIES_FROSTYBULBORB, SPECIES_URSALUNA, SPECIES_ZOROARK_H, SPECIES_PYROAR, SPECIES_SILVALLY},
        [8] = {SPECIES_INDEEDEE, SPECIES_FURFROU, SPECIES_PYROAR_FEMALE, SPECIES_LOPUNNY, SPECIES_SNORLAX, SPECIES_PYROAR, SPECIES_AUDINO_MEGA, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_FURFROU_DEBUTANTE, SPECIES_FEAROW},
    ...
    [CLASS_CHAMPION] = {
        [0] = {SPECIES_BIBAREL, SPECIES_SQUAWKABILLY_BLUE, SPECIES_FURFROU_HEART, SPECIES_WHISMUR, SPECIES_BEWEAR, SPECIES_MELOETTA_PIROUETTE, SPECIES_SAWSBUCK_AUTUMN, SPECIES_EEVEE, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_TYPE_NULL},
        [1] = {SPECIES_FURFROU_LA_REINE, SPECIES_FOOLIX, SPECIES_BOUFFALANT, SPECIES_SLAKING, SPECIES_STANTLER, SPECIES_BIDOOF, SPECIES_STUFFUL, SPECIES_DWARFFROSTYBULBORB, SPECIES_SQUAWKABILLY_YELLOW, SPECIES_HELIOLISK},
        [2] = {SPECIES_BUNEARY, SPECIES_URSALUNA_BLOODMOON, SPECIES_LINOONE_G, SPECIES_TAILLOW, SPECIES_DRAMPA, SPECIES_SHROODLE, SPECIES_SLAKOTH, SPECIES_STOUTLAND, SPECIES_FOOLIX, SPECIES_SNORLAX},
        ...
        [4] = {SPECIES_SILVALLY, SPECIES_BOUFFALANT, SPECIES_DWARFBULBORB, SPECIES_DRAMPA, SPECIES_DOLLIV, SPECIES_LINOONE, SPECIES_BRAVIARY, SPECIES_TAUROS, SPECIES_AZURILL, SPECIES_SQUAWKABILLY_BLUE},
        [5] = {SPECIES_AUDINO_MEGA, SPECIES_PORYGON, SPECIES_DOLLIV, SPECIES_FURFROU_DIAMOND, SPECIES_DRAMPA, SPECIES_DWARFBULBORB_GIGA, SPECIES_TERAPAGOS_TERASTAL, SPECIES_FARFETCHD, SPECIES_MAUSHOLD_FOUR, SPECIES_SLAKING},
        [6] = {SPECIES_ZORUA_H, SPECIES_FURFROU_DEBUTANTE, SPECIES_MILTANK, SPECIES_LINOONE_G, SPECIES_PIKIPEK, SPECIES_AMBIPOM, SPECIES_BRAVIARY, SPECIES_FURFROU_STAR, SPECIES_DWARFBULBORB_GIGA, SPECIES_AIPOM},
        ...
        [9] = {SPECIES_BRAVIARY, SPECIES_MINCCINO, SPECIES_SQUAWKABILLY_BLUE, SPECIES_SNORLAX_GIGA, SPECIES_VIGOROTH, SPECIES_TOUCANNON, SPECIES_STARLY, SPECIES_WHISMUR, SPECIES_DWARFBULBORB_GIGA, SPECIES_GUMSHOOS},
    },
    [CLASS_CHANNELER] = {
        [0] = {SPECIES_CRUMBUG_A, SPECIES_MINCCINO, SPECIES_LILLIPUP, SPECIES_TANDEMAUS, SPECIES_BUNNELBY, SPECIES_FLETCHLING, SPECIES_FARIGIRAF, SPECIES_DEERLING_WINTER, SPECIES_DEERLING_AUTUMN, SPECIES_MAUSHOLD},
        [1] = {SPECIES_TERAPAGOS_TERASTAL, SPECIES_HELIOPTILE, SPECIES_GIANTBREADBUG, SPECIES_DUDUNSPARCE_THREE, SPECIES_ZIGZAGOON_G, SPECIES_GRAFAIAI, SPECIES_URSALUNA_BLOODMOON, SPECIES_OINKOLOGNE, SPECIES_DEERLING_SUMMER, SPECIES_DWARFBULBORB_GIGA},
        ...
        [4] = {SPECIES_PORYGON, SPECIES_HERDIER, SPECIES_MOCKIWI, SPECIES_TRANQUILL, SPECIES_BUNEARY, SPECIES_TRUMBEAK, SPECIES_WATCHOG, SPECIES_DUNSPARCE, SPECIES_LOUDRED, SPECIES_LITLEO},
        [5] = {SPECIES_MUNCHLAX, SPECIES_PYROCLASTICSLOOCH, SPECIES_TRUMBEAK, SPECIES_KECLEON, SPECIES_GLAMEOW, SPECIES_LOUDRED, SPECIES_CHATOT, SPECIES_DWARFORANGEBULBORB, SPECIES_DIGGERSBY, SPECIES_PORYGON},
        ...
        [7] = {SPECIES_LOPUNNY, SPECIES_DUBWOOL, SPECIES_HELIOLISK, SPECIES_FROSTYBULBORB_MEGA, SPECIES_SNORLAX_GIGA, SPECIES_HAPPINY, SPECIES_MILTANK, SPECIES_FURFROU_DIAMOND, SPECIES_PORYGON_Z, SPECIES_TOUCANNON},
        [8] = {SPECIES_FURFROU_KABUKI, SPECIES_URSALUNA, SPECIES_OBSTAGOON, SPECIES_SNORLAX_GIGA, SPECIES_KANGASKHAN_MEGA, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_ZOROARK_H, SPECIES_BEWEAR, SPECIES_CINCCINO, SPECIES_FURFROU_DEBUTANTE},
    ...
    [CLASS_TWINS] = {
        [0] = {SPECIES_GRAFAIAI, SPECIES_CRUMBUG, SPECIES_SENTRET, SPECIES_STARLY, SPECIES_SKITTY, SPECIES_TAILLOW, SPECIES_MINCCINO, SPECIES_SQUAWKABILLY_WHITE, SPECIES_CYCLIZAR, SPECIES_LECHONK},
        [1] = {SPECIES_LECHONK, SPECIES_DWARFBULBORB, SPECIES_SNOWBULBORB, SPECIES_CYCLIZAR, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_PIKIPEK, SPECIES_MINCCINO, SPECIES_SQUAWKABILLY_WHITE, SPECIES_GRAFAIAI, SPECIES_OINKOLOGNE},
        [2] = {SPECIES_DEERLING_WINTER, SPECIES_PIDOVE, SPECIES_DEERLING_SUMMER, SPECIES_SHROODLE, SPECIES_SQUAWKABILLY_YELLOW, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_TERAPAGOS_TERASTAL, SPECIES_MAUSHOLD, SPECIES_SKWOVET, SPECIES_URSALUNA_BLOODMOON},
        [3] = {SPECIES_MOCKIWI, SPECIES_WATCHOG, SPECIES_PYROCLASTICSLOOCH, SPECIES_BREADBUG, SPECIES_TRANQUILL, SPECIES_FARFETCHD, SPECIES_CASTFORM, SPECIES_BREADBUG_A, SPECIES_DIGGERSBY, SPECIES_DELCATTY},
        [4] = {SPECIES_MUNCHLAX, SPECIES_DWARFFROSTYBULBORB, SPECIES_WOOLOO, SPECIES_TRUMBEAK, SPECIES_FURRET, SPECIES_RUFFLET, SPECIES_DWARFORANGEBULBORB, SPECIES_BIBAREL, SPECIES_DUNSPARCE, SPECIES_TYPE_NULL},
        [5] = {SPECIES_WATCHOG, SPECIES_FOOLIX, SPECIES_MUNCHLAX, SPECIES_SPINDA, SPECIES_SMEARGLE, SPECIES_BIBAREL, SPECIES_DUNSPARCE, SPECIES_DWARFORANGEBULBORB, SPECIES_DIGGERSBY, SPECIES_STARAVIA},
        ...
        [7] = {SPECIES_FURFROU_KABUKI, SPECIES_DRAMPA, SPECIES_FURFROU_HEART, SPECIES_GREEDENT, SPECIES_SAWSBUCK_AUTUMN, SPECIES_AUDINO, SPECIES_PORYGON2, SPECIES_URSALUNA, SPECIES_AMBIPOM, SPECIES_FROSTYBULBORB},
    ...
    [CLASS_COOL_COUPLE] = {
        [0] = {SPECIES_ZIGZAGOON_G, SPECIES_OINKOLOGNE_FEMALE, SPECIES_DWARFBULBORB_GIGA, SPECIES_SNOWBULBORB, SPECIES_PIKIPEK, SPECIES_DEERLING_WINTER, SPECIES_TANDEMAUS, SPECIES_PATRAT, SPECIES_SKWOVET, SPECIES_YUNGOOS},
        [1] = {SPECIES_DWARFBULBORB, SPECIES_GIANTBREADBUG, SPECIES_SKWOVET, SPECIES_DEERLING_AUTUMN, SPECIES_DEERLING, SPECIES_CRUMBUG, SPECIES_DEERLING_SUMMER, SPECIES_TERAPAGOS, SPECIES_DUDUNSPARCE, SPECIES_WHISMUR},
        [2] = {SPECIES_DEERLING_SUMMER, SPECIES_LECHONK, SPECIES_SQUAWKABILLY_YELLOW, SPECIES_GRAFAIAI, SPECIES_PATRAT, SPECIES_OINKOLOGNE_FEMALE, SPECIES_OINKOLOGNE, SPECIES_DUDUNSPARCE_THREE, SPECIES_AZURILL, SPECIES_CRUMBUG_A},
        [3] = {SPECIES_GOOLIX, SPECIES_LINOONE, SPECIES_TRANQUILL, SPECIES_MUNCHLAX, SPECIES_SWABLU, SPECIES_BREADBUG_A, SPECIES_RUFFLET, SPECIES_LINOONE_G, SPECIES_FARFETCHD, SPECIES_DWARFORANGEBULBORB},
        [4] = {SPECIES_WATCHOG, SPECIES_KECLEON, SPECIES_LOUDRED, SPECIES_BUNEARY, SPECIES_BREADBUG_A, SPECIES_PYROCLASTICSLOOCH, SPECIES_SWABLU, SPECIES_LINOONE_G, SPECIES_DUNSPARCE, SPECIES_CHATOT},
        [5] = {SPECIES_STUFFUL, SPECIES_BREADBUG, SPECIES_VIGOROTH, SPECIES_DELCATTY, SPECIES_RUFFLET, SPECIES_DWARFFROSTYBULBORB, SPECIES_LOUDRED, SPECIES_SLAKOTH, SPECIES_PYROCLASTICSLOOCH, SPECIES_SWABLU},
        ...
        [7] = {SPECIES_FEAROW, SPECIES_MELOETTA, SPECIES_INDEEDEE, SPECIES_KANGASKHAN_MEGA, SPECIES_SAWSBUCK_SUMMER, SPECIES_FROSTYBULBORB, SPECIES_STARAPTOR, SPECIES_FURFROU_PHAROAH, SPECIES_EXPLOUD, SPECIES_FURFROU_DANDY},
    ...
    [CLASS_YOUNG_COUPLE] = {
        [0] = {SPECIES_DWARFBULBORB, SPECIES_YUNGOOS, SPECIES_DEERLING, SPECIES_ARBOLIVA, SPECIES_TERAPAGOS_STELLAR, SPECIES_DOLLIV, SPECIES_CYCLIZAR, SPECIES_HOOTHOOT, SPECIES_DUDUNSPARCE, SPECIES_DUDUNSPARCE_THREE},
        [1] = {SPECIES_IGGLYBUFF, SPECIES_TERAPAGOS_STELLAR, SPECIES_MAUSHOLD_FOUR, SPECIES_CRUMBUG_A, SPECIES_SQUAWKABILLY, SPECIES_GIANTBREADBUG, SPECIES_LILLIPUP, SPECIES_WHISMUR, SPECIES_TERAPAGOS_TERASTAL, SPECIES_TAILLOW},
        [2] = {SPECIES_BUNNELBY, SPECIES_DWARFBULBORB, SPECIES_ARBOLIVA, SPECIES_FARIGIRAF, SPECIES_URSALUNA_BLOODMOON, SPECIES_DEERLING_AUTUMN, SPECIES_MINCCINO, SPECIES_PIDOVE, SPECIES_HOOTHOOT, SPECIES_EGG},
        [3] = {SPECIES_HERDIER, SPECIES_FURRET, SPECIES_RUFFLET, SPECIES_BREADBUG_A, SPECIES_AIPOM, SPECIES_DUNSPARCE, SPECIES_GOOLIX, SPECIES_PORYGON, SPECIES_GUMSHOOS, SPECIES_LOUDRED},
        [4] = {SPECIES_DWARFFROSTYBULBORB, SPECIES_EEVEE, SPECIES_TEDDIURSA, SPECIES_RUFFLET, SPECIES_TYPE_NULL, SPECIES_AIPOM, SPECIES_MUNCHLAX, SPECIES_DWARFORANGEBULBORB, SPECIES_BIBAREL, SPECIES_GUMSHOOS},
        [5] = {SPECIES_CHATOT, SPECIES_SWABLU, SPECIES_BREADBUG, SPECIES_PYROCLASTICSLOOCH, SPECIES_TRUMBEAK, SPECIES_GOOLIX, SPECIES_BREADBUG_A, SPECIES_SPINDA, SPECIES_WOOLOO, SPECIES_MUNCHLAX},
        [6] = {SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_PYROAR_FEMALE, SPECIES_ARCEUS, SPECIES_LOPUNNY_MEGA, SPECIES_MILTANK, SPECIES_FURFROU_LA_REINE, SPECIES_SILVALLY, SPECIES_ZOROARK_H, SPECIES_PORYGON_Z, SPECIES_WYRDEER},
    ...
    [CLASS_CRUSH_KIN] = {
        [0] = {SPECIES_FLETCHLING, SPECIES_MAUSHOLD_FOUR, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_TAILLOW, SPECIES_MAUSHOLD, SPECIES_SKWOVET, SPECIES_SHROODLE, SPECIES_PIDOVE, SPECIES_SQUAWKABILLY, SPECIES_PIKIPEK},
        [1] = {SPECIES_DEERLING_WINTER, SPECIES_GIANTBREADBUG, SPECIES_DEERLING, SPECIES_IGGLYBUFF, SPECIES_LILLIPUP, SPECIES_OINKOLOGNE_FEMALE, SPECIES_BIDOOF, SPECIES_PIKIPEK, SPECIES_YUNGOOS, SPECIES_MINCCINO},
        [2] = {SPECIES_TERAPAGOS_TERASTAL, SPECIES_DWARFBULBORB, SPECIES_ZIGZAGOON, SPECIES_WHISMUR, SPECIES_TERAPAGOS_STELLAR, SPECIES_TANDEMAUS, SPECIES_FARIGIRAF, SPECIES_FLETCHLING, SPECIES_CRUMBUG, SPECIES_BIDOOF},
        [3] = {SPECIES_DWARFORANGEBULBORB, SPECIES_GLAMEOW, SPECIES_SWABLU, SPECIES_TEDDIURSA, SPECIES_LINOONE_G, SPECIES_WOOLOO, SPECIES_SLAKOTH, SPECIES_GOOLIX, SPECIES_SPINDA, SPECIES_RUFFLET},
        [4] = {SPECIES_VIGOROTH, SPECIES_FURRET, SPECIES_CASTFORM, SPECIES_DUNSPARCE, SPECIES_STARAVIA, SPECIES_BIBAREL, SPECIES_MOCKIWI, SPECIES_STUFFUL, SPECIES_DIGGERSBY, SPECIES_DWARFFROSTYBULBORB},
        [5] = {SPECIES_DELCATTY, SPECIES_PYROCLASTICSLOOCH, SPECIES_SMEARGLE, SPECIES_KECLEON, SPECIES_SLAKOTH, SPECIES_WATCHOG, SPECIES_TYPE_NULL, SPECIES_TRANQUILL, SPECIES_TRUMBEAK, SPECIES_GLAMEOW},
        [6] = {SPECIES_ARCEUS, SPECIES_AMBIPOM, SPECIES_FEAROW, SPECIES_TAUROS, SPECIES_TOUCANNON, SPECIES_ORANGURU, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_PYROAR_FEMALE, SPECIES_URSARING, SPECIES_STARAPTOR},
    ...
    [CLASS_SIS_AND_BRO] = {
        [0] = {SPECIES_OINKOLOGNE, SPECIES_TERAPAGOS, SPECIES_MAUSHOLD, SPECIES_CYCLIZAR, SPECIES_WHISMUR, SPECIES_MAUSHOLD_FOUR, SPECIES_CRUMBUG_A, SPECIES_ZORUA_H, SPECIES_IGGLYBUFF, SPECIES_OINKOLOGNE_FEMALE},
        ...
        [2] = {SPECIES_LECHONK, SPECIES_TANDEMAUS, SPECIES_SHROODLE, SPECIES_ZORUA_H, SPECIES_GIANTBREADBUG, SPECIES_CYCLIZAR, SPECIES_DEERLING, SPECIES_TAILLOW, SPECIES_OINKOLOGNE, SPECIES_ZIGZAGOON_G},
        [3] = {SPECIES_SWABLU, SPECIES_LINOONE, SPECIES_DWARFFROSTYBULBORB, SPECIES_LINOONE_G, SPECIES_TRUMBEAK, SPECIES_CASTFORM, SPECIES_FARFETCHD, SPECIES_EEVEE_GIGA, SPECIES_TEDDIURSA, SPECIES_GOOLIX},
        [4] = {SPECIES_LITLEO, SPECIES_CHATOT, SPECIES_HERDIER, SPECIES_SLAKOTH, SPECIES_BUNEARY, SPECIES_GLAMEOW, SPECIES_LOUDRED, SPECIES_DWARFORANGEBULBORB, SPECIES_BIBAREL, SPECIES_KECLEON},
        ...
        [6] = {SPECIES_INDEEDEE, SPECIES_PORYGON2, SPECIES_BOUFFALANT, SPECIES_KANGASKHAN_MEGA, SPECIES_FURFROU_LA_REINE, SPECIES_LOPUNNY, SPECIES_CHANSEY, SPECIES_SLAKING, SPECIES_FROSTYBULBORB_MEGA, SPECIES_ORANGURU},
        [7] = {SPECIES_FROSTYBULBORB_MEGA, SPECIES_SAWSBUCK_SUMMER, SPECIES_KANGASKHAN, SPECIES_GREEDENT, SPECIES_FEAROW, SPECIES_BRAVIARY, SPECIES_KANGASKHAN_MEGA, SPECIES_URSARING, SPECIES_SILVALLY, SPECIES_INDEEDEE},
        ...
        [9] = {SPECIES_FROSTYBULBORB_MEGA, SPECIES_SAWSBUCK_AUTUMN, SPECIES_INDEEDEE_FEMALE, SPECIES_FURFROU_HEART, SPECIES_SAWSBUCK, SPECIES_FURFROU_MATRON, SPECIES_PURUGLY, SPECIES_BEWEAR, SPECIES_SAWSBUCK_SUMMER, SPECIES_ZANGOOSE},
    },
    [CLASS_PKMN_PROF] = {
        ...
        [2] = {SPECIES_STARLY, SPECIES_BUNNELBY, SPECIES_CRUMBUG, SPECIES_TERAPAGOS_TERASTAL, SPECIES_PATRAT, SPECIES_HELIOPTILE, SPECIES_LECHONK, SPECIES_SQUAWKABILLY_WHITE, SPECIES_SNOWBULBORB, SPECIES_MAUSHOLD},
        [3] = {SPECIES_STUFFUL, SPECIES_TEDDIURSA, SPECIES_SWABLU, SPECIES_FARFETCHD, SPECIES_LINOONE_G, SPECIES_MUNCHLAX, SPECIES_TYPE_NULL, SPECIES_PYROCLASTICSLOOCH, SPECIES_BREADBUG, SPECIES_RUFFLET},
        [4] = {SPECIES_TYPE_NULL, SPECIES_LINOONE_G, SPECIES_PYROCLASTICSLOOCH, SPECIES_EEVEE_GIGA, SPECIES_TRUMBEAK, SPECIES_GLAMEOW, SPECIES_BUNEARY, SPECIES_TEDDIURSA, SPECIES_MUNCHLAX, SPECIES_BREADBUG_A},
        [5] = {SPECIES_EEVEE, SPECIES_EEVEE_GIGA, SPECIES_LINOONE_G, SPECIES_DELCATTY, SPECIES_CHATOT, SPECIES_DWARFORANGEBULBORB, SPECIES_VIGOROTH, SPECIES_LINOONE, SPECIES_SLAKOTH, SPECIES_PORYGON},
        ...
        [8] = {SPECIES_FROSTYBULBORB_MEGA, SPECIES_UNFEZANT, SPECIES_AMBIPOM, SPECIES_PORYGON_Z, SPECIES_KOMALA, SPECIES_SAWSBUCK_AUTUMN, SPECIES_SAWSBUCK, SPECIES_STOUTLAND, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_SNORLAX_GIGA},
    ...
    [CLASS_PLAYER] = {
        [0] = {SPECIES_DWARFBULBORB, SPECIES_SKITTY, SPECIES_MAUSHOLD, SPECIES_BIDOOF, SPECIES_ZIGZAGOON_G, SPECIES_ARBOLIVA, SPECIES_DUDUNSPARCE_THREE, SPECIES_DEERLING_SUMMER, SPECIES_ZORUA_H, SPECIES_DEERLING_WINTER},
        [1] = {SPECIES_DEERLING_WINTER, SPECIES_LILLIPUP, SPECIES_BIDOOF, SPECIES_FLETCHLING, SPECIES_SMOLIV, SPECIES_BUNNELBY, SPECIES_SNOWBULBORB, SPECIES_LECHONK, SPECIES_YUNGOOS, SPECIES_ZIGZAGOON_G},
        [2] = {SPECIES_SNOWBULBORB, SPECIES_DEERLING_SUMMER, SPECIES_DWARFBULBORB, SPECIES_SQUAWKABILLY_WHITE, SPECIES_OINKOLOGNE_FEMALE, SPECIES_MINCCINO, SPECIES_TERAPAGOS, SPECIES_OINKOLOGNE, SPECIES_PIDOVE, SPECIES_LILLIPUP},
        [3] = {SPECIES_CHATOT, SPECIES_TRUMBEAK, SPECIES_CASTFORM, SPECIES_DELCATTY, SPECIES_PYROCLASTICSLOOCH, SPECIES_LINOONE, SPECIES_LITLEO, SPECIES_GLAMEOW, SPECIES_DWARFFROSTYBULBORB, SPECIES_STUFFUL},
        [4] = {SPECIES_PYROCLASTICSLOOCH, SPECIES_MUNCHLAX, SPECIES_TEDDIURSA, SPECIES_GOOLIX, SPECIES_VIGOROTH, SPECIES_KECLEON, SPECIES_TYPE_NULL, SPECIES_TRUMBEAK, SPECIES_PORYGON, SPECIES_EEVEE},
        [5] = {SPECIES_SPINDA, SPECIES_STUFFUL, SPECIES_LINOONE, SPECIES_DWARFFROSTYBULBORB, SPECIES_PYROCLASTICSLOOCH, SPECIES_KECLEON, SPECIES_SWABLU, SPECIES_DELCATTY, SPECIES_CHATOT, SPECIES_PORYGON},
    ...
    [CLASS_CRUSH_GIRL] = {
        [0] = {SPECIES_DWARFBULBORB_GIGA, SPECIES_CYCLIZAR, SPECIES_SHROODLE, SPECIES_SQUAWKABILLY_BLUE, SPECIES_SNOWBULBORB, SPECIES_DOLLIV, SPECIES_TERAPAGOS, SPECIES_MAUSHOLD, SPECIES_BIDOOF, SPECIES_HELIOPTILE},
        [1] = {SPECIES_YUNGOOS, SPECIES_DEERLING_AUTUMN, SPECIES_HOOTHOOT, SPECIES_SENTRET, SPECIES_WHISMUR, SPECIES_BIDOOF, SPECIES_SHROODLE, SPECIES_SKITTY, SPECIES_HELIOPTILE, SPECIES_CRUMBUG_A},
        [2] = {SPECIES_DEERLING, SPECIES_PIDOVE, SPECIES_EGG, SPECIES_DOLLIV, SPECIES_SQUAWKABILLY_YELLOW, SPECIES_PIKIPEK, SPECIES_TERAPAGOS, SPECIES_LECHONK, SPECIES_MAUSHOLD, SPECIES_GIANTBREADBUG},
        [3] = {SPECIES_TYPE_NULL, SPECIES_SWABLU, SPECIES_DWARFFROSTYBULBORB, SPECIES_GIRAFARIG, SPECIES_PYROCLASTICSLOOCH, SPECIES_LINOONE, SPECIES_EEVEE_GIGA, SPECIES_MUNCHLAX, SPECIES_STUFFUL, SPECIES_EEVEE},
        [4] = {SPECIES_AIPOM, SPECIES_LOUDRED, SPECIES_BREADBUG, SPECIES_DIGGERSBY, SPECIES_HERDIER, SPECIES_PYROCLASTICSLOOCH, SPECIES_RUFFLET, SPECIES_SMEARGLE, SPECIES_EEVEE_GIGA, SPECIES_STARAVIA},
        [5] = {SPECIES_MOCKIWI, SPECIES_WATCHOG, SPECIES_TYPE_NULL, SPECIES_DUNSPARCE, SPECIES_BUNEARY, SPECIES_FOOLIX, SPECIES_EEVEE_GIGA, SPECIES_DWARFORANGEBULBORB, SPECIES_LINOONE_G, SPECIES_HERDIER},
        [6] = {SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_AUDINO, SPECIES_BLISSEY, SPECIES_FURFROU, SPECIES_INDEEDEE, SPECIES_EXPLOUD, SPECIES_PURUGLY, SPECIES_FURFROU_HEART, SPECIES_STOUTLAND, SPECIES_WYRDEER},
        [7] = {SPECIES_AMBIPOM, SPECIES_URSALUNA, SPECIES_ZOROARK_H, SPECIES_STOUTLAND, SPECIES_FURFROU_HEART, SPECIES_FROSTYBULBORB_MEGA, SPECIES_REGIGIGAS, SPECIES_UNFEZANT, SPECIES_TOUCANNON, SPECIES_CHANSEY},
    ...
    [CLASS_TUBER] = {
        ...
        [2] = {SPECIES_DWARFBULBORB, SPECIES_HOOTHOOT, SPECIES_LECHONK, SPECIES_SMOLIV, SPECIES_MINCCINO, SPECIES_GRAFAIAI, SPECIES_FARIGIRAF, SPECIES_GIANTBREADBUG, SPECIES_ARBOLIVA, SPECIES_DEERLING_WINTER},
        ...
        [4] = {SPECIES_BREADBUG_A, SPECIES_STUFFUL, SPECIES_LOUDRED, SPECIES_DELCATTY, SPECIES_PORYGON, SPECIES_BUNEARY, SPECIES_CASTFORM, SPECIES_BIBAREL, SPECIES_SLAKOTH, SPECIES_AIPOM},
        [5] = {SPECIES_SLAKOTH, SPECIES_DUNSPARCE, SPECIES_RUFFLET, SPECIES_TEDDIURSA, SPECIES_DWARFORANGEBULBORB, SPECIES_MOCKIWI, SPECIES_GLAMEOW, SPECIES_STUFFUL, SPECIES_LINOONE_G, SPECIES_GOOLIX},
        ...
        [7] = {SPECIES_PORYGON_Z, SPECIES_SAWSBUCK, SPECIES_SNORLAX_GIGA, SPECIES_DRAMPA, SPECIES_FEAROW, SPECIES_ZOROARK_H, SPECIES_FURFROU_PHAROAH, SPECIES_SILVALLY, SPECIES_KOMALA, SPECIES_FROSTYBULBORB_MEGA},
    ...
    [CLASS_PKMN_BREEDER] = {
        [0] = {SPECIES_SCREAM_TAIL, SPECIES_SQUAWKABILLY, SPECIES_ZIGZAGOON_G, SPECIES_TINKATINK, SPECIES_CRUMBUG_A, SPECIES_FIDOUGH, SPECIES_MARILL, SPECIES_DUDUNSPARCE_THREE, SPECIES_HOOTHOOT, SPECIES_MILCERY},
        [1] = {SPECIES_SWIRLIX, SPECIES_DWARFBULBORB_GIGA, SPECIES_SKITTY, SPECIES_SKWOVET, SPECIES_MAUSHOLD, SPECIES_DACHSBUN, SPECIES_SHROODLE, SPECIES_SQUAWKABILLY_YELLOW, SPECIES_BUNNELBY, SPECIES_SENTRET},
        [2] = {SPECIES_DUDUNSPARCE, SPECIES_COTTONEE, SPECIES_MAUSHOLD, SPECIES_SHROODLE, SPECIES_CRUMBUG_A, SPECIES_DACHSBUN, SPECIES_SCREAM_TAIL, SPECIES_FLABEBE_ORANGE, SPECIES_DEERLING_WINTER, SPECIES_DUDUNSPARCE_THREE},
        [3] = {SPECIES_LINOONE, SPECIES_TEDDIURSA, SPECIES_BREADBUG, SPECIES_MOCKIWI, SPECIES_CUTIEFLY, SPECIES_MAGEARNA_P, SPECIES_KIRLIA, SPECIES_QUEENSHEARWIG, SPECIES_FARFETCHD, SPECIES_GUMSHOOS},
        [4] = {SPECIES_CASTFORM, SPECIES_GLAMEOW, SPECIES_WATCHOG, SPECIES_WOOLOO, SPECIES_QUEENSHEARWIG, SPECIES_BUNEARY, SPECIES_CHATOT, SPECIES_MIME_JR_G, SPECIES_SILVALLY_FAIRY, SPECIES_BIBAREL},
        [5] = {SPECIES_KECLEON, SPECIES_SILVALLY_FAIRY, SPECIES_EEVEE, SPECIES_RIBOMBEE, SPECIES_AIPOM, SPECIES_FLOETTE_ORANGE, SPECIES_EEVEE_GIGA, SPECIES_TEDDIURSA, SPECIES_GLAMEOW, SPECIES_GOOLIX},
    ...
    [CLASS_PKMN_RANGER] = {
        [0] = {SPECIES_OGERPON_WELLSPRING_MASK, SPECIES_GLIMMET, SPECIES_DEERLING_WINTER, SPECIES_DEERLING_AUTUMN, SPECIES_BULBORBLARVA, SPECIES_TOEDSCRUEL, SPECIES_POLTCHAGEIST, SPECIES_PUMPKABOO, SPECIES_DIPPLIN, SPECIES_SCOVILLAIN},
        [1] = {SPECIES_OGERPON_HEARTHFLAME_MASK, SPECIES_BULBORBLARVA, SPECIES_TREECKO, SPECIES_TURTWIG, SPECIES_DEERLING_SUMMER, SPECIES_CHESPIN, SPECIES_DEERLING_AUTUMN, SPECIES_ARBOLIVA, SPECIES_OGERPON_WELLSPRING_MASK, SPECIES_GARGANACL},
        ...
        [3] = {SPECIES_SNOVER, SPECIES_ARON, SPECIES_CARBINK, SPECIES_MINIOR_VIOLET, SPECIES_ARACHNODE, SPECIES_TIRTOUGA, SPECIES_FOMANTIS, SPECIES_NUZLEAF, SPECIES_SILVALLY_GRASS, SPECIES_VEHEAMOTHPHOSBAT},
        [4] = {SPECIES_SKIPLOOM, SPECIES_MINIOR_VIOLET, SPECIES_WOLLYHOP, SPECIES_SERVINE, SPECIES_PUFFMIN_H, SPECIES_LOMBRE, SPECIES_SWADLOON, SPECIES_MINIOR_GREEN, SPECIES_ANORITH, SPECIES_ROGGENROLA},
        ...
        [6] = {SPECIES_EXEGGUTOR, SPECIES_SPUTTLEFISH, SPECIES_TERRAKION, SPECIES_ARMALDO, SPECIES_RILLABOOM, SPECIES_EXEGGUTOR_A, SPECIES_LUNATONE, SPECIES_APPLETUN_GIGA, SPECIES_RHYPERIOR, SPECIES_SHAYMIN_SKY},
        ...
        [8] = {SPECIES_DREDNAW, SPECIES_CELEBI, SPECIES_NIHILEGO, SPECIES_SHIFTRY, SPECIES_WORMADAM, SPECIES_SPUTTLEFISH_A, SPECIES_LEAFEON, SPECIES_FERROTHORN, SPECIES_TSAREENA, SPECIES_STAKATAKA},
    ...
    [CLASS_AROMA_LADY] = {
        [0] = {SPECIES_OINKOLOGNE, SPECIES_URSALUNA_BLOODMOON, SPECIES_SHROODLE, SPECIES_YUNGOOS, SPECIES_SMOLIV, SPECIES_ZORUA_H, SPECIES_SNOWBULBORB, SPECIES_TANDEMAUS, SPECIES_DUDUNSPARCE_THREE, SPECIES_SKITTY},
        [1] = {SPECIES_LILLIPUP, SPECIES_DEERLING_WINTER, SPECIES_SNOWBULBORB, SPECIES_SKITTY, SPECIES_CRUMBUG_A, SPECIES_URSALUNA_BLOODMOON, SPECIES_STARLY, SPECIES_SMOLIV, SPECIES_FLETCHLING, SPECIES_MINCCINO},
        ...
        [3] = {SPECIES_BIBAREL, SPECIES_BREADBUG_A, SPECIES_WATCHOG, SPECIES_GUMSHOOS, SPECIES_DWARFORANGEBULBORB, SPECIES_SLAKOTH, SPECIES_EEVEE_GIGA, SPECIES_GOOLIX, SPECIES_VIGOROTH, SPECIES_WOOLOO},
        ...
        [5] = {SPECIES_PYROCLASTICSLOOCH, SPECIES_SMEARGLE, SPECIES_GIRAFARIG, SPECIES_RUFFLET, SPECIES_SLAKOTH, SPECIES_SWABLU, SPECIES_DWARFFROSTYBULBORB, SPECIES_EEVEE, SPECIES_WATCHOG, SPECIES_TRANQUILL},
        ...
        [7] = {SPECIES_STANTLER, SPECIES_HAPPINY, SPECIES_KANGASKHAN, SPECIES_MELOETTA_PIROUETTE, SPECIES_FURFROU_DIAMOND, SPECIES_AMBIPOM, SPECIES_FURFROU_KABUKI, SPECIES_SAWSBUCK_SUMMER, SPECIES_FROSTYBULBORB, SPECIES_URSARING},
    ...
    [CLASS_RUIN_MANIAC] = {
        ...
        [1] = {SPECIES_LILLIPUP, SPECIES_GIANTBREADBUG, SPECIES_OINKOLOGNE_FEMALE, SPECIES_URSALUNA_BLOODMOON, SPECIES_BIDOOF, SPECIES_PIKIPEK, SPECIES_AZURILL, SPECIES_CRUMBUG, SPECIES_SHROODLE, SPECIES_SNOWBULBORB},
        ...
        [5] = {SPECIES_GUMSHOOS, SPECIES_VIGOROTH, SPECIES_PYROCLASTICSLOOCH, SPECIES_TRANQUILL, SPECIES_AIPOM, SPECIES_LOUDRED, SPECIES_BREADBUG_A, SPECIES_LINOONE, SPECIES_WOOLOO, SPECIES_GOOLIX},
        [6] = {SPECIES_FEAROW, SPECIES_PYROAR, SPECIES_PURUGLY, SPECIES_MELOETTA_PIROUETTE, SPECIES_SWELLOW, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_LOPUNNY_MEGA, SPECIES_KANGASKHAN_MEGA, SPECIES_KOMALA, SPECIES_SAWSBUCK_AUTUMN},
        [7] = {SPECIES_KANGASKHAN, SPECIES_UNFEZANT, SPECIES_URSALUNA, SPECIES_BRAVIARY, SPECIES_ORANGURU, SPECIES_TAUROS, SPECIES_GREEDENT, SPECIES_MELOETTA_PIROUETTE, SPECIES_FROSTYBULBORB, SPECIES_FURFROU_HEART},
        [8] = {SPECIES_MELOETTA_PIROUETTE, SPECIES_LOPUNNY_MEGA, SPECIES_AUDINO, SPECIES_MILTANK, SPECIES_TAUROS, SPECIES_MELOETTA, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_URSALUNA, SPECIES_INDEEDEE, SPECIES_DRAMPA},
        [9] = {SPECIES_FURFROU_MATRON, SPECIES_AUDINO, SPECIES_CHANSEY, SPECIES_FURFROU_PHAROAH, SPECIES_KOMALA, SPECIES_LESSERSPOTTEDJELLYFLOAT, SPECIES_REGIGIGAS, SPECIES_FURFROU_DEBUTANTE, SPECIES_CINCCINO, SPECIES_ZANGOOSE},
    },
    [CLASS_LADY] = {
        ...
        [1] = {SPECIES_SNOWBULBORB, SPECIES_INKAY, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_UNOWN_I, SPECIES_DEERLING, SPECIES_PIDOVE, SPECIES_UNOWN_D, SPECIES_DOLLIV, SPECIES_UNOWN_T, SPECIES_UNOWN_J},
        ...
        [3] = {SPECIES_GOTHORITA, SPECIES_SILVALLY_PSYCHIC, SPECIES_GOOLIX, SPECIES_WOOLOO, SPECIES_MOCKIWI, SPECIES_RALTS, SPECIES_BUNEARY, SPECIES_DELCATTY, SPECIES_TRUMBEAK, SPECIES_STUFFUL},
        [4] = {SPECIES_LINOONE, SPECIES_FURRET, SPECIES_SPOINK, SPECIES_VIGOROTH, SPECIES_SLAKOTH, SPECIES_BREADBUG_A, SPECIES_HATTREM, SPECIES_SMOOCHUM, SPECIES_DWARFORANGEBULBORB, SPECIES_EEVEE},
        [5] = {SPECIES_GOTHORITA, SPECIES_GUMSHOOS, SPECIES_BUNEARY, SPECIES_DUOSION, SPECIES_MUNCHLAX, SPECIES_DOTTLER, SPECIES_NATU, SPECIES_MEDITITE, SPECIES_DIGGERSBY, SPECIES_HONEYWISP_A},
        [6] = {SPECIES_HOOPA_UNBOUND, SPECIES_UNFEZANT, SPECIES_PRICKLEPUFF_G, SPECIES_SLOWBRO_G, SPECIES_MR_RIME, SPECIES_MEWTWO, SPECIES_RAGINGLONGLEGS, SPECIES_EXPLOUD, SPECIES_SIGILYPH, SPECIES_TAPU_LELE},
    ...
    [CLASS_PAINTER] = {
        ...
        [1] = {SPECIES_FLITTLE, SPECIES_ZIGZAGOON, SPECIES_VELUZA, SPECIES_INKAY, SPECIES_TERAPAGOS_STELLAR, SPECIES_DUDUNSPARCE_THREE, SPECIES_ESPATHRA, SPECIES_CYCLIZAR, SPECIES_UNOWN_V, SPECIES_DWARFBULBORB},
        [2] = {SPECIES_SQUAWKABILLY_YELLOW, SPECIES_LILLIPUP, SPECIES_OINKOLOGNE_FEMALE, SPECIES_SQUAWKABILLY_BLUE, SPECIES_DEERLING_SUMMER, SPECIES_QUAGGLEDMIRECLOPS, SPECIES_DEERLING, SPECIES_BIDOOF, SPECIES_STARLY, SPECIES_UNOWN_P},
        ...
        [4] = {SPECIES_SPOTTYBULBEAR_PHD, SPECIES_HERDIER, SPECIES_HATTREM, SPECIES_GLAMEOW, SPECIES_BRONZOR, SPECIES_SUNQUISH, SPECIES_TRUMBEAK, SPECIES_PYROCLASTICSLOOCH, SPECIES_NATU, SPECIES_VIGOROTH},
        [5] = {SPECIES_MR_MIME_G, SPECIES_LINOONE_G, SPECIES_PORYGON, SPECIES_CHIMECHO, SPECIES_SPOTTYBULBEAR_PHD, SPECIES_FARFETCHD, SPECIES_DELCATTY, SPECIES_TRUMBEAK, SPECIES_KECLEON, SPECIES_WOOLOO},
        ...
        [7] = {SPECIES_PORYGON2, SPECIES_RAGINGLONGLEGS, SPECIES_HOOPA, SPECIES_VICTINI, SPECIES_SAWSBUCK_WINTER, SPECIES_TAUROS, SPECIES_BOUFFALANT, SPECIES_AMBIPOM, SPECIES_NECROZMA_DAWN_WINGS, SPECIES_SNORLAX_GIGA},
        ...
        [9] = {SPECIES_SOLGALEO, SPECIES_FURFROU_KABUKI, SPECIES_PYROAR, SPECIES_LUNATONE, SPECIES_SLOWBRO_MEGA, SPECIES_GATTLINGGROINK, SPECIES_STANTLER, SPECIES_BRAVIARY_H, SPECIES_VICTINI, SPECIES_DUBWOOL},
    },
};
