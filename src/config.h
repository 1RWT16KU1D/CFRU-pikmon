...
#define KANTO_DEX_COUNT 190
#define NATIONAL_DEX_COUNT 191
...
#define NUM_SPECIES_RANDOMIZER LAST_RANDOM //The final number of Pokemon (+ 1) of species that can appear in the randomizer. Change to NUM_SPECIES for Gen 8
...
#define CRY_SPECIES SPECIES_TITANBLOWHOG //The species that will be used for the cry in the titlescreen. Currently its 0x6 (TitanBlowhog).
#define OAK_INTRO_SPECIES SPECIES_BURROWINGSNAGRET //The species that appears in Oak's intro(New Game).
