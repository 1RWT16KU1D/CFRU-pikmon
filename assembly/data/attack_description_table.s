...
.word DESC_ARCTIC_BLAST
.word DESC_ACID_REFLEX
.word DESC_BOMB_ROCK
.word DESC_CURSED_FLAMES
.word DESC_BULBORB_BASH
.word DESC_CRUSHING_BLOW
.word DESC_BIG_CHOMP
.word DESC_STOMP_OUT
.word DESC_RAVE_PARTY
.word DESC_GLOOM
.word DESC_GOLDEN_GUN
.word DESC_MACHINE_GUN
.word DESC_TONGUE_LASH
.word DESC_ROLLER_RUSH
.word DESC_PELLET_POWER
.word DESC_MEDUSAL_BEAM
.word DESC_DUST_STORM
.word DESC_STONE_FANG
.word DESC_STONE_PUNCH
.word DESC_BITTER_SPRAY
.word DESC_SPICY_SPRAY
.word DESC_STONE_ARMOR
.word DESC_ROCKY_ROCK
.word DESC_TREASURE_BURST
.word DESC_MUSH_MASH
.word DESC_SHROOM_FUME
.word DESC_SPORE_PUFF
.word DESC_PRQUILONOSIS
